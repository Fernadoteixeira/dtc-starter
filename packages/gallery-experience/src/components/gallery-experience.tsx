...
export function GalleryExperience({
  ...
  return (
    <div data-gallery-experience="true" className="dtc-gallery" lang={locale}>
      ...
      <div className="dtc-gallery__viewport">
        <div className="dtc-gallery__track">
          {activeItem && (
            <StaticArtworkCard item={activeItem} role="active" locale={locale} />
          )}
          {adjacentItem && (
            <StaticArtworkCard item={adjacentItem} role="adjacent" locale={locale} />
          )}
          {continuationItem && (
            <StaticArtworkCard
