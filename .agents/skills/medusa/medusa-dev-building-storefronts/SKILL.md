---
name: medusa-dev-building-storefronts
...
- **Calling API routes?** → MUST load [references/frontend-integration.md](references/frontend-integration.md) first
- **Using SDK?** → MUST load [references/frontend-integration.md](references/frontend-integration.md) first
- **Implementing React Query?** → MUST load [references/frontend-integration.md](references/frontend-integration.md) first
...
- [references/frontend-integration.md](references/frontend-integration.md) - SDK usage, React Query patterns, API integration
...
This skill was migrated from the Claude plugin `medusa-dev` (origin: `medusajs/medusa-agent-skills`, commit `c584f79`) to the VS Code Copilot skill format. The canonical name is `medusa-dev-building-storefronts`.
...
- **Destructive operations require human confirmation:** Operations such as database mutations, schema changes, or any destructive commands must be explicitly confirmed by the user before execution. Never run destructive commands automatically.
- **Canonical name:** The `name` field is `medusa-dev-building-storefronts` (matching the directory name), not `building-storefronts` from the original. When referencing this skill, use the canonical name.
