---
name: medusa-dev-building-with-medusa
...
- **Creating a module?** → MUST load [reference/custom-modules.md](reference/custom-modules.md) first
- **Creating workflows?** → MUST load [reference/workflows.md](reference/workflows.md) first
- **Creating API routes?** → MUST load [reference/api-routes.md](reference/api-routes.md) first
- **Creating module links?** → MUST load [reference/module-links.md](reference/module-links.md) first
- **Querying data?** → MUST load [reference/querying-data.md](reference/querying-data.md) first
- **Adding authentication?** → MUST load [reference/authentication.md](reference/authentication.md) first
...
- [reference/custom-modules.md](reference/custom-modules.md) - Creating modules with data models
- [reference/workflows.md](reference/workflows.md) - Workflow creation and step patterns
- [reference/api-routes.md](reference/api-routes.md) - API route structure and validation
- [reference/module-links.md](reference/module-links.md) - Linking entities across modules
- [reference/querying-data.md](reference/querying-data.md) - Query patterns and filtering rules
- [reference/authentication.md](reference/authentication.md) - Protecting routes and accessing users
- [reference/error-handling.md](reference/error-handling.md) - MedusaError types and patterns
- [reference/scheduled-jobs.md](reference/scheduled-jobs.md) - Cron jobs and periodic tasks
- [reference/subscribers-and-events.md](reference/subscribers-and-events.md) - Event handling
- [reference/troubleshooting.md](reference/troubleshooting.md) - Common errors and solutions
...
This skill was migrated from the Claude plugin `medusa-dev` (origin: `medusajs/medusa-agent-skills`, commit `c584f79`) to the VS Code Copilot skill format. The canonical name is `medusa-dev-building-with-medusa`.
...
- **No `allowed-tools` restriction:** The Claude original frontmatter did not include `allowed-tools`, and Copilot does not support this field. Copilot uses normal terminal approval workflows — the user is prompted before terminal commands execute.
- **Destructive operations require human confirmation:** Operations such as `db:migrate`, `db:generate`, user creation, and any database mutations must be explicitly confirmed by the user before execution. Never run destructive commands automatically.
- **Canonical name:** The `name` field is `medusa-dev-building-with-medusa` (matching the directory name), not `building-with-medusa` from the original. When referencing this skill, use the canonical name.
...
- [reference/subscribers-and-events.md](reference/subscribers-and-events.md) - Event handling
- [reference/troubleshooting.md](reference/troubleshooting.md) - Common errors and solutions
- [reference/workflow-hooks.md](reference/workflow-hooks.md) - Workflow hook patterns
- [reference/data-models.md](reference/data-models.md) - Data model definitions
- [reference/frontend-integration.md](reference/frontend-integration.md) - Frontend integration patterns
