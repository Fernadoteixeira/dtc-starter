...
maturity: "canonical"
version: "1.0.0"
tags: ["analytics", "data", "databases", "logical", "model", "modeling"]
---
...
Produce a defensible, executable and measurable approach to **logical data model** within the broader capability of **data modeling**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Represents business information from concept to physical storage.

This skill owns the decision and execution contract for **logical data model**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **logical data model**.
...
- Logical Data Model decision brief
...
1. Frame the exact decision or outcome governed by logical data model.
...
```text
Act as the accountable owner for Logical Data Model.
