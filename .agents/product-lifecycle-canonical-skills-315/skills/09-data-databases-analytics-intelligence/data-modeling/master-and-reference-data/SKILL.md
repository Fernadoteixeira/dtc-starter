---
id: "PLC-135"
name: "master-and-reference-data"
...
capability_pack: "data-modeling"
capability_pack_title: "Data Modeling"
...
maturity: "canonical"
version: "1.0.0"
tags: ["analytics", "data", "databases", "master", "modeling", "reference"]
---
...
Produce a defensible, executable and measurable approach to **master and reference data** within the broader capability of **data modeling**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Represents business information from concept to physical storage.

This skill owns the decision and execution contract for **master and reference data**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **master and reference data**.
...
- Master and Reference Data decision brief
...
1. Frame the exact decision or outcome governed by master and reference data.
...
```yaml
skill_id: PLC-135
skill: master-and-reference-data
...
```text
Act as the accountable owner for Master and Reference Data.
