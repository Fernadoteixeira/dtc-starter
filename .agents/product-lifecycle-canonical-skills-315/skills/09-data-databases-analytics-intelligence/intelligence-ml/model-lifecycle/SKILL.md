...
maturity: "canonical"
version: "1.0.0"
tags: ["analytics", "data", "databases", "intelligence", "lifecycle", "ml", "model"]
---
...
Produce a defensible, executable and measurable approach to **model lifecycle** within the broader capability of **intelligence and machine learning**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Applies machine learning with lifecycle and responsibility controls.

This skill owns the decision and execution contract for **model lifecycle**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **model lifecycle**.
...
- Model Lifecycle decision brief
...
1. Frame the exact decision or outcome governed by model lifecycle.
...
```text
Act as the accountable owner for Model Lifecycle.
