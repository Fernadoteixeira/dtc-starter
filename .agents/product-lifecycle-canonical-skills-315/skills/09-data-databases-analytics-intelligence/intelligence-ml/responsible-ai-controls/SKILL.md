...
maturity: "canonical"
version: "1.0.0"
tags: ["ai", "analytics", "controls", "data", "databases", "intelligence", "ml", "responsible"]
---
...
Produce a defensible, executable and measurable approach to **responsible ai controls** within the broader capability of **intelligence and machine learning**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Applies machine learning with lifecycle and responsibility controls.

This skill owns the decision and execution contract for **responsible ai controls**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **responsible ai controls**.
...
- Responsible AI Controls decision brief
...
1. Frame the exact decision or outcome governed by responsible ai controls.
...
```text
Act as the accountable owner for Responsible AI Controls.
