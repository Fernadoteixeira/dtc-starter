---
id: "PLC-148"
name: "machine-learning-opportunity-assessment"
title: "Machine Learning Opportunity Assessment"
...
capability_pack: "intelligence-ml"
capability_pack_title: "Intelligence and Machine Learning"
...
maturity: "canonical"
version: "1.0.0"
tags: ["analytics", "assessment", "data", "databases", "intelligence", "learning", "machine", "ml", "opportunity"]
---
...
Produce a defensible, executable and measurable approach to **machine learning opportunity assessment** within the broader capability of **intelligence and machine learning**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Applies machine learning with lifecycle and responsibility controls.

This skill owns the decision and execution contract for **machine learning opportunity assessment**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **machine learning opportunity assessment**.
...
- Machine Learning Opportunity Assessment decision brief
...
1. Frame the exact decision or outcome governed by machine learning opportunity assessment.
...
```yaml
skill_id: PLC-148
skill: machine-learning-opportunity-assessment
...
```text
Act as the accountable owner for Machine Learning Opportunity Assessment.
