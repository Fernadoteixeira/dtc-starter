---
id: "PLC-149"
name: "feature-data-design"
title: "Feature Data Design"
...
maturity: "canonical"
version: "1.0.0"
tags: ["analytics", "data", "databases", "design", "feature", "intelligence", "ml"]
---
...
Produce a defensible, executable and measurable approach to **feature data design** within the broader capability of **intelligence and machine learning**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Applies machine learning with lifecycle and responsibility controls.

This skill owns the decision and execution contract for **feature data design**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **feature data design**.
...
- Feature Data Design decision brief
...
1. Frame the exact decision or outcome governed by feature data design.
...
```text
Act as the accountable owner for Feature Data Design.
