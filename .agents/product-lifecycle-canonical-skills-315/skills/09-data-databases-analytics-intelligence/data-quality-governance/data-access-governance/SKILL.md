...
maturity: "canonical"
version: "1.0.0"
tags: ["access", "analytics", "data", "databases", "governance", "quality"]
---
...
Produce a defensible, executable and measurable approach to **data access governance** within the broader capability of **data quality and governance**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Protects quality, lineage, retention and access.

This skill owns the decision and execution contract for **data access governance**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **data access governance**.
...
- Data Access Governance decision brief
...
1. Frame the exact decision or outcome governed by data access governance.
...
```text
Act as the accountable owner for Data Access Governance.
