---
id: "PLC-145"
name: "lineage-and-metadata"
title: "Lineage and Metadata"
...
capability_pack: "data-quality-governance"
capability_pack_title: "Data Quality and Governance"
...
maturity: "canonical"
version: "1.0.0"
tags: ["analytics", "data", "databases", "governance", "lineage", "metadata", "quality"]
---
...
Produce a defensible, executable and measurable approach to **lineage and metadata** within the broader capability of **data quality and governance**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Protects quality, lineage, retention and access.

This skill owns the decision and execution contract for **lineage and metadata**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **lineage and metadata**.
...
- Lineage and Metadata decision brief
...
1. Frame the exact decision or outcome governed by lineage and metadata.
...
```text
Act as the accountable owner for Lineage and Metadata.
