...
maturity: "canonical"
version: "1.0.0"
tags: ["analytics", "data", "databases", "governance", "quality", "rules"]
---
...
Produce a defensible, executable and measurable approach to **data quality rules** within the broader capability of **data quality and governance**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Protects quality, lineage, retention and access.

This skill owns the decision and execution contract for **data quality rules**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **data quality rules**.
...
- Data Quality Rules decision brief
...
1. Frame the exact decision or outcome governed by data quality rules.
...
```text
Act as the accountable owner for Data Quality Rules.
