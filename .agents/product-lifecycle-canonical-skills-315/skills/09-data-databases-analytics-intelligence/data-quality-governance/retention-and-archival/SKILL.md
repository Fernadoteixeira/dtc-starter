...
maturity: "canonical"
version: "1.0.0"
tags: ["analytics", "archival", "data", "databases", "governance", "quality", "retention"]
---
...
Produce a defensible, executable and measurable approach to **retention and archival** within the broader capability of **data quality and governance**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Protects quality, lineage, retention and access.

This skill owns the decision and execution contract for **retention and archival**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **retention and archival**.
...
- Retention and Archival decision brief
...
1. Frame the exact decision or outcome governed by retention and archival.
...
```text
Act as the accountable owner for Retention and Archival.
