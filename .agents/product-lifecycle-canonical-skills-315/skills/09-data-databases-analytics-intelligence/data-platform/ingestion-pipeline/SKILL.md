...
maturity: "canonical"
version: "1.0.0"
tags: ["analytics", "data", "databases", "ingestion", "pipeline", "platform"]
---
...
Produce a defensible, executable and measurable approach to **ingestion pipeline** within the broader capability of **data platform**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Moves, transforms, stores and serves data reliably.

This skill owns the decision and execution contract for **ingestion pipeline**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **ingestion pipeline**.
...
- Ingestion Pipeline decision brief
...
1. Frame the exact decision or outcome governed by ingestion pipeline.
...
```text
Act as the accountable owner for Ingestion Pipeline.
