...
maturity: "canonical"
version: "1.0.0"
tags: ["analytics", "data", "databases", "platform", "serving"]
---
...
Produce a defensible, executable and measurable approach to **data serving** within the broader capability of **data platform**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Moves, transforms, stores and serves data reliably.

This skill owns the decision and execution contract for **data serving**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **data serving**.
...
1. Frame the exact decision or outcome governed by data serving.
...
```text
Act as the accountable owner for Data Serving.
