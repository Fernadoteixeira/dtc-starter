...
capability_pack: "data-platform"
capability_pack_title: "Data Platform"
...
maturity: "canonical"
version: "1.0.0"
tags: ["analytics", "data", "databases", "modeling", "platform", "transformation"]
---
...
Produce a defensible, executable and measurable approach to **transformation modeling** within the broader capability of **data platform**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Moves, transforms, stores and serves data reliably.

This skill owns the decision and execution contract for **transformation modeling**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **transformation modeling**.
...
- Transformation Modeling decision brief
...
1. Frame the exact decision or outcome governed by transformation modeling.
...
```text
Act as the accountable owner for Transformation Modeling.
