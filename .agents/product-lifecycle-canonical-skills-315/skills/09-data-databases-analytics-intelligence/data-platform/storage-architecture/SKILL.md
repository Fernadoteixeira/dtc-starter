...
maturity: "canonical"
version: "1.0.0"
tags: ["analytics", "architecture", "data", "databases", "platform", "storage"]
---
...
Produce a defensible, executable and measurable approach to **storage architecture** within the broader capability of **data platform**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Moves, transforms, stores and serves data reliably.

This skill owns the decision and execution contract for **storage architecture**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **storage architecture**.
...
- Storage Architecture decision brief
...
1. Frame the exact decision or outcome governed by storage architecture.
...
```text
Act as the accountable owner for Storage Architecture.
