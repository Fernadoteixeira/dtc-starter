...
maturity: "canonical"
version: "1.0.0"
tags: ["analytical", "analytics", "data", "databases", "modeling"]
---
...
Produce a defensible, executable and measurable approach to **analytical modeling** within the broader capability of **analytics**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines trustworthy metrics and decision-oriented analytical products.

This skill owns the decision and execution contract for **analytical modeling**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **analytical modeling**.
...
- Analytical Modeling decision brief
...
1. Frame the exact decision or outcome governed by analytical modeling.
...
```text
Act as the accountable owner for Analytical Modeling.
