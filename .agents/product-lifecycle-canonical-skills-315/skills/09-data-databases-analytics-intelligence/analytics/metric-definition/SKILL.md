...
maturity: "canonical"
version: "1.0.0"
tags: ["analytics", "data", "databases", "definition", "metric"]
---
...
Produce a defensible, executable and measurable approach to **metric definition** within the broader capability of **analytics**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines trustworthy metrics and decision-oriented analytical products.

This skill owns the decision and execution contract for **metric definition**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **metric definition**.
...
- Metric Definition decision brief
...
1. Frame the exact decision or outcome governed by metric definition.
...
```text
Act as the accountable owner for Metric Definition.
