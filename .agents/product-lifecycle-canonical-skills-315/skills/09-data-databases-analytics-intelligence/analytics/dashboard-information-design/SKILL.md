---
id: "PLC-143"
name: "dashboard-information-design"
title: "Dashboard Information Design"
...
maturity: "canonical"
version: "1.0.0"
tags: ["analytics", "dashboard", "data", "databases", "design", "information"]
---
...
Produce a defensible, executable and measurable approach to **dashboard information design** within the broader capability of **analytics**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines trustworthy metrics and decision-oriented analytical products.

This skill owns the decision and execution contract for **dashboard information design**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **dashboard information design**.
...
- Dashboard Information Design decision brief
...
1. Frame the exact decision or outcome governed by dashboard information design.
...
```yaml
skill_id: PLC-143
skill: dashboard-information-design
...
```text
Act as the accountable owner for Dashboard Information Design.
