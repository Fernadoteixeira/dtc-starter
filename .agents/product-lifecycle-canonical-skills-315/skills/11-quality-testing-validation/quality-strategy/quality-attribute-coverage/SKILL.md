...
title: "Quality Attribute Coverage"
...
maturity: "canonical"
version: "1.0.0"
tags: ["attribute", "coverage", "quality", "strategy", "testing", "validation"]
---
...
Produce a defensible, executable and measurable approach to **quality attribute coverage** within the broader capability of **quality strategy**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Aligns validation effort to product and technical risk.

This skill owns the decision and execution contract for **quality attribute coverage**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **quality attribute coverage**.
...
- Quality Attribute Coverage decision brief
...
1. Frame the exact decision or outcome governed by quality attribute coverage.
...
```yaml
skill_id: PLC-171
skill: quality-attribute-coverage
...
```text
Act as the accountable owner for Quality Attribute Coverage.
