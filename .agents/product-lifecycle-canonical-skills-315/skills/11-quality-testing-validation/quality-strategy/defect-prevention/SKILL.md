...
maturity: "canonical"
version: "1.0.0"
tags: ["defect", "prevention", "quality", "strategy", "testing", "validation"]
---
...
Produce a defensible, executable and measurable approach to **defect prevention** within the broader capability of **quality strategy**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Aligns validation effort to product and technical risk.

This skill owns the decision and execution contract for **defect prevention**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **defect prevention**.
...
- Defect Prevention decision brief
...
1. Frame the exact decision or outcome governed by defect prevention.
...
```text
Act as the accountable owner for Defect Prevention.
