...
maturity: "canonical"
version: "1.0.0"
tags: ["based", "quality", "risk", "strategy", "test", "testing", "validation"]
---
...
Produce a defensible, executable and measurable approach to **risk based test strategy** within the broader capability of **quality strategy**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Aligns validation effort to product and technical risk.

This skill owns the decision and execution contract for **risk based test strategy**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **risk based test strategy**.
...
- Risk Based Test Strategy decision brief
...
1. Frame the exact decision or outcome governed by risk based test strategy.
...
```yaml
skill_id: PLC-170
skill: risk-based-test-strategy
...
```text
Act as the accountable owner for Risk Based Test Strategy.
