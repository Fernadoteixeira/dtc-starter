...
maturity: "canonical"
version: "1.0.0"
tags: ["automated", "design", "integration", "quality", "test", "testing", "validation"]
---
...
Produce a defensible, executable and measurable approach to **integration test design** within the broader capability of **automated validation**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Builds layered automated evidence across the system.

This skill owns the decision and execution contract for **integration test design**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **integration test design**.
...
- Integration Test Design decision brief
...
1. Frame the exact decision or outcome governed by integration test design.
...
```text
Act as the accountable owner for Integration Test Design.
