...
title: "End to End Test Design"
kind: "atomic-capability"
domain: "11-quality-testing-validation"
domain_title: "Quality, Testing and Validation"
capability_pack: "automated-validation"
capability_pack_title: "Automated Validation"
...
maturity: "canonical"
version: "1.0.0"
tags: ["automated", "end", "quality", "test", "testing", "validation"]
---
...
Produce a defensible, executable and measurable approach to **end to end test design** within the broader capability of **automated validation**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Builds layered automated evidence across the system.

This skill owns the decision and execution contract for **end to end test design**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **end to end test design**.
...
- End to End Test Design decision brief
...
1. Frame the exact decision or outcome governed by end to end test design.
...
```text
Act as the accountable owner for End to End Test Design.
