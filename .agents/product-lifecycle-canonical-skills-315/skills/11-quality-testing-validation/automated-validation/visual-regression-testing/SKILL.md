...
maturity: "canonical"
version: "1.0.0"
tags: ["automated", "quality", "regression", "testing", "validation", "visual"]
---
...
Produce a defensible, executable and measurable approach to **visual regression testing** within the broader capability of **automated validation**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Builds layered automated evidence across the system.

This skill owns the decision and execution contract for **visual regression testing**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **visual regression testing**.
...
- Visual Regression Testing decision brief
...
1. Frame the exact decision or outcome governed by visual regression testing.
...
```text
Act as the accountable owner for Visual Regression Testing.
