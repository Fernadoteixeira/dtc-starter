...
maturity: "canonical"
version: "1.0.0"
tags: ["assurance", "governance", "quality", "security", "testing", "validation"]
---
...
Produce a defensible, executable and measurable approach to **security validation** within the broader capability of **assurance and governance**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Controls specialized validation, environments and release confidence.

This skill owns the decision and execution contract for **security validation**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **security validation**.
...
- Security Validation decision brief
...
1. Frame the exact decision or outcome governed by security validation.
...
```text
Act as the accountable owner for Security Validation.
