---
id: "PLC-187"
name: "release-quality-assessment"
title: "Release Quality Assessment"
kind: "atomic-capability"
domain: "11-quality-testing-validation"
domain_title: "Quality, Testing and Validation"
capability_pack: "assurance-governance"
capability_pack_title: "Assurance and Governance"
...
maturity: "canonical"
version: "1.0.0"
tags: ["assessment", "assurance", "governance", "quality", "release", "testing", "validation"]
---
...
Produce a defensible, executable and measurable approach to **release quality assessment** within the broader capability of **assurance and governance**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Controls specialized validation, environments and release confidence.

This skill owns the decision and execution contract for **release quality assessment**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **release quality assessment**.
...
- Release Quality Assessment decision brief
...
1. Frame the exact decision or outcome governed by release quality assessment.
...
```yaml
skill_id: PLC-187
skill: release-quality-assessment
...
```text
Act as the accountable owner for Release Quality Assessment.
