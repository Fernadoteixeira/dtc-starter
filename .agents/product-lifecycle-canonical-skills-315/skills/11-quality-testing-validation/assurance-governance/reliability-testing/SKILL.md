...
maturity: "canonical"
version: "1.0.0"
tags: ["assurance", "governance", "quality", "reliability", "testing", "validation"]
---
...
Produce a defensible, executable and measurable approach to **reliability testing** within the broader capability of **assurance and governance**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Controls specialized validation, environments and release confidence.

This skill owns the decision and execution contract for **reliability testing**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **reliability testing**.
...
- Reliability Testing decision brief
...
1. Frame the exact decision or outcome governed by reliability testing.
...
```text
Act as the accountable owner for Reliability Testing.
