---
id: "PLC-065"
name: "actor-ecosystem-mapping"
title: "Actor Ecosystem Mapping"
...
maturity: "canonical"
version: "1.0.0"
tags: ["actor", "design", "ecosystem", "mapping", "service", "ux"]
---

# Actor Ecosystem Mapping

## Canonical outcome

Produce a defensible, executable and measurable approach to **actor ecosystem mapping** within the broader capability of **service design**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Designs end-to-end service delivery across people, process and technology.

This skill owns the decision and execution contract for **actor ecosystem mapping**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **actor ecosystem mapping**.
...
- Actor Ecosystem Mapping decision brief
...
1. Frame the exact decision or outcome governed by actor ecosystem mapping.
...
```text
Act as the accountable owner for Actor Ecosystem Mapping.
