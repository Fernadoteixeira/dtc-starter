...
maturity: "canonical"
version: "1.0.0"
tags: ["design", "failure", "recovery", "service", "ux"]
---
...
Produce a defensible, executable and measurable approach to **service failure recovery** within the broader capability of **service design**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Designs end-to-end service delivery across people, process and technology.

This skill owns the decision and execution contract for **service failure recovery**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **service failure recovery**.
...
- Service Failure Recovery decision brief
...
1. Frame the exact decision or outcome governed by service failure recovery.
...
```yaml
skill_id: PLC-067
skill: service-failure-recovery
...
```text
Act as the accountable owner for Service Failure Recovery.
