---
id: "PLC-066"
name: "frontstage-backstage-design"
title: "Frontstage Backstage Design"
...
capability_pack: "service-design"
capability_pack_title: "Service Design"
...
maturity: "canonical"
version: "1.0.0"
tags: ["backstage", "design", "frontstage", "service", "ux"]
---
...
Produce a defensible, executable and measurable approach to **frontstage backstage design** within the broader capability of **service design**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Designs end-to-end service delivery across people, process and technology.

This skill owns the decision and execution contract for **frontstage backstage design**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **frontstage backstage design**.
...
- Frontstage Backstage Design decision brief
...
1. Frame the exact decision or outcome governed by frontstage backstage design.
...
```yaml
skill_id: PLC-066
skill: frontstage-backstage-design
...
```text
Act as the accountable owner for Frontstage Backstage Design.
