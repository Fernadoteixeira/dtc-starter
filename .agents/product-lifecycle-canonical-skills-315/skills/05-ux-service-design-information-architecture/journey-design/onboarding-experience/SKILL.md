...
maturity: "canonical"
version: "1.0.0"
tags: ["design", "experience", "journey", "onboarding", "service", "ux"]
---
...
Produce a defensible, executable and measurable approach to **onboarding experience** within the broader capability of **journey design**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Structures user goals, transitions, onboarding and conversion.

This skill owns the decision and execution contract for **onboarding experience**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **onboarding experience**.
...
- Onboarding Experience decision brief
...
1. Frame the exact decision or outcome governed by onboarding experience.
...
```text
Act as the accountable owner for Onboarding Experience.
