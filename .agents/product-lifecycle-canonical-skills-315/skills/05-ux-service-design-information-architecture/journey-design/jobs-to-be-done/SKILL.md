...
maturity: "canonical"
version: "1.0.0"
tags: ["be", "design", "done", "jobs", "journey", "service", "ux"]
---
...
Produce a defensible, executable and measurable approach to **jobs to be done** within the broader capability of **journey design**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Structures user goals, transitions, onboarding and conversion.

This skill owns the decision and execution contract for **jobs to be done**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **jobs to be done**.
...
- Jobs to Be Done decision brief
...
1. Frame the exact decision or outcome governed by jobs to be done.
...
```text
Act as the accountable owner for Jobs to Be Done.
