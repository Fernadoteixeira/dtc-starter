---
id: "PLC-068"
name: "persona-and-archetype-modeling"
title: "Persona and Archetype Modeling"
...
capability_pack: "journey-design"
capability_pack_title: "Journey Design"
...
maturity: "canonical"
version: "1.0.0"
tags: ["archetype", "design", "journey", "modeling", "persona", "service", "ux"]
---

# Persona and Archetype Modeling

## Canonical outcome

Produce a defensible, executable and measurable approach to **persona and archetype modeling** within the broader capability of **journey design**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Structures user goals, transitions, onboarding and conversion.

This skill owns the decision and execution contract for **persona and archetype modeling**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **persona and archetype modeling**.
...
- Persona and Archetype Modeling decision brief
...
1. Frame the exact decision or outcome governed by persona and archetype modeling.
...
```yaml
skill_id: PLC-068
skill: persona-and-archetype-modeling
...
```text
Act as the accountable owner for Persona and Archetype Modeling.
