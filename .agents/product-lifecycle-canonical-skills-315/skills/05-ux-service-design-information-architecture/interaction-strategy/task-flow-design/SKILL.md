...
maturity: "canonical"
version: "1.0.0"
tags: ["design", "flow", "interaction", "service", "strategy", "task", "ux"]
---
...
Produce a defensible, executable and measurable approach to **task flow design** within the broader capability of **interaction strategy**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines task flow, state feedback and interaction patterns.

This skill owns the decision and execution contract for **task flow design**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **task flow design**.
...
- Task Flow Design decision brief
...
1. Frame the exact decision or outcome governed by task flow design.
...
```text
Act as the accountable owner for Task Flow Design.
