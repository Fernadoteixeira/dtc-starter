---
id: "PLC-080"
name: "feedback-state-design"
title: "Feedback State Design"
...
capability_pack: "interaction-strategy"
capability_pack_title: "Interaction Strategy"
...
maturity: "canonical"
version: "1.0.0"
tags: ["design", "feedback", "interaction", "service", "state", "strategy", "ux"]
---

# Feedback State Design

## Canonical outcome

Produce a defensible, executable and measurable approach to **feedback state design** within the broader capability of **interaction strategy**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines task flow, state feedback and interaction patterns.

This skill owns the decision and execution contract for **feedback state design**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **feedback state design**.
...
- Feedback State Design decision brief
...
1. Frame the exact decision or outcome governed by feedback state design.
...
```text
Act as the accountable owner for Feedback State Design.
