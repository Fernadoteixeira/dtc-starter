...
maturity: "canonical"
version: "1.0.0"
tags: ["design", "interaction", "model", "service", "strategy", "ux"]
---
...
Produce a defensible, executable and measurable approach to **interaction model** within the broader capability of **interaction strategy**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines task flow, state feedback and interaction patterns.

This skill owns the decision and execution contract for **interaction model**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **interaction model**.
...
- Interaction Model decision brief
...
1. Frame the exact decision or outcome governed by interaction model.
...
```text
Act as the accountable owner for Interaction Model.
