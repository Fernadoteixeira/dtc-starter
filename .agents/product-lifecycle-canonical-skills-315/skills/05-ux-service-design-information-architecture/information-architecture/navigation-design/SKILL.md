...
maturity: "canonical"
version: "1.0.0"
tags: ["architecture", "design", "information", "navigation", "service", "ux"]
---
...
Produce a defensible, executable and measurable approach to **navigation design** within the broader capability of **information architecture**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Organizes content, navigation, taxonomy and findability.

This skill owns the decision and execution contract for **navigation design**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **navigation design**.
...
- Navigation Design decision brief
...
1. Frame the exact decision or outcome governed by navigation design.
...
```text
Act as the accountable owner for Navigation Design.
