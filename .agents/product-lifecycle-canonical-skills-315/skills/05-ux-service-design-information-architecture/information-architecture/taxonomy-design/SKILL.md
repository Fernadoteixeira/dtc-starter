...
maturity: "canonical"
version: "1.0.0"
tags: ["architecture", "design", "information", "service", "taxonomy", "ux"]
---
...
Produce a defensible, executable and measurable approach to **taxonomy design** within the broader capability of **information architecture**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Organizes content, navigation, taxonomy and findability.

This skill owns the decision and execution contract for **taxonomy design**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **taxonomy design**.
...
- Taxonomy Design decision brief
...
1. Frame the exact decision or outcome governed by taxonomy design.
...
```text
Act as the accountable owner for Taxonomy Design.
