---
id: "PLC-076"
name: "findability-and-search-design"
title: "Findability and Search Design"
kind: "atomic-capability"
domain: "05-ux-service-design-information-architecture"
domain_title: "UX, Service Design and Information Architecture"
capability_pack: "information-architecture"
capability_pack_title: "Information Architecture"
technology_agnostic: true
language_agnostic: true
industry_agnostic: true
lifecycle_modes: ["research", "map", "design", "prototype", "validate", "optimize"]
maturity: "canonical"
version: "1.0.0"
tags: ["architecture", "design", "findability", "information", "search", "service", "ux"]
---

# Findability and Search Design

## Canonical outcome

Produce a defensible, executable and measurable approach to **findability and search design** within the broader capability of **information architecture**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Organizes content, navigation, taxonomy and findability.

This skill owns the decision and execution contract for **findability and search design**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **findability and search design**.
...
- Findability and Search Design decision brief
...
Expected artifact families for this domain include: journey map, service blueprint, task flow, information architecture.

## Operating workflow

1. Frame the exact decision or outcome governed by findability and search design.
...
- Design the whole service, not only the screen.
- Represent failure and recovery.
- Prioritize user comprehension over novelty.
...
```yaml
skill_id: PLC-076
skill: findability-and-search-design
...
```text
Act as the accountable owner for Findability and Search Design.
