...
maturity: "canonical"
version: "1.0.0"
tags: ["architecture", "content", "design", "information", "inventory", "service", "ux"]
---
...
Produce a defensible, executable and measurable approach to **content inventory** within the broader capability of **information architecture**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Organizes content, navigation, taxonomy and findability.

This skill owns the decision and execution contract for **content inventory**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **content inventory**.
...
- Content Inventory decision brief
...
1. Frame the exact decision or outcome governed by content inventory.
...
```text
Act as the accountable owner for Content Inventory.
