---
id: "PLC-086"
name: "pattern-library-governance"
title: "Pattern Library Governance"
...
capability_pack: "design-system"
capability_pack_title: "Design System"
...
maturity: "canonical"
version: "1.0.0"
tags: ["design", "governance", "library", "pattern", "system", "ui"]
---
...
Produce a defensible, executable and measurable approach to **pattern library governance** within the broader capability of **design system**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Creates reusable tokens, components, patterns and governance.

This skill owns the decision and execution contract for **pattern library governance**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **pattern library governance**.
...
- Pattern Library Governance decision brief
...
1. Frame the exact decision or outcome governed by pattern library governance.
...
```yaml
skill_id: PLC-086
skill: pattern-library-governance
...
```text
Act as the accountable owner for Pattern Library Governance.
