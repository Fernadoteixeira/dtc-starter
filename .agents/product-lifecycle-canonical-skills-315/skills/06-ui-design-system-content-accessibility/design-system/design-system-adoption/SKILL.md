...
maturity: "canonical"
version: "1.0.0"
tags: ["adoption", "design", "system", "ui"]
---
...
Produce a defensible, executable and measurable approach to **design system adoption** within the broader capability of **design system**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Creates reusable tokens, components, patterns and governance.

This skill owns the decision and execution contract for **design system adoption**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **design system adoption**.
...
- Design System Adoption decision brief
...
1. Frame the exact decision or outcome governed by design system adoption.
...
```text
Act as the accountable owner for Design System Adoption.
