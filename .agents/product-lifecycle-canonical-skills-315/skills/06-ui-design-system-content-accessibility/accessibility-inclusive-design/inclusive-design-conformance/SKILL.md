---
id: "PLC-098"
name: "inclusive-design-conformance"
title: "Inclusive Design Conformance"
...
maturity: "canonical"
version: "1.0.0"
tags: ["accessibility", "conformance", "design", "inclusive", "system", "ui"]
---

# Inclusive Design Conformance

## Canonical outcome

Produce a defensible, executable and measurable approach to **inclusive design conformance** within the broader capability of **accessibility and inclusive design**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Designs for diverse abilities, technologies and contexts.

This skill owns the decision and execution contract for **inclusive design conformance**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **inclusive design conformance**.
...
- Inclusive Design Conformance decision brief
...
1. Frame the exact decision or outcome governed by inclusive design conformance.
...
```yaml
skill_id: PLC-098
skill: inclusive-design-conformance
...
```text
Act as the accountable owner for Inclusive Design Conformance.
