...
maturity: "canonical"
version: "1.0.0"
tags: ["accessibility", "design", "focus", "inclusive", "keyboard", "system", "ui"]
---
...
Produce a defensible, executable and measurable approach to **keyboard and focus accessibility** within the broader capability of **accessibility and inclusive design**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Designs for diverse abilities, technologies and contexts.

This skill owns the decision and execution contract for **keyboard and focus accessibility**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **keyboard and focus accessibility**.
...
- Keyboard and Focus Accessibility decision brief
...
1. Frame the exact decision or outcome governed by keyboard and focus accessibility.
...
```yaml
skill_id: PLC-095
skill: keyboard-and-focus-accessibility
...
```text
Act as the accountable owner for Keyboard and Focus Accessibility.
