...
maturity: "canonical"
version: "1.0.0"
tags: ["accessibility", "design", "inclusive", "semantic", "system", "ui"]
---
...
Produce a defensible, executable and measurable approach to **semantic accessibility** within the broader capability of **accessibility and inclusive design**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Designs for diverse abilities, technologies and contexts.

This skill owns the decision and execution contract for **semantic accessibility**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **semantic accessibility**.
...
- Semantic Accessibility decision brief
...
1. Frame the exact decision or outcome governed by semantic accessibility.
...
```text
Act as the accountable owner for Semantic Accessibility.
