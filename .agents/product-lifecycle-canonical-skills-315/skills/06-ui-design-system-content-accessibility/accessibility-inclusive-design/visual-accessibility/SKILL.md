...
maturity: "canonical"
version: "1.0.0"
tags: ["accessibility", "design", "inclusive", "system", "ui", "visual"]
---
...
Produce a defensible, executable and measurable approach to **visual accessibility** within the broader capability of **accessibility and inclusive design**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Designs for diverse abilities, technologies and contexts.

This skill owns the decision and execution contract for **visual accessibility**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **visual accessibility**.
...
- Visual Accessibility decision brief
...
1. Frame the exact decision or outcome governed by visual accessibility.
...
```text
Act as the accountable owner for Visual Accessibility.
