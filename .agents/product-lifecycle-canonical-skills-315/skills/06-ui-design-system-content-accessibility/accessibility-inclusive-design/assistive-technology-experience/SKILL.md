---
id: "PLC-097"
name: "assistive-technology-experience"
title: "Assistive Technology Experience"
kind: "atomic-capability"
domain: "06-ui-design-system-content-accessibility"
domain_title: "UI, Design Systems, Content and Accessibility"
capability_pack: "accessibility-inclusive-design"
capability_pack_title: "Accessibility and Inclusive Design"
technology_agnostic: true
language_agnostic: true
industry_agnostic: true
lifecycle_modes: ["audit", "design", "prototype", "implement", "verify", "govern"]
maturity: "canonical"
version: "1.0.0"
tags: ["accessibility", "assistive", "design", "experience", "inclusive", "system", "technology", "ui"]
---
...
Produce a defensible, executable and measurable approach to **assistive technology experience** within the broader capability of **accessibility and inclusive design**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Designs for diverse abilities, technologies and contexts.

This skill owns the decision and execution contract for **assistive technology experience**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **assistive technology experience**.
...
- Assistive Technology Experience decision brief
...
Expected artifact families for this domain include: interface specification, design token, component contract, accessibility evidence.

## Operating workflow

1. Frame the exact decision or outcome governed by assistive technology experience.
...
- Use motion and content to explain state.
...
```yaml
skill_id: PLC-097
skill: assistive-technology-experience
...
```text
Act as the accountable owner for Assistive Technology Experience.
