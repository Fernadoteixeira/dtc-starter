...
maturity: "canonical"
version: "1.0.0"
tags: ["design", "hierarchy", "language", "system", "ui", "visual"]
---
...
Produce a defensible, executable and measurable approach to **visual hierarchy** within the broader capability of **visual language**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Translates brand and hierarchy into a coherent interface language.

This skill owns the decision and execution contract for **visual hierarchy**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **visual hierarchy**.
...
- Visual Hierarchy decision brief
...
1. Frame the exact decision or outcome governed by visual hierarchy.
...
```text
Act as the accountable owner for Visual Hierarchy.
