---
id: "PLC-081"
name: "brand-interface-alignment"
title: "Brand Interface Alignment"
...
capability_pack: "visual-language"
capability_pack_title: "Visual Language"
...
maturity: "canonical"
version: "1.0.0"
tags: ["alignment", "brand", "design", "interface", "language", "system", "ui", "visual"]
---

# Brand Interface Alignment

## Canonical outcome

Produce a defensible, executable and measurable approach to **brand interface alignment** within the broader capability of **visual language**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Translates brand and hierarchy into a coherent interface language.

This skill owns the decision and execution contract for **brand interface alignment**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **brand interface alignment**.
...
- Brand Interface Alignment decision brief
...
1. Frame the exact decision or outcome governed by brand interface alignment.
...
```yaml
skill_id: PLC-081
skill: brand-interface-alignment
...
```text
Act as the accountable owner for Brand Interface Alignment.
