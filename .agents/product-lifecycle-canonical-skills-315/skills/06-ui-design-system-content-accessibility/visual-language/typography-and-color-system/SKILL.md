---
id: "PLC-083"
name: "typography-and-color-system"
...
maturity: "canonical"
version: "1.0.0"
tags: ["color", "design", "language", "system", "typography", "ui", "visual"]
---
...
Produce a defensible, executable and measurable approach to **typography and color system** within the broader capability of **visual language**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Translates brand and hierarchy into a coherent interface language.

This skill owns the decision and execution contract for **typography and color system**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **typography and color system**.
...
- Typography and Color System decision brief
...
1. Frame the exact decision or outcome governed by typography and color system.
...
```yaml
skill_id: PLC-083
skill: typography-and-color-system
...
```text
Act as the accountable owner for Typography and Color System.
