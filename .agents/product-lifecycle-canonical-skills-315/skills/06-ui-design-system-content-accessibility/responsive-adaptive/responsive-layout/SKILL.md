...
maturity: "canonical"
version: "1.0.0"
tags: ["adaptive", "design", "layout", "responsive", "system", "ui"]
---
...
Produce a defensible, executable and measurable approach to **responsive layout** within the broader capability of **responsive and adaptive experience**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Ensures coherent behavior across devices, contexts and capabilities.

This skill owns the decision and execution contract for **responsive layout**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **responsive layout**.
...
- Responsive Layout decision brief
...
1. Frame the exact decision or outcome governed by responsive layout.
...
```text
Act as the accountable owner for Responsive Layout.
