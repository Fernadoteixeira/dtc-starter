...
maturity: "canonical"
version: "1.0.0"
tags: ["adaptive", "design", "experience", "responsive", "system", "ui"]
---
...
Produce a defensible, executable and measurable approach to **adaptive experience** within the broader capability of **responsive and adaptive experience**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Ensures coherent behavior across devices, contexts and capabilities.

This skill owns the decision and execution contract for **adaptive experience**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **adaptive experience**.
...
- Adaptive Experience decision brief
...
1. Frame the exact decision or outcome governed by adaptive experience.
...
```text
Act as the accountable owner for Adaptive Experience.
