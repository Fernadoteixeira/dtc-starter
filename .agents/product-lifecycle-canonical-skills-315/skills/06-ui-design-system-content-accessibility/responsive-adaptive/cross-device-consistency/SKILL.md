...
capability_pack: "responsive-adaptive"
capability_pack_title: "Responsive and Adaptive Experience"
...
maturity: "canonical"
version: "1.0.0"
tags: ["adaptive", "consistency", "cross", "design", "device", "responsive", "system", "ui"]
---
...
Produce a defensible, executable and measurable approach to **cross device consistency** within the broader capability of **responsive and adaptive experience**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Ensures coherent behavior across devices, contexts and capabilities.

This skill owns the decision and execution contract for **cross device consistency**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **cross device consistency**.
...
- Cross Device Consistency decision brief
...
1. Frame the exact decision or outcome governed by cross device consistency.
...
```yaml
skill_id: PLC-090
skill: cross-device-consistency
...
```text
Act as the accountable owner for Cross Device Consistency.
