...
maturity: "canonical"
version: "1.0.0"
tags: ["incident", "management", "observability", "operations", "reliability", "response"]
---
...
Produce a defensible, executable and measurable approach to **incident response** within the broader capability of **incident management**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Detects, coordinates, communicates and learns from incidents.

This skill owns the decision and execution contract for **incident response**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **incident response**.
...
- Incident Response decision brief
...
1. Frame the exact decision or outcome governed by incident response.
...
```text
Act as the accountable owner for Incident Response.
