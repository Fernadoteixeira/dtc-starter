...
maturity: "canonical"
version: "1.0.0"
tags: ["incident", "learning", "management", "observability", "operations", "post", "reliability"]
---
...
Produce a defensible, executable and measurable approach to **post incident learning** within the broader capability of **incident management**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Detects, coordinates, communicates and learns from incidents.

This skill owns the decision and execution contract for **post incident learning**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **post incident learning**.
...
- Post Incident Learning decision brief
...
1. Frame the exact decision or outcome governed by post incident learning.
...
```text
Act as the accountable owner for Post Incident Learning.
