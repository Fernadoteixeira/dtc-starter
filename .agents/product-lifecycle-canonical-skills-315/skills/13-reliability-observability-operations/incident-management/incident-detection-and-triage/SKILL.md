...
maturity: "canonical"
version: "1.0.0"
tags: ["detection", "incident", "management", "observability", "operations", "reliability", "triage"]
---
...
Produce a defensible, executable and measurable approach to **incident detection and triage** within the broader capability of **incident management**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Detects, coordinates, communicates and learns from incidents.

This skill owns the decision and execution contract for **incident detection and triage**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **incident detection and triage**.
...
- Incident Detection and Triage decision brief
...
1. Frame the exact decision or outcome governed by incident detection and triage.
...
```yaml
skill_id: PLC-212
skill: incident-detection-and-triage
...
```text
Act as the accountable owner for Incident Detection and Triage.
