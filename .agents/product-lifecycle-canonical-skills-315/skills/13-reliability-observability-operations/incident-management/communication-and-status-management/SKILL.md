---
id: "PLC-214"
name: "communication-and-status-management"
title: "Communication and Status Management"
kind: "atomic-capability"
domain: "13-reliability-observability-operations"
domain_title: "Reliability, Observability and Operations"
capability_pack: "incident-management"
capability_pack_title: "Incident Management"
technology_agnostic: true
language_agnostic: true
industry_agnostic: true
lifecycle_modes: ["define", "instrument", "operate", "detect", "respond", "learn", "optimize"]
maturity: "canonical"
version: "1.0.0"
tags: ["communication", "incident", "management", "observability", "operations", "reliability", "status"]
---
...
Produce a defensible, executable and measurable approach to **communication and status management** within the broader capability of **incident management**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Detects, coordinates, communicates and learns from incidents.

This skill owns the decision and execution contract for **communication and status management**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **communication and status management**.
...
- Communication and Status Management decision brief
...
Expected artifact families for this domain include: SLO, telemetry model, runbook, incident learning record.

## Operating workflow

1. Frame the exact decision or outcome governed by communication and status management.
...
- Instrument user-visible outcomes.
- Avoid alert noise.
...
```yaml
skill_id: PLC-214
skill: communication-and-status-management
...
```text
Act as the accountable owner for Communication and Status Management.
