...
maturity: "canonical"
version: "1.0.0"
tags: ["excellence", "maintenance", "observability", "operational", "operations", "reliability"]
---
...
Produce a defensible, executable and measurable approach to **maintenance operations** within the broader capability of **operational excellence**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Turns operating knowledge into repeatable readiness and maintenance.

This skill owns the decision and execution contract for **maintenance operations**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **maintenance operations**.
...
- Maintenance Operations decision brief
...
1. Frame the exact decision or outcome governed by maintenance operations.
...
```text
Act as the accountable owner for Maintenance Operations.
