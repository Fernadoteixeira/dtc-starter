...
capability_pack: "operational-excellence"
capability_pack_title: "Operational Excellence"
...
maturity: "canonical"
version: "1.0.0"
tags: ["engineering", "excellence", "observability", "operational", "operations", "reliability", "runbook"]
---
...
Produce a defensible, executable and measurable approach to **runbook engineering** within the broader capability of **operational excellence**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Turns operating knowledge into repeatable readiness and maintenance.

This skill owns the decision and execution contract for **runbook engineering**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **runbook engineering**.
...
- Runbook Engineering decision brief
...
1. Frame the exact decision or outcome governed by runbook engineering.
...
```text
Act as the accountable owner for Runbook Engineering.
