...
maturity: "canonical"
version: "1.0.0"
tags: ["logging", "observability", "operations", "reliability", "strategy"]
---
...
Produce a defensible, executable and measurable approach to **logging strategy** within the broader capability of **observability**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Creates actionable telemetry across logs, metrics and traces.

This skill owns the decision and execution contract for **logging strategy**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **logging strategy**.
...
- Logging Strategy decision brief
...
1. Frame the exact decision or outcome governed by logging strategy.
...
```text
Act as the accountable owner for Logging Strategy.
