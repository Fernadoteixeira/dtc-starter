...
capability_pack: "observability"
capability_pack_title: "Observability"
...
maturity: "canonical"
version: "1.0.0"
tags: ["architecture", "observability", "operations", "reliability", "telemetry"]
---
...
Produce a defensible, executable and measurable approach to **telemetry architecture** within the broader capability of **observability**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Creates actionable telemetry across logs, metrics and traces.

This skill owns the decision and execution contract for **telemetry architecture**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **telemetry architecture**.
...
- Telemetry Architecture decision brief
...
1. Frame the exact decision or outcome governed by telemetry architecture.
...
```text
Act as the accountable owner for Telemetry Architecture.
