...
maturity: "canonical"
version: "1.0.0"
tags: ["observability", "operations", "reliability", "strategy", "tracing"]
---
...
Produce a defensible, executable and measurable approach to **tracing strategy** within the broader capability of **observability**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Creates actionable telemetry across logs, metrics and traces.

This skill owns the decision and execution contract for **tracing strategy**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **tracing strategy**.
...
- Tracing Strategy decision brief
...
1. Frame the exact decision or outcome governed by tracing strategy.
...
```text
Act as the accountable owner for Tracing Strategy.
