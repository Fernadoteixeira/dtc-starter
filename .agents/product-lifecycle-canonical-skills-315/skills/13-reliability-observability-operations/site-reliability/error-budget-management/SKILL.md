...
maturity: "canonical"
version: "1.0.0"
tags: ["budget", "error", "management", "observability", "operations", "reliability", "site"]
---
...
Produce a defensible, executable and measurable approach to **error budget management** within the broader capability of **site reliability**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Manages reliability using objectives, budgets and resilience evidence.

This skill owns the decision and execution contract for **error budget management**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **error budget management**.
...
- Error Budget Management decision brief
...
1. Frame the exact decision or outcome governed by error budget management.
...
```text
Act as the accountable owner for Error Budget Management.
