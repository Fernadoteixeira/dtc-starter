---
id: "PLC-206"
name: "reliability-risk-analysis"
title: "Reliability Risk Analysis"
...
capability_pack: "site-reliability"
capability_pack_title: "Site Reliability"
...
maturity: "canonical"
version: "1.0.0"
tags: ["analysis", "observability", "operations", "reliability", "risk", "site"]
---
...
Produce a defensible, executable and measurable approach to **reliability risk analysis** within the broader capability of **site reliability**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Manages reliability using objectives, budgets and resilience evidence.

This skill owns the decision and execution contract for **reliability risk analysis**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **reliability risk analysis**.
...
- Reliability Risk Analysis decision brief
...
1. Frame the exact decision or outcome governed by reliability risk analysis.
...
```yaml
skill_id: PLC-206
skill: reliability-risk-analysis
...
```text
Act as the accountable owner for Reliability Risk Analysis.
