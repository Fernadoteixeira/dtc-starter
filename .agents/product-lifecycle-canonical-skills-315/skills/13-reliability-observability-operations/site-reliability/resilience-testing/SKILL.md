...
maturity: "canonical"
version: "1.0.0"
tags: ["observability", "operations", "reliability", "resilience", "site", "testing"]
---
...
Produce a defensible, executable and measurable approach to **resilience testing** within the broader capability of **site reliability**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Manages reliability using objectives, budgets and resilience evidence.

This skill owns the decision and execution contract for **resilience testing**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **resilience testing**.
...
- Resilience Testing decision brief
...
1. Frame the exact decision or outcome governed by resilience testing.
...
```text
Act as the accountable owner for Resilience Testing.
