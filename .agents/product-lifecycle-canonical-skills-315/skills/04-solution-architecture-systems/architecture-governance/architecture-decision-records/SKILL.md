...
capability_pack: "architecture-governance"
capability_pack_title: "Architecture Governance"
...
maturity: "canonical"
version: "1.0.0"
tags: ["architecture", "decision", "governance", "records", "solution", "systems"]
---
...
Produce a defensible, executable and measurable approach to **architecture decision records** within the broader capability of **architecture governance**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Records, verifies and evolves architectural decisions.

This skill owns the decision and execution contract for **architecture decision records**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **architecture decision records**.
...
- Architecture Decision Records decision brief
...
1. Frame the exact decision or outcome governed by architecture decision records.
...
```text
Act as the accountable owner for Architecture Decision Records.
