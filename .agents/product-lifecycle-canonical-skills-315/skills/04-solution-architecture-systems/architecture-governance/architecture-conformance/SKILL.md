...
maturity: "canonical"
version: "1.0.0"
tags: ["architecture", "conformance", "governance", "solution", "systems"]
---
...
Produce a defensible, executable and measurable approach to **architecture conformance** within the broader capability of **architecture governance**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Records, verifies and evolves architectural decisions.

This skill owns the decision and execution contract for **architecture conformance**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **architecture conformance**.
...
- Architecture Conformance decision brief
...
1. Frame the exact decision or outcome governed by architecture conformance.
...
```text
Act as the accountable owner for Architecture Conformance.
