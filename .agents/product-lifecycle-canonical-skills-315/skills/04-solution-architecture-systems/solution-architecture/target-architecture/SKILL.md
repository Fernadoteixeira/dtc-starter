...
maturity: "canonical"
version: "1.0.0"
tags: ["architecture", "solution", "systems", "target"]
---
...
Produce a defensible, executable and measurable approach to **target architecture** within the broader capability of **solution architecture**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Designs the target system and evaluates architectural options.

This skill owns the decision and execution contract for **target architecture**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **target architecture**.
...
- Target Architecture decision brief
...
1. Frame the exact decision or outcome governed by target architecture.
...
```text
Act as the accountable owner for Target Architecture.
