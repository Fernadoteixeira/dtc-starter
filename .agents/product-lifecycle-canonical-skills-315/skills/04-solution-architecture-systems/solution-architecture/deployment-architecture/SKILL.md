...
maturity: "canonical"
version: "1.0.0"
tags: ["architecture", "deployment", "solution", "systems"]
---
...
Produce a defensible, executable and measurable approach to **deployment architecture** within the broader capability of **solution architecture**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Designs the target system and evaluates architectural options.

This skill owns the decision and execution contract for **deployment architecture**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **deployment architecture**.
...
- Deployment Architecture decision brief
...
1. Frame the exact decision or outcome governed by deployment architecture.
...
```text
Act as the accountable owner for Deployment Architecture.
