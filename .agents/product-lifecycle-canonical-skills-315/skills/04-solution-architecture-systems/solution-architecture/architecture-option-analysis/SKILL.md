---
id: "PLC-050"
name: "architecture-option-analysis"
title: "Architecture Option Analysis"
kind: "atomic-capability"
domain: "04-solution-architecture-systems"
domain_title: "Solution Architecture and Systems Design"
capability_pack: "solution-architecture"
capability_pack_title: "Solution Architecture"
technology_agnostic: true
language_agnostic: true
industry_agnostic: true
lifecycle_modes: ["assess", "model", "design", "compare", "govern", "evolve"]
maturity: "canonical"
version: "1.0.0"
tags: ["analysis", "architecture", "option", "solution", "systems"]
---
...
Produce a defensible, executable and measurable approach to **architecture option analysis** within the broader capability of **solution architecture**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Designs the target system and evaluates architectural options.

This skill owns the decision and execution contract for **architecture option analysis**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **architecture option analysis**.
...
- Architecture Option Analysis decision brief
...
Expected artifact families for this domain include: architecture model, decision record, trade-off analysis, conformance plan.

## Operating workflow

1. Frame the exact decision or outcome governed by architecture option analysis.
...
- Trace architecture to quality attributes.
- Avoid technology-first reasoning.
...
```yaml
skill_id: PLC-050
skill: architecture-option-analysis
...
```text
Act as the accountable owner for Architecture Option Analysis.
