...
maturity: "canonical"
version: "1.0.0"
tags: ["analysis", "architecture", "attributes", "quality", "solution", "systems", "tradeoff"]
---
...
Produce a defensible, executable and measurable approach to **architecture tradeoff analysis** within the broader capability of **quality attributes**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Makes nonfunctional expectations measurable and testable.

This skill owns the decision and execution contract for **architecture tradeoff analysis**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **architecture tradeoff analysis**.
...
- Architecture Tradeoff Analysis decision brief
...
1. Frame the exact decision or outcome governed by architecture tradeoff analysis.
...
```text
Act as the accountable owner for Architecture Tradeoff Analysis.
