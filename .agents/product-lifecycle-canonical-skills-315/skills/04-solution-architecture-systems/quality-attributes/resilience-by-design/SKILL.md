...
maturity: "canonical"
version: "1.0.0"
tags: ["architecture", "attributes", "by", "design", "quality", "resilience", "solution", "systems"]
---
...
Produce a defensible, executable and measurable approach to **resilience by design** within the broader capability of **quality attributes**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Makes nonfunctional expectations measurable and testable.

This skill owns the decision and execution contract for **resilience by design**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **resilience by design**.
...
- Resilience by Design decision brief
...
1. Frame the exact decision or outcome governed by resilience by design.
...
```text
Act as the accountable owner for Resilience by Design.
