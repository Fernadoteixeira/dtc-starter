...
capability_pack: "quality-attributes"
capability_pack_title: "Quality Attributes"
...
maturity: "canonical"
version: "1.0.0"
tags: ["architecture", "attribute", "attributes", "quality", "scenarios", "solution", "systems"]
---
...
Produce a defensible, executable and measurable approach to **quality attribute scenarios** within the broader capability of **quality attributes**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Makes nonfunctional expectations measurable and testable.

This skill owns the decision and execution contract for **quality attribute scenarios**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **quality attribute scenarios**.
...
- Quality Attribute Scenarios decision brief
...
1. Frame the exact decision or outcome governed by quality attribute scenarios.
...
```yaml
skill_id: PLC-058
skill: quality-attribute-scenarios
...
```text
Act as the accountable owner for Quality Attribute Scenarios.
