...
maturity: "canonical"
version: "1.0.0"
tags: ["architecture", "context", "dependency", "map", "solution", "system", "systems"]
---
...
Produce a defensible, executable and measurable approach to **dependency map** within the broader capability of **system context**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Clarifies boundaries, actors, capabilities and dependencies.

This skill owns the decision and execution contract for **dependency map**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **dependency map**.
...
1. Frame the exact decision or outcome governed by dependency map.
...
```text
Act as the accountable owner for Dependency Map.
