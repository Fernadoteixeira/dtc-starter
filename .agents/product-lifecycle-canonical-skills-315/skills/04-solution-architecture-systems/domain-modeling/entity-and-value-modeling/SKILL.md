---
id: "PLC-056"
name: "entity-and-value-modeling"
title: "Entity and Value Modeling"
kind: "atomic-capability"
domain: "04-solution-architecture-systems"
domain_title: "Solution Architecture and Systems Design"
capability_pack: "domain-modeling"
capability_pack_title: "Domain Modeling"
...
maturity: "canonical"
version: "1.0.0"
tags: ["architecture", "domain", "entity", "modeling", "solution", "systems", "value"]
---

# Entity and Value Modeling

## Canonical outcome

Produce a defensible, executable and measurable approach to **entity and value modeling** within the broader capability of **domain modeling**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Models business concepts, boundaries and processes.

This skill owns the decision and execution contract for **entity and value modeling**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **entity and value modeling**.
...
- Entity and Value Modeling decision brief
...
1. Frame the exact decision or outcome governed by entity and value modeling.
...
```yaml
skill_id: PLC-056
skill: entity-and-value-modeling
...
```text
Act as the accountable owner for Entity and Value Modeling.
