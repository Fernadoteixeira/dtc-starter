...
maturity: "canonical"
version: "1.0.0"
tags: ["architecture", "business", "domain", "modeling", "process", "solution", "systems"]
---
...
Produce a defensible, executable and measurable approach to **business process modeling** within the broader capability of **domain modeling**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Models business concepts, boundaries and processes.

This skill owns the decision and execution contract for **business process modeling**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **business process modeling**.
...
- Business Process Modeling decision brief
...
1. Frame the exact decision or outcome governed by business process modeling.
...
```text
Act as the accountable owner for Business Process Modeling.
