...
maturity: "canonical"
version: "1.0.0"
tags: ["architecture", "decomposition", "domain", "modeling", "solution", "systems"]
---
...
Produce a defensible, executable and measurable approach to **domain decomposition** within the broader capability of **domain modeling**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Models business concepts, boundaries and processes.

This skill owns the decision and execution contract for **domain decomposition**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **domain decomposition**.
...
- Domain Decomposition decision brief
...
1. Frame the exact decision or outcome governed by domain decomposition.
...
```text
Act as the accountable owner for Domain Decomposition.
