...
maturity: "canonical"
version: "1.0.0"
tags: ["access", "compliance", "identity", "isolation", "privacy", "security", "tenant"]
---
...
Produce a defensible, executable and measurable approach to **tenant isolation** within the broader capability of **identity and access**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Controls identity, permission, tenancy and privileged actions.

This skill owns the decision and execution contract for **tenant isolation**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **tenant isolation**.
...
- Tenant Isolation decision brief
...
1. Frame the exact decision or outcome governed by tenant isolation.
...
```text
Act as the accountable owner for Tenant Isolation.
