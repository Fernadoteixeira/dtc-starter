...
maturity: "canonical"
version: "1.0.0"
tags: ["access", "authentication", "compliance", "design", "identity", "privacy", "security"]
---
...
Produce a defensible, executable and measurable approach to **authentication design** within the broader capability of **identity and access**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Controls identity, permission, tenancy and privileged actions.

This skill owns the decision and execution contract for **authentication design**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **authentication design**.
...
- Authentication Design decision brief
...
1. Frame the exact decision or outcome governed by authentication design.
...
```text
Act as the accountable owner for Authentication Design.
