...
capability_pack: "identity-access"
capability_pack_title: "Identity and Access"
...
maturity: "canonical"
version: "1.0.0"
tags: ["access", "compliance", "identity", "management", "privacy", "privileged", "security"]
---
...
Produce a defensible, executable and measurable approach to **privileged access management** within the broader capability of **identity and access**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Controls identity, permission, tenancy and privileged actions.

This skill owns the decision and execution contract for **privileged access management**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **privileged access management**.
...
- Privileged Access Management decision brief
...
1. Frame the exact decision or outcome governed by privileged access management.
...
```text
Act as the accountable owner for Privileged Access Management.
