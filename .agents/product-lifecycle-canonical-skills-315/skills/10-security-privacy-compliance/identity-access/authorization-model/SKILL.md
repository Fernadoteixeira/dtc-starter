...
maturity: "canonical"
version: "1.0.0"
tags: ["access", "authorization", "compliance", "identity", "model", "privacy", "security"]
---
...
Produce a defensible, executable and measurable approach to **authorization model** within the broader capability of **identity and access**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Controls identity, permission, tenancy and privileged actions.

This skill owns the decision and execution contract for **authorization model**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **authorization model**.
...
- Authorization Model decision brief
...
1. Frame the exact decision or outcome governed by authorization model.
...
```text
Act as the accountable owner for Authorization Model.
