...
maturity: "canonical"
version: "1.0.0"
tags: ["compliance", "data", "privacy", "rights", "security", "subject"]
---
...
Produce a defensible, executable and measurable approach to **data subject rights** within the broader capability of **privacy**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Embeds privacy principles, preferences and rights.

This skill owns the decision and execution contract for **data subject rights**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **data subject rights**.
...
- Data Subject Rights decision brief
...
1. Frame the exact decision or outcome governed by data subject rights.
...
```text
Act as the accountable owner for Data Subject Rights.
