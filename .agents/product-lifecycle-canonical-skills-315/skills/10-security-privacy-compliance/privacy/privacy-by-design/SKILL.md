...
maturity: "canonical"
version: "1.0.0"
tags: ["by", "compliance", "design", "privacy", "security"]
---
...
Produce a defensible, executable and measurable approach to **privacy by design** within the broader capability of **privacy**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Embeds privacy principles, preferences and rights.

This skill owns the decision and execution contract for **privacy by design**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **privacy by design**.
...
- Privacy by Design decision brief
...
1. Frame the exact decision or outcome governed by privacy by design.
...
```text
Act as the accountable owner for Privacy by Design.
