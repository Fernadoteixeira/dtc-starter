...
capability_pack: "privacy"
capability_pack_title: "Privacy"
...
maturity: "canonical"
version: "1.0.0"
tags: ["compliance", "consent", "management", "preference", "privacy", "security"]
---
...
Produce a defensible, executable and measurable approach to **consent and preference management** within the broader capability of **privacy**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Embeds privacy principles, preferences and rights.

This skill owns the decision and execution contract for **consent and preference management**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **consent and preference management**.
...
- Consent and Preference Management decision brief
...
1. Frame the exact decision or outcome governed by consent and preference management.
...
```yaml
skill_id: PLC-165
skill: consent-and-preference-management
...
```text
Act as the accountable owner for Consent and Preference Management.
