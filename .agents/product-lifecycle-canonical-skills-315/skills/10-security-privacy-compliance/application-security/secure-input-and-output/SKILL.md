...
maturity: "canonical"
version: "1.0.0"
tags: ["application", "compliance", "input", "output", "privacy", "secure", "security"]
---
...
Produce a defensible, executable and measurable approach to **secure input and output** within the broader capability of **application security**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Reduces application and supply-chain vulnerabilities.

This skill owns the decision and execution contract for **secure input and output**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **secure input and output**.
...
- Secure Input and Output decision brief
...
1. Frame the exact decision or outcome governed by secure input and output.
...
```text
Act as the accountable owner for Secure Input and Output.
