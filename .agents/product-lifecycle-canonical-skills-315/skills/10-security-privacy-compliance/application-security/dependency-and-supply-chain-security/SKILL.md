...
domain: "10-security-privacy-compliance"
domain_title: "Security, Privacy and Compliance"
capability_pack: "application-security"
capability_pack_title: "Application Security"
technology_agnostic: true
language_agnostic: true
industry_agnostic: true
lifecycle_modes: ["assess", "threat-model", "design", "implement", "verify", "govern", "respond"]
maturity: "canonical"
version: "1.0.0"
tags: ["application", "chain", "compliance", "dependency", "privacy", "security", "supply"]
---
...
Produce a defensible, executable and measurable approach to **dependency and supply chain security** within the broader capability of **application security**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Reduces application and supply-chain vulnerabilities.

This skill owns the decision and execution contract for **dependency and supply chain security**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **dependency and supply chain security**.
...
- Dependency and Supply Chain Security decision brief
...
Expected artifact families for this domain include: threat model, control design, policy, audit evidence.

## Operating workflow

1. Frame the exact decision or outcome governed by dependency and supply chain security.
...
- Never treat compliance as equivalent to security.
...
```yaml
skill_id: PLC-162
skill: dependency-and-supply-chain-security
...
```text
Act as the accountable owner for Dependency and Supply Chain Security.
