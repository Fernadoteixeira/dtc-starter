...
maturity: "canonical"
version: "1.0.0"
tags: ["application", "compliance", "privacy", "security", "testing"]
---
...
Produce a defensible, executable and measurable approach to **security testing** within the broader capability of **application security**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Reduces application and supply-chain vulnerabilities.

This skill owns the decision and execution contract for **security testing**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **security testing**.
...
- Security Testing decision brief
...
1. Frame the exact decision or outcome governed by security testing.
...
```text
Act as the accountable owner for Security Testing.
