---
id: "PLC-161"
name: "session-and-csrf-protection"
...
maturity: "canonical"
version: "1.0.0"
tags: ["application", "compliance", "csrf", "privacy", "protection", "security", "session"]
---
...
Produce a defensible, executable and measurable approach to **session and csrf protection** within the broader capability of **application security**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Reduces application and supply-chain vulnerabilities.

This skill owns the decision and execution contract for **session and csrf protection**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **session and csrf protection**.
...
- Session and CSRF Protection decision brief
...
1. Frame the exact decision or outcome governed by session and csrf protection.
...
```yaml
skill_id: PLC-161
skill: session-and-csrf-protection
...
```text
Act as the accountable owner for Session and CSRF Protection.
