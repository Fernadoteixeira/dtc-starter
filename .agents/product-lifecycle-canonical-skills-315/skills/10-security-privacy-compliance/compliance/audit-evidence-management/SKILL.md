...
capability_pack: "compliance"
capability_pack_title: "Compliance"
...
maturity: "canonical"
version: "1.0.0"
tags: ["audit", "compliance", "evidence", "management", "privacy", "security"]
---
...
Produce a defensible, executable and measurable approach to **audit evidence management** within the broader capability of **compliance**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Maps obligations to evidence and change management.

This skill owns the decision and execution contract for **audit evidence management**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **audit evidence management**.
...
- Audit Evidence Management decision brief
...
1. Frame the exact decision or outcome governed by audit evidence management.
...
```yaml
skill_id: PLC-168
skill: audit-evidence-management
...
```text
Act as the accountable owner for Audit Evidence Management.
