...
maturity: "canonical"
version: "1.0.0"
tags: ["change", "compliance", "management", "privacy", "regulatory", "security"]
---
...
Produce a defensible, executable and measurable approach to **regulatory change management** within the broader capability of **compliance**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Maps obligations to evidence and change management.

This skill owns the decision and execution contract for **regulatory change management**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **regulatory change management**.
...
- Regulatory Change Management decision brief
...
1. Frame the exact decision or outcome governed by regulatory change management.
...
```text
Act as the accountable owner for Regulatory Change Management.
