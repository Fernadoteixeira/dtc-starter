...
maturity: "canonical"
version: "1.0.0"
tags: ["architecture", "compliance", "modeling", "privacy", "security", "threat"]
---
...
Produce a defensible, executable and measurable approach to **threat modeling** within the broader capability of **security architecture**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Models threats, trust and foundational security controls.

This skill owns the decision and execution contract for **threat modeling**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **threat modeling**.
...
- Threat Modeling decision brief
...
1. Frame the exact decision or outcome governed by threat modeling.
...
```text
Act as the accountable owner for Threat Modeling.
