...
maturity: "canonical"
version: "1.0.0"
tags: ["architecture", "compliance", "key", "management", "privacy", "secrets", "security"]
---
...
Produce a defensible, executable and measurable approach to **secrets and key management** within the broader capability of **security architecture**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Models threats, trust and foundational security controls.

This skill owns the decision and execution contract for **secrets and key management**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **secrets and key management**.
...
- Secrets and Key Management decision brief
...
1. Frame the exact decision or outcome governed by secrets and key management.
...
```yaml
skill_id: PLC-155
skill: secrets-and-key-management
...
```text
Act as the accountable owner for Secrets and Key Management.
