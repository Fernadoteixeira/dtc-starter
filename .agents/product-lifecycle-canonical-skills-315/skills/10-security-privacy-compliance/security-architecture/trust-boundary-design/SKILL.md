...
maturity: "canonical"
version: "1.0.0"
tags: ["architecture", "boundary", "compliance", "design", "privacy", "security", "trust"]
---
...
Produce a defensible, executable and measurable approach to **trust boundary design** within the broader capability of **security architecture**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Models threats, trust and foundational security controls.

This skill owns the decision and execution contract for **trust boundary design**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **trust boundary design**.
...
- Trust Boundary Design decision brief
...
1. Frame the exact decision or outcome governed by trust boundary design.
...
```text
Act as the accountable owner for Trust Boundary Design.
