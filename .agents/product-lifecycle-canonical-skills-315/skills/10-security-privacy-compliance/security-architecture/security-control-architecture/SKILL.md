...
title: "Security Control Architecture"
kind: "atomic-capability"
domain: "10-security-privacy-compliance"
domain_title: "Security, Privacy and Compliance"
capability_pack: "security-architecture"
capability_pack_title: "Security Architecture"
...
maturity: "canonical"
version: "1.0.0"
tags: ["architecture", "compliance", "control", "privacy", "security"]
---
...
Produce a defensible, executable and measurable approach to **security control architecture** within the broader capability of **security architecture**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Models threats, trust and foundational security controls.

This skill owns the decision and execution contract for **security control architecture**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **security control architecture**.
...
- Security Control Architecture decision brief
...
1. Frame the exact decision or outcome governed by security control architecture.
...
```yaml
skill_id: PLC-154
skill: security-control-architecture
...
```text
Act as the accountable owner for Security Control Architecture.
