...
maturity: "canonical"
version: "1.0.0"
tags: ["cloud", "developer", "devops", "engineering", "platform", "self", "service"]
---
...
Produce a defensible, executable and measurable approach to **developer self service** within the broader capability of **platform engineering**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Treats internal platform capabilities as a product.

This skill owns the decision and execution contract for **developer self service**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **developer self service**.
...
- Developer Self Service decision brief
...
1. Frame the exact decision or outcome governed by developer self service.
...
```text
Act as the accountable owner for Developer Self Service.
