...
maturity: "canonical"
version: "1.0.0"
tags: ["cloud", "devops", "engineering", "golden", "paths", "platform"]
---
...
Produce a defensible, executable and measurable approach to **golden paths** within the broader capability of **platform engineering**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Treats internal platform capabilities as a product.

This skill owns the decision and execution contract for **golden paths**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **golden paths**.
...
1. Frame the exact decision or outcome governed by golden paths.
...
```text
Act as the accountable owner for Golden Paths.
