...
maturity: "canonical"
version: "1.0.0"
tags: ["cloud", "devops", "engineering", "management", "platform", "product"]
---
...
Produce a defensible, executable and measurable approach to **platform product management** within the broader capability of **platform engineering**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Treats internal platform capabilities as a product.

This skill owns the decision and execution contract for **platform product management**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **platform product management**.
...
- Platform Product Management decision brief
...
1. Frame the exact decision or outcome governed by platform product management.
...
```yaml
skill_id: PLC-191
skill: platform-product-management
...
```text
Act as the accountable owner for Platform Product Management.
