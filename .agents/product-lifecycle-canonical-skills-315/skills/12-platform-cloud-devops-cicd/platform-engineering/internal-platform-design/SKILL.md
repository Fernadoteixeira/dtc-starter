...
title: "Internal Platform Design"
kind: "atomic-capability"
domain: "12-platform-cloud-devops-cicd"
domain_title: "Platform, Cloud, DevOps and CI/CD"
capability_pack: "platform-engineering"
capability_pack_title: "Platform Engineering"
...
maturity: "canonical"
version: "1.0.0"
tags: ["cloud", "design", "devops", "engineering", "internal", "platform"]
---
...
Produce a defensible, executable and measurable approach to **internal platform design** within the broader capability of **platform engineering**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Treats internal platform capabilities as a product.

This skill owns the decision and execution contract for **internal platform design**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **internal platform design**.
...
- Internal Platform Design decision brief
...
1. Frame the exact decision or outcome governed by internal platform design.
...
```yaml
skill_id: PLC-188
skill: internal-platform-design
...
```text
Act as the accountable owner for Internal Platform Design.
