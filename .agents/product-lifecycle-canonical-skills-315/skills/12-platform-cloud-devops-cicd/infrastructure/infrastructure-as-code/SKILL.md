...
maturity: "canonical"
version: "1.0.0"
tags: ["cloud", "code", "devops", "infrastructure", "platform"]
---
...
Produce a defensible, executable and measurable approach to **infrastructure as code** within the broader capability of **infrastructure**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines reproducible compute, storage, network and environment topology.

This skill owns the decision and execution contract for **infrastructure as code**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **infrastructure as code**.
...
- Infrastructure as Code decision brief
...
1. Frame the exact decision or outcome governed by infrastructure as code.
...
```text
Act as the accountable owner for Infrastructure as Code.
