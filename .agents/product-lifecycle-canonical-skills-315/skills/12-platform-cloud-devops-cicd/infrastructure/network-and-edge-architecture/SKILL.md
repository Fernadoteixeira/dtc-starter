---
id: "PLC-194"
name: "network-and-edge-architecture"
title: "Network and Edge Architecture"
...
maturity: "canonical"
version: "1.0.0"
tags: ["architecture", "cloud", "devops", "edge", "infrastructure", "network", "platform"]
---
...
Produce a defensible, executable and measurable approach to **network and edge architecture** within the broader capability of **infrastructure**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines reproducible compute, storage, network and environment topology.

This skill owns the decision and execution contract for **network and edge architecture**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **network and edge architecture**.
...
- Network and Edge Architecture decision brief
...
1. Frame the exact decision or outcome governed by network and edge architecture.
...
```yaml
skill_id: PLC-194
skill: network-and-edge-architecture
...
```text
Act as the accountable owner for Network and Edge Architecture.
