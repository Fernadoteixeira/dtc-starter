---
id: "PLC-195"
name: "storage-and-compute-selection"
title: "Storage and Compute Selection"
kind: "atomic-capability"
domain: "12-platform-cloud-devops-cicd"
domain_title: "Platform, Cloud, DevOps and CI/CD"
capability_pack: "infrastructure"
capability_pack_title: "Infrastructure"
technology_agnostic: true
language_agnostic: true
industry_agnostic: true
lifecycle_modes: ["design", "implement", "automate", "verify", "operate", "optimize"]
maturity: "canonical"
version: "1.0.0"
tags: ["cloud", "compute", "devops", "infrastructure", "platform", "selection", "storage"]
---

# Storage and Compute Selection

## Canonical outcome

Produce a defensible, executable and measurable approach to **storage and compute selection** within the broader capability of **infrastructure**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines reproducible compute, storage, network and environment topology.

This skill owns the decision and execution contract for **storage and compute selection**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **storage and compute selection**.
...
- Storage and Compute Selection decision brief
...
Expected artifact families for this domain include: platform capability, pipeline, environment contract, deployment policy.

## Operating workflow

1. Frame the exact decision or outcome governed by storage and compute selection.
...
- Preserve provenance.
- Make rollback independently executable.
...
```yaml
skill_id: PLC-195
skill: storage-and-compute-selection
...
```text
Act as the accountable owner for Storage and Compute Selection.
