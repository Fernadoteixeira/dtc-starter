...
maturity: "canonical"
version: "1.0.0"
tags: ["cloud", "devops", "environment", "infrastructure", "platform", "topology"]
---
...
Produce a defensible, executable and measurable approach to **environment topology** within the broader capability of **infrastructure**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines reproducible compute, storage, network and environment topology.

This skill owns the decision and execution contract for **environment topology**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **environment topology**.
...
- Environment Topology decision brief
...
1. Frame the exact decision or outcome governed by environment topology.
...
```text
Act as the accountable owner for Environment Topology.
