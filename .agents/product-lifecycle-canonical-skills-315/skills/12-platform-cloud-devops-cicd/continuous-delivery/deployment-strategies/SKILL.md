...
capability_pack: "continuous-delivery"
capability_pack_title: "Continuous Delivery"
...
maturity: "canonical"
version: "1.0.0"
tags: ["cloud", "continuous", "delivery", "deployment", "devops", "platform", "strategies"]
---
...
Produce a defensible, executable and measurable approach to **deployment strategies** within the broader capability of **continuous delivery**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Automates integration, delivery, deployment and provenance.

This skill owns the decision and execution contract for **deployment strategies**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **deployment strategies**.
...
- Deployment Strategies decision brief
...
1. Frame the exact decision or outcome governed by deployment strategies.
...
```text
Act as the accountable owner for Deployment Strategies.
