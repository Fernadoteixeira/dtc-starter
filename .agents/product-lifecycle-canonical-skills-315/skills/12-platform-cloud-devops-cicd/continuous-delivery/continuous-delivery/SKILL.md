...
maturity: "canonical"
version: "1.0.0"
tags: ["cloud", "continuous", "delivery", "devops", "platform"]
---
...
Produce a defensible, executable and measurable approach to **continuous delivery** within the broader capability of **continuous delivery**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Automates integration, delivery, deployment and provenance.

This skill owns the decision and execution contract for **continuous delivery**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **continuous delivery**.
...
- Continuous Delivery decision brief
...
1. Frame the exact decision or outcome governed by continuous delivery.
...
```text
Act as the accountable owner for Continuous Delivery.
