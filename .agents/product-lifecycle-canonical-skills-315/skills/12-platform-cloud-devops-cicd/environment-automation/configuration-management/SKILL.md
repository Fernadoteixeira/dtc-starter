...
capability_pack: "environment-automation"
capability_pack_title: "Environment Automation"
...
maturity: "canonical"
version: "1.0.0"
tags: ["automation", "cloud", "configuration", "devops", "environment", "management", "platform"]
---
...
Produce a defensible, executable and measurable approach to **configuration management** within the broader capability of **environment automation**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Controls configuration, promotion, secrets and rollback.

This skill owns the decision and execution contract for **configuration management**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **configuration management**.
...
- Configuration Management decision brief
...
1. Frame the exact decision or outcome governed by configuration management.
...
```text
Act as the accountable owner for Configuration Management.
