...
maturity: "canonical"
version: "1.0.0"
tags: ["automation", "cloud", "devops", "environment", "platform", "rollback"]
---
...
Produce a defensible, executable and measurable approach to **rollback automation** within the broader capability of **environment automation**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Controls configuration, promotion, secrets and rollback.

This skill owns the decision and execution contract for **rollback automation**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **rollback automation**.
...
- Rollback Automation decision brief
...
1. Frame the exact decision or outcome governed by rollback automation.
...
```text
Act as the accountable owner for Rollback Automation.
