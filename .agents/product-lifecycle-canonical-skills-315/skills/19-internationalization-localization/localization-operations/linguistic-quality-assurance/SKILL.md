...
maturity: "canonical"
version: "1.0.0"
tags: ["assurance", "internationalization", "linguistic", "localization", "operations", "quality"]
---
...
Produce a defensible, executable and measurable approach to **linguistic quality assurance** within the broader capability of **localization operations**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Operates translation, terminology, QA and regional adaptation.

This skill owns the decision and execution contract for **linguistic quality assurance**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **linguistic quality assurance**.
...
- Linguistic Quality Assurance decision brief
...
1. Frame the exact decision or outcome governed by linguistic quality assurance.
...
```yaml
skill_id: PLC-288
skill: linguistic-quality-assurance
...
```text
Act as the accountable owner for Linguistic Quality Assurance.
