...
maturity: "canonical"
version: "1.0.0"
tags: ["internationalization", "localization", "management", "operations", "terminology"]
---
...
Produce a defensible, executable and measurable approach to **terminology management** within the broader capability of **localization operations**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Operates translation, terminology, QA and regional adaptation.

This skill owns the decision and execution contract for **terminology management**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **terminology management**.
...
- Terminology Management decision brief
...
1. Frame the exact decision or outcome governed by terminology management.
...
```text
Act as the accountable owner for Terminology Management.
