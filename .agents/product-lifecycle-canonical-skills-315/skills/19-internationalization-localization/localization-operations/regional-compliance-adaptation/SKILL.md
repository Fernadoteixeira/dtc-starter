---
id: "PLC-289"
name: "regional-compliance-adaptation"
...
capability_pack: "localization-operations"
capability_pack_title: "Localization Operations"
...
maturity: "canonical"
version: "1.0.0"
tags: ["adaptation", "compliance", "internationalization", "localization", "operations", "regional"]
---
...
Produce a defensible, executable and measurable approach to **regional compliance adaptation** within the broader capability of **localization operations**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Operates translation, terminology, QA and regional adaptation.

This skill owns the decision and execution contract for **regional compliance adaptation**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **regional compliance adaptation**.
...
- Regional Compliance Adaptation decision brief
...
1. Frame the exact decision or outcome governed by regional compliance adaptation.
...
```yaml
skill_id: PLC-289
skill: regional-compliance-adaptation
...
```text
Act as the accountable owner for Regional Compliance Adaptation.
