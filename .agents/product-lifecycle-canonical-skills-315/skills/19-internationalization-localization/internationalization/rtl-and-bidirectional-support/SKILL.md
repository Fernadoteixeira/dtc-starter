---
id: "PLC-285"
name: "rtl-and-bidirectional-support"
title: "RTL and Bidirectional Support"
kind: "atomic-capability"
domain: "19-internationalization-localization"
domain_title: "Internationalization and Localization"
capability_pack: "internationalization"
capability_pack_title: "Internationalization"
technology_agnostic: true
language_agnostic: true
industry_agnostic: true
lifecycle_modes: ["assess", "design", "externalize", "localize", "verify", "operate"]
maturity: "canonical"
version: "1.0.0"
tags: ["bidirectional", "internationalization", "localization", "rtl", "support"]
---
...
Produce a defensible, executable and measurable approach to **rtl and bidirectional support** within the broader capability of **internationalization**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Prepares product architecture for languages, formats and directionality.

This skill owns the decision and execution contract for **rtl and bidirectional support**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **rtl and bidirectional support**.
...
- RTL and Bidirectional Support decision brief
...
Expected artifact families for this domain include: locale architecture, translation model, terminology base, regional validation.

## Operating workflow

1. Frame the exact decision or outcome governed by rtl and bidirectional support.
...
- Separate language from business logic.
- Avoid string concatenation.
- Validate regional legal and cultural differences.
...
```yaml
skill_id: PLC-285
skill: rtl-and-bidirectional-support
...
```text
Act as the accountable owner for RTL and Bidirectional Support.
