...
maturity: "canonical"
version: "1.0.0"
tags: ["architecture", "internationalization", "localization"]
---
...
Produce a defensible, executable and measurable approach to **internationalization architecture** within the broader capability of **internationalization**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Prepares product architecture for languages, formats and directionality.

This skill owns the decision and execution contract for **internationalization architecture**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **internationalization architecture**.
...
- Internationalization Architecture decision brief
...
1. Frame the exact decision or outcome governed by internationalization architecture.
...
```text
Act as the accountable owner for Internationalization Architecture.
