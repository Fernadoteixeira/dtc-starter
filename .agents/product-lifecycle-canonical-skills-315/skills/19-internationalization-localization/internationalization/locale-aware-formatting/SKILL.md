...
maturity: "canonical"
version: "1.0.0"
tags: ["aware", "formatting", "internationalization", "locale", "localization"]
---
...
Produce a defensible, executable and measurable approach to **locale aware formatting** within the broader capability of **internationalization**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Prepares product architecture for languages, formats and directionality.

This skill owns the decision and execution contract for **locale aware formatting**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **locale aware formatting**.
...
- Locale Aware Formatting decision brief
...
1. Frame the exact decision or outcome governed by locale aware formatting.
...
```text
Act as the accountable owner for Locale Aware Formatting.
