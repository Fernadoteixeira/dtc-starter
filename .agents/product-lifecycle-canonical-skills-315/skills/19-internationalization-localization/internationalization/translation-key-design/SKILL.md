...
maturity: "canonical"
version: "1.0.0"
tags: ["design", "internationalization", "key", "localization", "translation"]
---
...
Produce a defensible, executable and measurable approach to **translation key design** within the broader capability of **internationalization**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Prepares product architecture for languages, formats and directionality.

This skill owns the decision and execution contract for **translation key design**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **translation key design**.
...
- Translation Key Design decision brief
...
1. Frame the exact decision or outcome governed by translation key design.
...
```text
Act as the accountable owner for Translation Key Design.
