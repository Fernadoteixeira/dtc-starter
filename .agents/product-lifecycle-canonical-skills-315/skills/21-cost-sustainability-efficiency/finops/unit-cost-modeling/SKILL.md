---
id: "PLC-301"
name: "unit-cost-modeling"
title: "Unit Cost Modeling"
...
capability_pack: "finops"
capability_pack_title: "FinOps"
...
maturity: "canonical"
version: "1.0.0"
tags: ["cost", "efficiency", "finops", "modeling", "sustainability", "unit"]
---
...
Produce a defensible, executable and measurable approach to **unit cost modeling** within the broader capability of **finops**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Makes cost visible, attributable, forecastable and optimizable.

This skill owns the decision and execution contract for **unit cost modeling**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **unit cost modeling**.
...
- Unit Cost Modeling decision brief
...
1. Frame the exact decision or outcome governed by unit cost modeling.
...
```text
Act as the accountable owner for Unit Cost Modeling.
