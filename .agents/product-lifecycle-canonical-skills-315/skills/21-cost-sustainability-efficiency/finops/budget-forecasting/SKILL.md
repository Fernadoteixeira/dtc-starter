...
maturity: "canonical"
version: "1.0.0"
tags: ["budget", "cost", "efficiency", "finops", "forecasting", "sustainability"]
---
...
Produce a defensible, executable and measurable approach to **budget forecasting** within the broader capability of **finops**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Makes cost visible, attributable, forecastable and optimizable.

This skill owns the decision and execution contract for **budget forecasting**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **budget forecasting**.
...
- Budget Forecasting decision brief
...
1. Frame the exact decision or outcome governed by budget forecasting.
...
```text
Act as the accountable owner for Budget Forecasting.
