...
maturity: "canonical"
version: "1.0.0"
tags: ["allocation", "cost", "efficiency", "finops", "sustainability"]
---
...
Produce a defensible, executable and measurable approach to **cost allocation** within the broader capability of **finops**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Makes cost visible, attributable, forecastable and optimizable.

This skill owns the decision and execution contract for **cost allocation**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **cost allocation**.
...
- Cost Allocation decision brief
...
1. Frame the exact decision or outcome governed by cost allocation.
...
```text
Act as the accountable owner for Cost Allocation.
