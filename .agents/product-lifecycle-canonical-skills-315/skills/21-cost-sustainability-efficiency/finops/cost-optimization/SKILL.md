...
maturity: "canonical"
version: "1.0.0"
tags: ["cost", "efficiency", "finops", "optimization", "sustainability"]
---
...
Produce a defensible, executable and measurable approach to **cost optimization** within the broader capability of **finops**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Makes cost visible, attributable, forecastable and optimizable.

This skill owns the decision and execution contract for **cost optimization**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **cost optimization**.
...
- Cost Optimization decision brief
...
1. Frame the exact decision or outcome governed by cost optimization.
...
```text
Act as the accountable owner for Cost Optimization.
