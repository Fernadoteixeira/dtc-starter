---
id: "PLC-304"
name: "carbon-footprint-measurement"
title: "Carbon Footprint Measurement"
kind: "atomic-capability"
domain: "21-cost-sustainability-efficiency"
domain_title: "Cost, Sustainability and Operational Efficiency"
capability_pack: "sustainability"
capability_pack_title: "Sustainability"
technology_agnostic: true
language_agnostic: true
industry_agnostic: true
lifecycle_modes: ["measure", "allocate", "forecast", "optimize", "govern", "report"]
maturity: "canonical"
version: "1.0.0"
tags: ["carbon", "cost", "efficiency", "footprint", "measurement", "sustainability"]
---
...
Produce a defensible, executable and measurable approach to **carbon footprint measurement** within the broader capability of **sustainability**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Measures and reduces environmental impact.

This skill owns the decision and execution contract for **carbon footprint measurement**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **carbon footprint measurement**.
...
- Carbon Footprint Measurement decision brief
...
Expected artifact families for this domain include: cost model, forecast, optimization plan, sustainability report.

## Operating workflow

1. Frame the exact decision or outcome governed by carbon footprint measurement.
...
- Do not trade away reliability blindly.
- Make allocation rules transparent.
- Use comparable measurement boundaries.
...
```yaml
skill_id: PLC-304
skill: carbon-footprint-measurement
...
```text
Act as the accountable owner for Carbon Footprint Measurement.
