...
maturity: "canonical"
version: "1.0.0"
tags: ["architecture", "cost", "efficiency", "sustainability", "sustainable"]
---
...
Produce a defensible, executable and measurable approach to **sustainable architecture** within the broader capability of **sustainability**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Measures and reduces environmental impact.

This skill owns the decision and execution contract for **sustainable architecture**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **sustainable architecture**.
...
- Sustainable Architecture decision brief
...
1. Frame the exact decision or outcome governed by sustainable architecture.
...
```text
Act as the accountable owner for Sustainable Architecture.
