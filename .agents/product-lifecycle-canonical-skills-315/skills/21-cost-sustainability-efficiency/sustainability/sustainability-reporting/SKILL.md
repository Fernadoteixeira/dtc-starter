...
maturity: "canonical"
version: "1.0.0"
tags: ["cost", "efficiency", "reporting", "sustainability"]
---
...
Produce a defensible, executable and measurable approach to **sustainability reporting** within the broader capability of **sustainability**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Measures and reduces environmental impact.

This skill owns the decision and execution contract for **sustainability reporting**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **sustainability reporting**.
...
- Sustainability Reporting decision brief
...
1. Frame the exact decision or outcome governed by sustainability reporting.
...
```text
Act as the accountable owner for Sustainability Reporting.
