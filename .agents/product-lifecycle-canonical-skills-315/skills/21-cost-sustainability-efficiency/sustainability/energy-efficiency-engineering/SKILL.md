---
id: "PLC-305"
name: "energy-efficiency-engineering"
...
maturity: "canonical"
version: "1.0.0"
tags: ["cost", "efficiency", "energy", "engineering", "sustainability"]
---
...
Produce a defensible, executable and measurable approach to **energy efficiency engineering** within the broader capability of **sustainability**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Measures and reduces environmental impact.

This skill owns the decision and execution contract for **energy efficiency engineering**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **energy efficiency engineering**.
...
- Energy Efficiency Engineering decision brief
...
1. Frame the exact decision or outcome governed by energy efficiency engineering.
...
```yaml
skill_id: PLC-305
skill: energy-efficiency-engineering
...
```text
Act as the accountable owner for Energy Efficiency Engineering.
