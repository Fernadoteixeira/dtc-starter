...
maturity: "canonical"
version: "1.0.0"
tags: ["ecosystem", "exit", "external", "governance", "integrations", "strategy", "vendor"]
---
...
Produce a defensible, executable and measurable approach to **vendor exit strategy** within the broader capability of **vendor governance**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Controls third-party risk, service levels and exit options.

This skill owns the decision and execution contract for **vendor exit strategy**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **vendor exit strategy**.
...
- Vendor Exit Strategy decision brief
...
1. Frame the exact decision or outcome governed by vendor exit strategy.
...
```text
Act as the accountable owner for Vendor Exit Strategy.
