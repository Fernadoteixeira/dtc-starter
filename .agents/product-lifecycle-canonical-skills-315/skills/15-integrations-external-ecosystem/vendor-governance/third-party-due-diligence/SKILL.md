...
capability_pack: "vendor-governance"
capability_pack_title: "Vendor Governance"
...
maturity: "canonical"
version: "1.0.0"
tags: ["diligence", "due", "ecosystem", "external", "governance", "integrations", "party", "third", "vendor"]
---
...
Produce a defensible, executable and measurable approach to **third party due diligence** within the broader capability of **vendor governance**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Controls third-party risk, service levels and exit options.

This skill owns the decision and execution contract for **third party due diligence**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **third party due diligence**.
...
- Third Party Due Diligence decision brief
...
1. Frame the exact decision or outcome governed by third party due diligence.
...
```yaml
skill_id: PLC-236
skill: third-party-due-diligence
...
```text
Act as the accountable owner for Third Party Due Diligence.
