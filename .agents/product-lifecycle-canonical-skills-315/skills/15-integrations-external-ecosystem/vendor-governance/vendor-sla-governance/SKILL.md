...
maturity: "canonical"
version: "1.0.0"
tags: ["ecosystem", "external", "governance", "integrations", "sla", "vendor"]
---
...
Produce a defensible, executable and measurable approach to **vendor sla governance** within the broader capability of **vendor governance**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Controls third-party risk, service levels and exit options.

This skill owns the decision and execution contract for **vendor sla governance**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **vendor sla governance**.
...
- Vendor SLA Governance decision brief
...
1. Frame the exact decision or outcome governed by vendor sla governance.
...
```text
Act as the accountable owner for Vendor SLA Governance.
