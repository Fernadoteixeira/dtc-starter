...
maturity: "canonical"
version: "1.0.0"
tags: ["api", "ecosystem", "enablement", "external", "integrations", "partner", "program"]
---
...
Produce a defensible, executable and measurable approach to **partner api program** within the broader capability of **ecosystem enablement**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Enables partners through APIs, events and developer experience.

This skill owns the decision and execution contract for **partner api program**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **partner api program**.
...
- Partner API Program decision brief
...
1. Frame the exact decision or outcome governed by partner api program.
...
```text
Act as the accountable owner for Partner API Program.
