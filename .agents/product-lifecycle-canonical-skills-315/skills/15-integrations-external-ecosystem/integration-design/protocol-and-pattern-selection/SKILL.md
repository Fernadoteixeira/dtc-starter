---
id: "PLC-233"
name: "protocol-and-pattern-selection"
title: "Protocol and Pattern Selection"
kind: "atomic-capability"
domain: "15-integrations-external-ecosystem"
domain_title: "Integrations, External Services and Ecosystems"
capability_pack: "integration-design"
capability_pack_title: "Integration Design"
technology_agnostic: true
language_agnostic: true
industry_agnostic: true
lifecycle_modes: ["assess", "design", "contract", "implement", "verify", "operate", "exit"]
maturity: "canonical"
version: "1.0.0"
tags: ["design", "ecosystem", "external", "integration", "integrations", "pattern", "protocol", "selection"]
---

# Protocol and Pattern Selection

## Canonical outcome

Produce a defensible, executable and measurable approach to **protocol and pattern selection** within the broader capability of **integration design**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines reliable contracts and patterns between systems.

This skill owns the decision and execution contract for **protocol and pattern selection**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **protocol and pattern selection**.
...
- Protocol and Pattern Selection decision brief
...
Expected artifact families for this domain include: integration contract, vendor assessment, SLA, exit plan.

## Operating workflow

1. Frame the exact decision or outcome governed by protocol and pattern selection.
...
- Define ownership and retries.
- Avoid irreversible vendor coupling.
...
```yaml
skill_id: PLC-233
skill: protocol-and-pattern-selection
...
```text
Act as the accountable owner for Protocol and Pattern Selection.
