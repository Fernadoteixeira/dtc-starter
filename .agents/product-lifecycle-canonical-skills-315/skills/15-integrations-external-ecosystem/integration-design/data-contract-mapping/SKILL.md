---
id: "PLC-234"
name: "data-contract-mapping"
title: "Data Contract Mapping"
...
maturity: "canonical"
version: "1.0.0"
tags: ["contract", "data", "design", "ecosystem", "external", "integration", "integrations", "mapping"]
---
...
Produce a defensible, executable and measurable approach to **data contract mapping** within the broader capability of **integration design**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines reliable contracts and patterns between systems.

This skill owns the decision and execution contract for **data contract mapping**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **data contract mapping**.
...
- Data Contract Mapping decision brief
...
1. Frame the exact decision or outcome governed by data contract mapping.
...
```text
Act as the accountable owner for Data Contract Mapping.
