...
maturity: "canonical"
version: "1.0.0"
tags: ["design", "ecosystem", "external", "integration", "integrations", "reliability"]
---
...
Produce a defensible, executable and measurable approach to **integration reliability** within the broader capability of **integration design**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines reliable contracts and patterns between systems.

This skill owns the decision and execution contract for **integration reliability**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **integration reliability**.
...
- Integration Reliability decision brief
...
1. Frame the exact decision or outcome governed by integration reliability.
...
```text
Act as the accountable owner for Integration Reliability.
