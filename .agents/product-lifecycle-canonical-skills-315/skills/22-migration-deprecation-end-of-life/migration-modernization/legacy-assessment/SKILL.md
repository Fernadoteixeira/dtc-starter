...
maturity: "canonical"
version: "1.0.0"
tags: ["assessment", "deprecation", "end", "legacy", "migration", "modernization"]
---
...
Produce a defensible, executable and measurable approach to **legacy assessment** within the broader capability of **migration and modernization**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Moves systems and data with controlled cutover and validation.

This skill owns the decision and execution contract for **legacy assessment**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **legacy assessment**.
...
- Legacy Assessment decision brief
...
1. Frame the exact decision or outcome governed by legacy assessment.
...
```text
Act as the accountable owner for Legacy Assessment.
