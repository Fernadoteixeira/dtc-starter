---
id: "PLC-311"
name: "migration-cutover-validation"
title: "Migration Cutover Validation"
kind: "atomic-capability"
domain: "22-migration-deprecation-end-of-life"
domain_title: "Migration, Deprecation and End of Life"
capability_pack: "migration-modernization"
capability_pack_title: "Migration and Modernization"
...
maturity: "canonical"
version: "1.0.0"
tags: ["cutover", "deprecation", "end", "migration", "modernization", "validation"]
---
...
Produce a defensible, executable and measurable approach to **migration cutover validation** within the broader capability of **migration and modernization**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Moves systems and data with controlled cutover and validation.

This skill owns the decision and execution contract for **migration cutover validation**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **migration cutover validation**.
...
- Migration Cutover Validation decision brief
...
1. Frame the exact decision or outcome governed by migration cutover validation.
...
```yaml
skill_id: PLC-311
skill: migration-cutover-validation
...
```text
Act as the accountable owner for Migration Cutover Validation.
