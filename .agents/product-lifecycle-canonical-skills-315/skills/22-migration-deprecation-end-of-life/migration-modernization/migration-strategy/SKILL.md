...
maturity: "canonical"
version: "1.0.0"
tags: ["deprecation", "end", "migration", "modernization", "strategy"]
---
...
Produce a defensible, executable and measurable approach to **migration strategy** within the broader capability of **migration and modernization**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Moves systems and data with controlled cutover and validation.

This skill owns the decision and execution contract for **migration strategy**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **migration strategy**.
...
- Migration Strategy decision brief
...
1. Frame the exact decision or outcome governed by migration strategy.
...
```text
Act as the accountable owner for Migration Strategy.
