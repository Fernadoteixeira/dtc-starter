...
maturity: "canonical"
version: "1.0.0"
tags: ["customer", "deprecation", "end", "migration", "sunset", "transition"]
---
...
Produce a defensible, executable and measurable approach to **customer transition** within the broader capability of **deprecation and sunset**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Transitions customers and safely retires products or services.

This skill owns the decision and execution contract for **customer transition**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **customer transition**.
...
- Customer Transition decision brief
...
1. Frame the exact decision or outcome governed by customer transition.
...
```text
Act as the accountable owner for Customer Transition.
