---
id: "PLC-314"
name: "archival-retention-and-closeout"
title: "Archival Retention and Closeout"
kind: "atomic-capability"
domain: "22-migration-deprecation-end-of-life"
domain_title: "Migration, Deprecation and End of Life"
capability_pack: "deprecation-sunset"
capability_pack_title: "Deprecation and Sunset"
technology_agnostic: true
language_agnostic: true
industry_agnostic: true
lifecycle_modes: ["assess", "plan", "migrate", "validate", "transition", "retire", "close"]
maturity: "canonical"
version: "1.0.0"
tags: ["archival", "closeout", "deprecation", "end", "migration", "retention", "sunset"]
---

# Archival Retention and Closeout

## Canonical outcome

Produce a defensible, executable and measurable approach to **archival retention and closeout** within the broader capability of **deprecation and sunset**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Transitions customers and safely retires products or services.

This skill owns the decision and execution contract for **archival retention and closeout**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **archival retention and closeout**.
...
- Archival Retention and Closeout decision brief
...
Expected artifact families for this domain include: migration plan, cutover plan, deprecation policy, closeout evidence.

## Operating workflow

1. Frame the exact decision or outcome governed by archival retention and closeout.
...
- Preserve reversibility until validation.
- Communicate timelines clearly.
- Prove data retention and deletion obligations.
...
```yaml
skill_id: PLC-314
skill: archival-retention-and-closeout
...
```text
Act as the accountable owner for Archival Retention and Closeout.
