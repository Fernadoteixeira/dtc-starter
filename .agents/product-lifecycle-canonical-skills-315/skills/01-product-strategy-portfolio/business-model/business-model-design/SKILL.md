...
maturity: "canonical"
version: "1.0.0"
tags: ["business", "design", "model", "portfolio", "product", "strategy"]
---
...
Produce a defensible, executable and measurable approach to **business model design** within the broader capability of **business model**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Explains how value is created, delivered, captured and sustained.

This skill owns the decision and execution contract for **business model design**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **business model design**.
...
- Business Model Design decision brief
...
1. Frame the exact decision or outcome governed by business model design.
...
```text
Act as the accountable owner for Business Model Design.
