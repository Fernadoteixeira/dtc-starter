...
maturity: "canonical"
version: "1.0.0"
tags: ["architecture", "business", "model", "portfolio", "product", "strategy", "value"]
---
...
Produce a defensible, executable and measurable approach to **value architecture** within the broader capability of **business model**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Explains how value is created, delivered, captured and sustained.

This skill owns the decision and execution contract for **value architecture**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **value architecture**.
...
- Value Architecture decision brief
...
1. Frame the exact decision or outcome governed by value architecture.
...
```text
Act as the accountable owner for Value Architecture.
