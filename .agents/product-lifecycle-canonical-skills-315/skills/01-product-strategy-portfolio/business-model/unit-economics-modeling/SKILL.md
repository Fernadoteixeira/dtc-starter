...
capability_pack: "business-model"
capability_pack_title: "Business Model"
...
maturity: "canonical"
version: "1.0.0"
tags: ["business", "economics", "model", "modeling", "portfolio", "product", "strategy", "unit"]
---
...
Produce a defensible, executable and measurable approach to **unit economics modeling** within the broader capability of **business model**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Explains how value is created, delivered, captured and sustained.

This skill owns the decision and execution contract for **unit economics modeling**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **unit economics modeling**.
...
- Unit Economics Modeling decision brief
...
1. Frame the exact decision or outcome governed by unit economics modeling.
...
```text
Act as the accountable owner for Unit Economics Modeling.
