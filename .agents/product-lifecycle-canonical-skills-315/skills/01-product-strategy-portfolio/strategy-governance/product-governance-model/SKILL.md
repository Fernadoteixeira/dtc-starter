---
id: "PLC-012"
name: "product-governance-model"
title: "Product Governance Model"
...
maturity: "canonical"
version: "1.0.0"
tags: ["governance", "model", "portfolio", "product", "strategy"]
---
...
Produce a defensible, executable and measurable approach to **product governance model** within the broader capability of **strategy governance**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Establishes decision rights, review cadence and accountability for strategy.

This skill owns the decision and execution contract for **product governance model**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **product governance model**.
...
- Product Governance Model decision brief
...
1. Frame the exact decision or outcome governed by product governance model.
...
```yaml
skill_id: PLC-012
skill: product-governance-model
...
```text
Act as the accountable owner for Product Governance Model.
