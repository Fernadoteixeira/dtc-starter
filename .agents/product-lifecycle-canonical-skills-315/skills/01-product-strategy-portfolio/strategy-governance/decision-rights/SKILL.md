...
maturity: "canonical"
version: "1.0.0"
tags: ["decision", "governance", "portfolio", "product", "rights", "strategy"]
---
...
Produce a defensible, executable and measurable approach to **decision rights** within the broader capability of **strategy governance**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Establishes decision rights, review cadence and accountability for strategy.

This skill owns the decision and execution contract for **decision rights**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **decision rights**.
...
- Decision Rights decision brief
...
1. Frame the exact decision or outcome governed by decision rights.
...
```text
Act as the accountable owner for Decision Rights.
