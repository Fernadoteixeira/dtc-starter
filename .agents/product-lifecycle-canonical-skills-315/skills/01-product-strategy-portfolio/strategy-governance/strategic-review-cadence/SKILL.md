---
id: "PLC-014"
name: "strategic-review-cadence"
title: "Strategic Review Cadence"
kind: "atomic-capability"
domain: "01-product-strategy-portfolio"
domain_title: "Product Strategy and Portfolio"
capability_pack: "strategy-governance"
capability_pack_title: "Strategy Governance"
...
maturity: "canonical"
version: "1.0.0"
tags: ["cadence", "governance", "portfolio", "product", "review", "strategic", "strategy"]
---
...
Produce a defensible, executable and measurable approach to **strategic review cadence** within the broader capability of **strategy governance**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Establishes decision rights, review cadence and accountability for strategy.

This skill owns the decision and execution contract for **strategic review cadence**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **strategic review cadence**.
...
- Strategic Review Cadence decision brief
...
1. Frame the exact decision or outcome governed by strategic review cadence.
...
```yaml
skill_id: PLC-014
skill: strategic-review-cadence
...
```text
Act as the accountable owner for Strategic Review Cadence.
