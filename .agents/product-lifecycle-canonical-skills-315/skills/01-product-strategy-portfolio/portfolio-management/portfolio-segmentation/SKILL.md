...
capability_pack: "portfolio-management"
capability_pack_title: "Portfolio Management"
...
maturity: "canonical"
version: "1.0.0"
tags: ["management", "portfolio", "product", "segmentation", "strategy"]
---
...
Produce a defensible, executable and measurable approach to **portfolio segmentation** within the broader capability of **portfolio management**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Allocates attention and investment across multiple products, bets or initiatives.

This skill owns the decision and execution contract for **portfolio segmentation**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **portfolio segmentation**.
...
- Portfolio Segmentation decision brief
...
1. Frame the exact decision or outcome governed by portfolio segmentation.
...
```text
Act as the accountable owner for Portfolio Segmentation.
