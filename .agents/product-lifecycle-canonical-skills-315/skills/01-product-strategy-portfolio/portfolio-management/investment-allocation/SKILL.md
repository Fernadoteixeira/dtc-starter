...
maturity: "canonical"
version: "1.0.0"
tags: ["allocation", "investment", "management", "portfolio", "product", "strategy"]
---
...
Produce a defensible, executable and measurable approach to **investment allocation** within the broader capability of **portfolio management**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Allocates attention and investment across multiple products, bets or initiatives.

This skill owns the decision and execution contract for **investment allocation**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **investment allocation**.
...
- Investment Allocation decision brief
...
1. Frame the exact decision or outcome governed by investment allocation.
...
```text
Act as the accountable owner for Investment Allocation.
