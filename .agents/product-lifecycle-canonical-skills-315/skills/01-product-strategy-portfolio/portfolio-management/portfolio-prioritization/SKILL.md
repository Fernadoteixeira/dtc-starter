...
maturity: "canonical"
version: "1.0.0"
tags: ["management", "portfolio", "prioritization", "product", "strategy"]
---
...
Produce a defensible, executable and measurable approach to **portfolio prioritization** within the broader capability of **portfolio management**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Allocates attention and investment across multiple products, bets or initiatives.

This skill owns the decision and execution contract for **portfolio prioritization**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **portfolio prioritization**.
...
- Portfolio Prioritization decision brief
...
1. Frame the exact decision or outcome governed by portfolio prioritization.
...
```text
Act as the accountable owner for Portfolio Prioritization.
