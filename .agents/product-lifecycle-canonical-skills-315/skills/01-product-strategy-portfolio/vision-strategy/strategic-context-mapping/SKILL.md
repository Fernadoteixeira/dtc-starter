---
id: "PLC-002"
name: "strategic-context-mapping"
title: "Strategic Context Mapping"
...
maturity: "canonical"
version: "1.0.0"
tags: ["context", "mapping", "portfolio", "product", "strategic", "strategy", "vision"]
---
...
Produce a defensible, executable and measurable approach to **strategic context mapping** within the broader capability of **vision and strategy**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines the direction, strategic logic and narrative that align product decisions.

This skill owns the decision and execution contract for **strategic context mapping**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **strategic context mapping**.
...
- Strategic Context Mapping decision brief
...
1. Frame the exact decision or outcome governed by strategic context mapping.
...
```yaml
skill_id: PLC-002
skill: strategic-context-mapping
...
```text
Act as the accountable owner for Strategic Context Mapping.
