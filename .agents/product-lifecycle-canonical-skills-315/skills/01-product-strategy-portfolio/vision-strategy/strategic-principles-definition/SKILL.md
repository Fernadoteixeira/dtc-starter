---
id: "PLC-003"
name: "strategic-principles-definition"
title: "Strategic Principles Definition"
kind: "atomic-capability"
domain: "01-product-strategy-portfolio"
domain_title: "Product Strategy and Portfolio"
capability_pack: "vision-strategy"
capability_pack_title: "Vision and Strategy"
technology_agnostic: true
language_agnostic: true
industry_agnostic: true
lifecycle_modes: ["discover", "frame", "design", "prioritize", "govern", "optimize"]
maturity: "canonical"
version: "1.0.0"
tags: ["definition", "portfolio", "principles", "product", "strategic", "strategy", "vision"]
---

# Strategic Principles Definition

## Canonical outcome

Produce a defensible, executable and measurable approach to **strategic principles definition** within the broader capability of **vision and strategy**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines the direction, strategic logic and narrative that align product decisions.

This skill owns the decision and execution contract for **strategic principles definition**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **strategic principles definition**.
...
- Strategic Principles Definition decision brief
...
Expected artifact families for this domain include: strategy brief, portfolio decision, investment rationale, review cadence.

## Operating workflow

1. Frame the exact decision or outcome governed by strategic principles definition.
...
- Tie investment to measurable outcomes.
...
```yaml
skill_id: PLC-003
skill: strategic-principles-definition
...
```text
Act as the accountable owner for Strategic Principles Definition.
