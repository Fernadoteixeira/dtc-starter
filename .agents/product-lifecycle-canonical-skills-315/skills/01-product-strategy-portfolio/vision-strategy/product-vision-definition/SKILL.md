...
title: "Product Vision Definition"
...
maturity: "canonical"
version: "1.0.0"
tags: ["definition", "portfolio", "product", "strategy", "vision"]
---
...
Produce a defensible, executable and measurable approach to **product vision definition** within the broader capability of **vision and strategy**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines the direction, strategic logic and narrative that align product decisions.

This skill owns the decision and execution contract for **product vision definition**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **product vision definition**.
...
- Product Vision Definition decision brief
...
1. Frame the exact decision or outcome governed by product vision definition.
...
```yaml
skill_id: PLC-001
skill: product-vision-definition
...
```text
Act as the accountable owner for Product Vision Definition.
