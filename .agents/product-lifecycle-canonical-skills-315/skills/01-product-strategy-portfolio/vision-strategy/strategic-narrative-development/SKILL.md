...
maturity: "canonical"
version: "1.0.0"
tags: ["development", "narrative", "portfolio", "product", "strategic", "strategy", "vision"]
---
...
Produce a defensible, executable and measurable approach to **strategic narrative development** within the broader capability of **vision and strategy**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines the direction, strategic logic and narrative that align product decisions.

This skill owns the decision and execution contract for **strategic narrative development**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **strategic narrative development**.
...
- Strategic Narrative Development decision brief
...
1. Frame the exact decision or outcome governed by strategic narrative development.
...
```yaml
skill_id: PLC-004
skill: strategic-narrative-development
...
```text
Act as the accountable owner for Strategic Narrative Development.
