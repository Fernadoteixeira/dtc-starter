...
maturity: "canonical"
version: "1.0.0"
tags: ["acceptance", "definition", "done", "planning", "product", "requirements"]
---
...
Produce a defensible, executable and measurable approach to **definition of done** within the broader capability of **acceptance and planning**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines readiness, completion, dependencies and sequencing.

This skill owns the decision and execution contract for **definition of done**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **definition of done**.
...
- Definition of Done decision brief
...
1. Frame the exact decision or outcome governed by definition of done.
...
```text
Act as the accountable owner for Definition of Done.
