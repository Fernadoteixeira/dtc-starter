...
capability_pack: "acceptance-planning"
capability_pack_title: "Acceptance and Planning"
...
maturity: "canonical"
version: "1.0.0"
tags: ["acceptance", "definition", "dependency", "identification", "planning", "product", "requirements"]
---
...
Produce a defensible, executable and measurable approach to **dependency identification** within the broader capability of **acceptance and planning**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines readiness, completion, dependencies and sequencing.

This skill owns the decision and execution contract for **dependency identification**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **dependency identification**.
...
- Dependency Identification decision brief
...
1. Frame the exact decision or outcome governed by dependency identification.
...
```text
Act as the accountable owner for Dependency Identification.
