...
maturity: "canonical"
version: "1.0.0"
tags: ["acceptance", "definition", "planning", "product", "ready", "requirements"]
---
...
Produce a defensible, executable and measurable approach to **definition of ready** within the broader capability of **acceptance and planning**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines readiness, completion, dependencies and sequencing.

This skill owns the decision and execution contract for **definition of ready**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **definition of ready**.
...
- Definition of Ready decision brief
...
1. Frame the exact decision or outcome governed by definition of ready.
...
```text
Act as the accountable owner for Definition of Ready.
