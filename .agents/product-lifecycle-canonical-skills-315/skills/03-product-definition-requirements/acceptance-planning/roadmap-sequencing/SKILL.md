...
maturity: "canonical"
version: "1.0.0"
tags: ["acceptance", "definition", "planning", "product", "requirements", "roadmap", "sequencing"]
---
...
Produce a defensible, executable and measurable approach to **roadmap sequencing** within the broader capability of **acceptance and planning**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines readiness, completion, dependencies and sequencing.

This skill owns the decision and execution contract for **roadmap sequencing**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **roadmap sequencing**.
...
- Roadmap Sequencing decision brief
...
1. Frame the exact decision or outcome governed by roadmap sequencing.
...
```text
Act as the accountable owner for Roadmap Sequencing.
