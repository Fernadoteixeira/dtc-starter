...
maturity: "canonical"
version: "1.0.0"
tags: ["boundary", "definition", "outcomes", "product", "requirements", "scope"]
---
...
Produce a defensible, executable and measurable approach to **scope boundary definition** within the broader capability of **outcomes and scope**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines desired outcomes, boundaries, constraints and alignment.

This skill owns the decision and execution contract for **scope boundary definition**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **scope boundary definition**.
...
- Scope Boundary Definition decision brief
...
1. Frame the exact decision or outcome governed by scope boundary definition.
...
```text
Act as the accountable owner for Scope Boundary Definition.
