...
maturity: "canonical"
version: "1.0.0"
tags: ["alignment", "definition", "outcomes", "product", "requirements", "scope", "stakeholder"]
---
...
Produce a defensible, executable and measurable approach to **stakeholder alignment** within the broader capability of **outcomes and scope**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines desired outcomes, boundaries, constraints and alignment.

This skill owns the decision and execution contract for **stakeholder alignment**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **stakeholder alignment**.
...
- Stakeholder Alignment decision brief
...
1. Frame the exact decision or outcome governed by stakeholder alignment.
...
```text
Act as the accountable owner for Stakeholder Alignment.
