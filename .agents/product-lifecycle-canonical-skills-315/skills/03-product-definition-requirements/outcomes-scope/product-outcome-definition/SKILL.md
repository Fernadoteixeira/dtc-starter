---
id: "PLC-031"
name: "product-outcome-definition"
title: "Product Outcome Definition"
kind: "atomic-capability"
domain: "03-product-definition-requirements"
domain_title: "Product Definition and Requirements"
capability_pack: "outcomes-scope"
capability_pack_title: "Outcomes and Scope"
technology_agnostic: true
language_agnostic: true
industry_agnostic: true
lifecycle_modes: ["define", "decompose", "specify", "validate", "prioritize"]
maturity: "canonical"
version: "1.0.0"
tags: ["definition", "outcome", "outcomes", "product", "requirements", "scope"]
---
...
Produce a defensible, executable and measurable approach to **product outcome definition** within the broader capability of **outcomes and scope**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines desired outcomes, boundaries, constraints and alignment.

This skill owns the decision and execution contract for **product outcome definition**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **product outcome definition**.
...
- Product Outcome Definition decision brief
...
Expected artifact families for this domain include: requirement set, acceptance model, scope boundary, traceability map.

## Operating workflow

1. Frame the exact decision or outcome governed by product outcome definition.
...
- Describe outcomes before solutions.
...
```yaml
skill_id: PLC-031
skill: product-outcome-definition
...
```text
Act as the accountable owner for Product Outcome Definition.
