...
maturity: "canonical"
version: "1.0.0"
tags: ["definition", "metrics", "outcomes", "product", "requirements", "scope", "success"]
---
...
Produce a defensible, executable and measurable approach to **success metrics definition** within the broader capability of **outcomes and scope**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Defines desired outcomes, boundaries, constraints and alignment.

This skill owns the decision and execution contract for **success metrics definition**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **success metrics definition**.
...
- Success Metrics Definition decision brief
...
1. Frame the exact decision or outcome governed by success metrics definition.
...
```yaml
skill_id: PLC-032
skill: success-metrics-definition
...
```text
Act as the accountable owner for Success Metrics Definition.
