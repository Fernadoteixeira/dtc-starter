...
maturity: "canonical"
version: "1.0.0"
tags: ["data", "definition", "engineering", "product", "requirements"]
---
...
Produce a defensible, executable and measurable approach to **data requirements** within the broader capability of **requirements engineering**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Turns business and user needs into testable product contracts.

This skill owns the decision and execution contract for **data requirements**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **data requirements**.
...
- Data Requirements decision brief
...
1. Frame the exact decision or outcome governed by data requirements.
...
```text
Act as the accountable owner for Data Requirements.
