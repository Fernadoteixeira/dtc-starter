...
maturity: "canonical"
version: "1.0.0"
tags: ["definition", "engineering", "model", "product", "requirements", "traceability"]
---
...
Produce a defensible, executable and measurable approach to **traceability model** within the broader capability of **requirements engineering**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Turns business and user needs into testable product contracts.

This skill owns the decision and execution contract for **traceability model**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **traceability model**.
...
- Traceability Model decision brief
...
1. Frame the exact decision or outcome governed by traceability model.
...
```text
Act as the accountable owner for Traceability Model.
