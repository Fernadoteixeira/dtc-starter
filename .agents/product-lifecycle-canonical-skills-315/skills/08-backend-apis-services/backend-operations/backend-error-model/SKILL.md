---
id: "PLC-128"
name: "backend-error-model"
title: "Backend Error Model"
kind: "atomic-capability"
domain: "08-backend-apis-services"
domain_title: "Backend, APIs and Services"
capability_pack: "backend-operations"
capability_pack_title: "Backend Operations"
...
maturity: "canonical"
version: "1.0.0"
tags: ["apis", "backend", "error", "model", "operations", "services"]
---
...
Produce a defensible, executable and measurable approach to **backend error model** within the broader capability of **backend operations**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Makes backend services observable, configurable and scalable.

This skill owns the decision and execution contract for **backend error model**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **backend error model**.
...
- Backend Error Model decision brief
...
1. Frame the exact decision or outcome governed by backend error model.
...
```text
Act as the accountable owner for Backend Error Model.
