...
maturity: "canonical"
version: "1.0.0"
tags: ["apis", "backend", "configuration", "operations", "service", "services"]
---
...
Produce a defensible, executable and measurable approach to **service configuration** within the broader capability of **backend operations**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Makes backend services observable, configurable and scalable.

This skill owns the decision and execution contract for **service configuration**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **service configuration**.
...
- Service Configuration decision brief
...
1. Frame the exact decision or outcome governed by service configuration.
...
```text
Act as the accountable owner for Service Configuration.
