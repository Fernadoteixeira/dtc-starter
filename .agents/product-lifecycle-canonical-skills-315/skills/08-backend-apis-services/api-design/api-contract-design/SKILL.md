...
maturity: "canonical"
version: "1.0.0"
tags: ["api", "apis", "backend", "contract", "design", "services"]
---
...
Produce a defensible, executable and measurable approach to **api contract design** within the broader capability of **api design**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Creates stable, understandable and evolvable interfaces.

This skill owns the decision and execution contract for **api contract design**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **api contract design**.
...
- API Contract Design decision brief
...
1. Frame the exact decision or outcome governed by api contract design.
...
```text
Act as the accountable owner for API Contract Design.
