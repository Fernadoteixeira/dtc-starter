...
domain: "08-backend-apis-services"
domain_title: "Backend, APIs and Services"
capability_pack: "api-design"
capability_pack_title: "API Design"
technology_agnostic: true
language_agnostic: true
industry_agnostic: true
lifecycle_modes: ["assess", "design", "implement", "verify", "operate", "scale"]
maturity: "canonical"
version: "1.0.0"
tags: ["api", "apis", "backend", "design", "filtering", "pagination", "services", "sorting"]
---
...
Produce a defensible, executable and measurable approach to **pagination filtering and sorting** within the broader capability of **api design**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Creates stable, understandable and evolvable interfaces.

This skill owns the decision and execution contract for **pagination filtering and sorting**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **pagination filtering and sorting**.
...
- Pagination Filtering and Sorting decision brief
...
Expected artifact families for this domain include: service contract, API specification, processing model, operational controls.

## Operating workflow

1. Frame the exact decision or outcome governed by pagination filtering and sorting.
...
```yaml
skill_id: PLC-122
skill: pagination-filtering-and-sorting
...
```text
Act as the accountable owner for Pagination Filtering and Sorting.
