...
maturity: "canonical"
version: "1.0.0"
tags: ["api", "apis", "backend", "design", "modeling", "resource", "services"]
---
...
Produce a defensible, executable and measurable approach to **resource modeling** within the broader capability of **api design**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Creates stable, understandable and evolvable interfaces.

This skill owns the decision and execution contract for **resource modeling**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **resource modeling**.
...
- Resource Modeling decision brief
...
1. Frame the exact decision or outcome governed by resource modeling.
...
```text
Act as the accountable owner for Resource Modeling.
