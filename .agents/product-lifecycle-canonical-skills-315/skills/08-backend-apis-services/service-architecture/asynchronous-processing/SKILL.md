...
maturity: "canonical"
version: "1.0.0"
tags: ["apis", "architecture", "asynchronous", "backend", "processing", "service", "services"]
---
...
Produce a defensible, executable and measurable approach to **asynchronous processing** within the broader capability of **service architecture**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Structures backend services around clear responsibilities.

This skill owns the decision and execution contract for **asynchronous processing**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **asynchronous processing**.
...
- Asynchronous Processing decision brief
...
1. Frame the exact decision or outcome governed by asynchronous processing.
...
```text
Act as the accountable owner for Asynchronous Processing.
