...
maturity: "canonical"
version: "1.0.0"
tags: ["apis", "architecture", "backend", "design", "domain", "service", "services"]
---
...
Produce a defensible, executable and measurable approach to **domain service design** within the broader capability of **service architecture**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Structures backend services around clear responsibilities.

This skill owns the decision and execution contract for **domain service design**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **domain service design**.
...
- Domain Service Design decision brief
...
1. Frame the exact decision or outcome governed by domain service design.
...
```text
Act as the accountable owner for Domain Service Design.
