...
maturity: "canonical"
version: "1.0.0"
tags: ["apis", "backend", "background", "domain", "jobs", "processing", "services"]
---
...
Produce a defensible, executable and measurable approach to **background jobs** within the broader capability of **domain processing**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Coordinates validation, transactions, workflows and background work.

This skill owns the decision and execution contract for **background jobs**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **background jobs**.
...
- Background Jobs decision brief
...
1. Frame the exact decision or outcome governed by background jobs.
...
```text
Act as the accountable owner for Background Jobs.
