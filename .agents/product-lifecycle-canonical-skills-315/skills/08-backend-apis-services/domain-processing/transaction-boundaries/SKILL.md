...
maturity: "canonical"
version: "1.0.0"
tags: ["apis", "backend", "boundaries", "domain", "processing", "services", "transaction"]
---
...
Produce a defensible, executable and measurable approach to **transaction boundaries** within the broader capability of **domain processing**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Coordinates validation, transactions, workflows and background work.

This skill owns the decision and execution contract for **transaction boundaries**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **transaction boundaries**.
...
- Transaction Boundaries decision brief
...
1. Frame the exact decision or outcome governed by transaction boundaries.
...
```text
Act as the accountable owner for Transaction Boundaries.
