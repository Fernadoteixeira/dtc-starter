...
capability_pack: "domain-processing"
capability_pack_title: "Domain Processing"
...
maturity: "canonical"
version: "1.0.0"
tags: ["apis", "backend", "domain", "machines", "processing", "services", "state", "workflow"]
---
...
Produce a defensible, executable and measurable approach to **workflow state machines** within the broader capability of **domain processing**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Coordinates validation, transactions, workflows and background work.

This skill owns the decision and execution contract for **workflow state machines**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **workflow state machines**.
...
- Workflow State Machines decision brief
...
1. Frame the exact decision or outcome governed by workflow state machines.
...
```text
Act as the accountable owner for Workflow State Machines.
