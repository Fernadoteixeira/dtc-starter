...
maturity: "canonical"
version: "1.0.0"
tags: ["experimentation", "growth", "monetization", "pricing", "strategy"]
---
...
Produce a defensible, executable and measurable approach to **pricing strategy** within the broader capability of **monetization**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Designs pricing, packaging, entitlement and revenue operations.

This skill owns the decision and execution contract for **pricing strategy**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **pricing strategy**.
...
- Pricing Strategy decision brief
...
1. Frame the exact decision or outcome governed by pricing strategy.
...
```text
Act as the accountable owner for Pricing Strategy.
