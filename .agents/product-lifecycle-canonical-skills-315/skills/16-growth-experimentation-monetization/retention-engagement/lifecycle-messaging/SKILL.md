...
maturity: "canonical"
version: "1.0.0"
tags: ["engagement", "experimentation", "growth", "lifecycle", "messaging", "monetization", "retention"]
---
...
Produce a defensible, executable and measurable approach to **lifecycle messaging** within the broader capability of **retention and engagement**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Builds durable engagement and lifecycle value.

This skill owns the decision and execution contract for **lifecycle messaging**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **lifecycle messaging**.
...
- Lifecycle Messaging decision brief
...
1. Frame the exact decision or outcome governed by lifecycle messaging.
...
```text
Act as the accountable owner for Lifecycle Messaging.
