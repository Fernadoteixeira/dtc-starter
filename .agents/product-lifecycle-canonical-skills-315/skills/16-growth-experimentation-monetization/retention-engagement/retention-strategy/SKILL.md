...
maturity: "canonical"
version: "1.0.0"
tags: ["engagement", "experimentation", "growth", "monetization", "retention", "strategy"]
---
...
Produce a defensible, executable and measurable approach to **retention strategy** within the broader capability of **retention and engagement**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Builds durable engagement and lifecycle value.

This skill owns the decision and execution contract for **retention strategy**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **retention strategy**.
...
- Retention Strategy decision brief
...
1. Frame the exact decision or outcome governed by retention strategy.
...
```text
Act as the accountable owner for Retention Strategy.
