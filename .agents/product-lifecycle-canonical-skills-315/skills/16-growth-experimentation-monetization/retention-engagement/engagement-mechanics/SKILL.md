...
capability_pack: "retention-engagement"
capability_pack_title: "Retention and Engagement"
...
maturity: "canonical"
version: "1.0.0"
tags: ["engagement", "experimentation", "growth", "mechanics", "monetization", "retention"]
---
...
Produce a defensible, executable and measurable approach to **engagement mechanics** within the broader capability of **retention and engagement**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Builds durable engagement and lifecycle value.

This skill owns the decision and execution contract for **engagement mechanics**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **engagement mechanics**.
...
- Engagement Mechanics decision brief
...
1. Frame the exact decision or outcome governed by engagement mechanics.
...
```text
Act as the accountable owner for Engagement Mechanics.
