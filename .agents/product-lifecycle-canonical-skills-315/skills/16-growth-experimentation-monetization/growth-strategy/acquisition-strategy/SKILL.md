...
maturity: "canonical"
version: "1.0.0"
tags: ["acquisition", "experimentation", "growth", "monetization", "strategy"]
---
...
Produce a defensible, executable and measurable approach to **acquisition strategy** within the broader capability of **growth strategy**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Models sustainable acquisition, activation and referral.

This skill owns the decision and execution contract for **acquisition strategy**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **acquisition strategy**.
...
- Acquisition Strategy decision brief
...
1. Frame the exact decision or outcome governed by acquisition strategy.
...
```text
Act as the accountable owner for Acquisition Strategy.
