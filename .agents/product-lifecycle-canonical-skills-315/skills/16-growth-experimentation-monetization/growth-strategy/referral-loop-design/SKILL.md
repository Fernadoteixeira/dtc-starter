...
capability_pack: "growth-strategy"
capability_pack_title: "Growth Strategy"
...
maturity: "canonical"
version: "1.0.0"
tags: ["design", "experimentation", "growth", "loop", "monetization", "referral", "strategy"]
---
...
Produce a defensible, executable and measurable approach to **referral loop design** within the broader capability of **growth strategy**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Models sustainable acquisition, activation and referral.

This skill owns the decision and execution contract for **referral loop design**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **referral loop design**.
...
- Referral Loop Design decision brief
...
1. Frame the exact decision or outcome governed by referral loop design.
...
```text
Act as the accountable owner for Referral Loop Design.
