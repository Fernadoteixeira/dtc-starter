...
maturity: "canonical"
version: "1.0.0"
tags: ["activation", "experimentation", "growth", "monetization", "strategy"]
---
...
Produce a defensible, executable and measurable approach to **activation strategy** within the broader capability of **growth strategy**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Models sustainable acquisition, activation and referral.

This skill owns the decision and execution contract for **activation strategy**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **activation strategy**.
...
- Activation Strategy decision brief
...
1. Frame the exact decision or outcome governed by activation strategy.
...
```text
Act as the accountable owner for Activation Strategy.
