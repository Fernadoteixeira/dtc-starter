...
maturity: "canonical"
version: "1.0.0"
tags: ["experimentation", "growth", "model", "monetization", "strategy"]
---
...
Produce a defensible, executable and measurable approach to **growth model** within the broader capability of **growth strategy**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Models sustainable acquisition, activation and referral.

This skill owns the decision and execution contract for **growth model**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **growth model**.
...
1. Frame the exact decision or outcome governed by growth model.
...
```text
Act as the accountable owner for Growth Model.
