...
maturity: "canonical"
version: "1.0.0"
tags: ["design", "experiment", "experimentation", "growth", "monetization"]
---
...
Produce a defensible, executable and measurable approach to **experiment design** within the broader capability of **experimentation**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Turns hypotheses into causal decisions.

This skill owns the decision and execution contract for **experiment design**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **experiment design**.
...
- Experiment Design decision brief
...
1. Frame the exact decision or outcome governed by experiment design.
...
```text
Act as the accountable owner for Experiment Design.
