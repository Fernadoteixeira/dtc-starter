...
maturity: "canonical"
version: "1.0.0"
tags: ["customer", "design", "knowledge", "operations", "self", "service", "support"]
---
...
Produce a defensible, executable and measurable approach to **self service knowledge** within the broader capability of **support design**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Designs support channels, service levels and escalation.

This skill owns the decision and execution contract for **self service knowledge**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **self service knowledge**.
...
- Self Service Knowledge decision brief
...
1. Frame the exact decision or outcome governed by self service knowledge.
...
```text
Act as the accountable owner for Self Service Knowledge.
