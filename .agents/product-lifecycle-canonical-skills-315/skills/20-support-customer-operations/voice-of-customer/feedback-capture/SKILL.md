...
maturity: "canonical"
version: "1.0.0"
tags: ["capture", "customer", "feedback", "operations", "support", "voice"]
---
...
Produce a defensible, executable and measurable approach to **feedback capture** within the broader capability of **voice of customer**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Turns feedback into structured product learning.

This skill owns the decision and execution contract for **feedback capture**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **feedback capture**.
...
- Feedback Capture decision brief
...
1. Frame the exact decision or outcome governed by feedback capture.
...
```text
Act as the accountable owner for Feedback Capture.
