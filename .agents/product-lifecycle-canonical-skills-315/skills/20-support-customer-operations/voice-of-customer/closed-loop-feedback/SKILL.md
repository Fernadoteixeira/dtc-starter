...
capability_pack: "voice-of-customer"
capability_pack_title: "Voice of Customer"
...
maturity: "canonical"
version: "1.0.0"
tags: ["closed", "customer", "feedback", "loop", "operations", "support", "voice"]
---
...
Produce a defensible, executable and measurable approach to **closed loop feedback** within the broader capability of **voice of customer**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Turns feedback into structured product learning.

This skill owns the decision and execution contract for **closed loop feedback**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **closed loop feedback**.
...
- Closed Loop Feedback decision brief
...
1. Frame the exact decision or outcome governed by closed loop feedback.
...
```text
Act as the accountable owner for Closed Loop Feedback.
