...
maturity: "canonical"
version: "1.0.0"
tags: ["case", "communication", "customer", "operations", "support"]
---
...
Produce a defensible, executable and measurable approach to **customer communication** within the broader capability of **case operations**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Runs customer cases through queues, communication and resolution.

This skill owns the decision and execution contract for **customer communication**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **customer communication**.
...
- Customer Communication decision brief
...
1. Frame the exact decision or outcome governed by customer communication.
...
```text
Act as the accountable owner for Customer Communication.
