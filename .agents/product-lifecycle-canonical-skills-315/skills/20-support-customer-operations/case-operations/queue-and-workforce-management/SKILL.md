---
id: "PLC-295"
name: "queue-and-workforce-management"
title: "Queue and Workforce Management"
kind: "atomic-capability"
domain: "20-support-customer-operations"
domain_title: "Support and Customer Operations"
capability_pack: "case-operations"
capability_pack_title: "Case Operations"
technology_agnostic: true
language_agnostic: true
industry_agnostic: true
lifecycle_modes: ["design", "instrument", "operate", "triage", "resolve", "learn"]
maturity: "canonical"
version: "1.0.0"
tags: ["case", "customer", "management", "operations", "queue", "support", "workforce"]
---
...
Produce a defensible, executable and measurable approach to **queue and workforce management** within the broader capability of **case operations**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Runs customer cases through queues, communication and resolution.

This skill owns the decision and execution contract for **queue and workforce management**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **queue and workforce management**.
...
- Queue and Workforce Management decision brief
...
Expected artifact families for this domain include: support model, case workflow, knowledge article, feedback insight.

## Operating workflow

1. Frame the exact decision or outcome governed by queue and workforce management.
...
```yaml
skill_id: PLC-295
skill: queue-and-workforce-management
...
```text
Act as the accountable owner for Queue and Workforce Management.
