...
maturity: "canonical"
version: "1.0.0"
tags: ["case", "customer", "lifecycle", "management", "operations", "support"]
---
...
Produce a defensible, executable and measurable approach to **case lifecycle management** within the broader capability of **case operations**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Runs customer cases through queues, communication and resolution.

This skill owns the decision and execution contract for **case lifecycle management**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **case lifecycle management**.
...
- Case Lifecycle Management decision brief
...
1. Frame the exact decision or outcome governed by case lifecycle management.
...
```yaml
skill_id: PLC-294
skill: case-lifecycle-management
...
```text
Act as the accountable owner for Case Lifecycle Management.
