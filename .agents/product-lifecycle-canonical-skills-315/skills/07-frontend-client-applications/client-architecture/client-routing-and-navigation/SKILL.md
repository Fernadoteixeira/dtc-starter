---
id: "PLC-101"
name: "client-routing-and-navigation"
title: "Client Routing and Navigation"
kind: "atomic-capability"
domain: "07-frontend-client-applications"
domain_title: "Frontend and Client Applications"
capability_pack: "client-architecture"
capability_pack_title: "Client Architecture"
technology_agnostic: true
language_agnostic: true
industry_agnostic: true
lifecycle_modes: ["assess", "design", "implement", "verify", "operate", "optimize"]
maturity: "canonical"
version: "1.0.0"
tags: ["applications", "architecture", "client", "frontend", "navigation", "routing"]
---
...
Produce a defensible, executable and measurable approach to **client routing and navigation** within the broader capability of **client architecture**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Structures client applications for maintainability and evolution.

This skill owns the decision and execution contract for **client routing and navigation**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **client routing and navigation**.
...
- Client Routing and Navigation decision brief
...
Expected artifact families for this domain include: client architecture, state contract, implementation plan, browser validation.

## Operating workflow

1. Frame the exact decision or outcome governed by client routing and navigation.
...
- Minimize unnecessary client state.
...
```yaml
skill_id: PLC-101
skill: client-routing-and-navigation
...
```text
Act as the accountable owner for Client Routing and Navigation.
