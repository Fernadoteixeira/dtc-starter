...
maturity: "canonical"
version: "1.0.0"
tags: ["application", "applications", "architecture", "client", "frontend", "shell"]
---
...
Produce a defensible, executable and measurable approach to **application shell architecture** within the broader capability of **client architecture**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Structures client applications for maintainability and evolution.

This skill owns the decision and execution contract for **application shell architecture**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **application shell architecture**.
...
- Application Shell Architecture decision brief
...
1. Frame the exact decision or outcome governed by application shell architecture.
...
```yaml
skill_id: PLC-099
skill: application-shell-architecture
...
```text
Act as the accountable owner for Application Shell Architecture.
