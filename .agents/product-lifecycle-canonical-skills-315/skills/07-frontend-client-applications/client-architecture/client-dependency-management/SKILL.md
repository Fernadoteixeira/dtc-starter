---
id: "PLC-102"
name: "client-dependency-management"
title: "Client Dependency Management"
...
maturity: "canonical"
version: "1.0.0"
tags: ["applications", "architecture", "client", "dependency", "frontend", "management"]
---
...
Produce a defensible, executable and measurable approach to **client dependency management** within the broader capability of **client architecture**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Structures client applications for maintainability and evolution.

This skill owns the decision and execution contract for **client dependency management**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **client dependency management**.
...
- Client Dependency Management decision brief
...
1. Frame the exact decision or outcome governed by client dependency management.
...
```yaml
skill_id: PLC-102
skill: client-dependency-management
...
```text
Act as the accountable owner for Client Dependency Management.
