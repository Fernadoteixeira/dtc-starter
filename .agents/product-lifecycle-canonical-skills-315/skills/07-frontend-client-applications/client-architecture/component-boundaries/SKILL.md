...
maturity: "canonical"
version: "1.0.0"
tags: ["applications", "architecture", "boundaries", "client", "component", "frontend"]
---
...
Produce a defensible, executable and measurable approach to **component boundaries** within the broader capability of **client architecture**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Structures client applications for maintainability and evolution.

This skill owns the decision and execution contract for **component boundaries**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **component boundaries**.
...
- Component Boundaries decision brief
...
1. Frame the exact decision or outcome governed by component boundaries.
...
```text
Act as the accountable owner for Component Boundaries.
