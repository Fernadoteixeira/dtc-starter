---
id: "PLC-106"
name: "optimistic-interaction"
title: "Optimistic Interaction"
...
maturity: "canonical"
version: "1.0.0"
tags: ["applications", "client", "data", "flow", "frontend", "interaction", "optimistic", "state"]
---
...
Produce a defensible, executable and measurable approach to **optimistic interaction** within the broader capability of **state and data flow**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Controls local, shared and server-synchronized state.

This skill owns the decision and execution contract for **optimistic interaction**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **optimistic interaction**.
...
- Optimistic Interaction decision brief
...
1. Frame the exact decision or outcome governed by optimistic interaction.
...
```text
Act as the accountable owner for Optimistic Interaction.
