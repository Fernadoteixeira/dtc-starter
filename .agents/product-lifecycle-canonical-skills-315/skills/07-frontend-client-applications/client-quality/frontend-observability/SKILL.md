...
maturity: "canonical"
version: "1.0.0"
tags: ["applications", "client", "frontend", "observability", "quality"]
---
...
Produce a defensible, executable and measurable approach to **frontend observability** within the broader capability of **client quality**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Protects compatibility, security, recovery and observability on the client.

This skill owns the decision and execution contract for **frontend observability**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **frontend observability**.
...
- Frontend Observability decision brief
...
1. Frame the exact decision or outcome governed by frontend observability.
...
```text
Act as the accountable owner for Frontend Observability.
