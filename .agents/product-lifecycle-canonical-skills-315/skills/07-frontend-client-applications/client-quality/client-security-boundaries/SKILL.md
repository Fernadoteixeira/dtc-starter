---
id: "PLC-113"
name: "client-security-boundaries"
title: "Client Security Boundaries"
kind: "atomic-capability"
domain: "07-frontend-client-applications"
domain_title: "Frontend and Client Applications"
capability_pack: "client-quality"
capability_pack_title: "Client Quality"
...
maturity: "canonical"
version: "1.0.0"
tags: ["applications", "boundaries", "client", "frontend", "quality", "security"]
---
...
Produce a defensible, executable and measurable approach to **client security boundaries** within the broader capability of **client quality**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Protects compatibility, security, recovery and observability on the client.

This skill owns the decision and execution contract for **client security boundaries**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **client security boundaries**.
...
- Client Security Boundaries decision brief
...
1. Frame the exact decision or outcome governed by client security boundaries.
...
```yaml
skill_id: PLC-113
skill: client-security-boundaries
...
```text
Act as the accountable owner for Client Security Boundaries.
