...
maturity: "canonical"
version: "1.0.0"
tags: ["applications", "browser", "client", "compatibility", "cross", "frontend", "quality"]
---
...
Produce a defensible, executable and measurable approach to **cross browser compatibility** within the broader capability of **client quality**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Protects compatibility, security, recovery and observability on the client.

This skill owns the decision and execution contract for **cross browser compatibility**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **cross browser compatibility**.
...
- Cross Browser Compatibility decision brief
...
1. Frame the exact decision or outcome governed by cross browser compatibility.
...
```text
Act as the accountable owner for Cross Browser Compatibility.
