---
id: "PLC-111"
name: "client-error-recovery"
title: "Client Error Recovery"
...
maturity: "canonical"
version: "1.0.0"
tags: ["applications", "client", "error", "frontend", "quality", "recovery"]
---
...
Produce a defensible, executable and measurable approach to **client error recovery** within the broader capability of **client quality**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Protects compatibility, security, recovery and observability on the client.

This skill owns the decision and execution contract for **client error recovery**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **client error recovery**.
...
- Client Error Recovery decision brief
...
1. Frame the exact decision or outcome governed by client error recovery.
...
```text
Act as the accountable owner for Client Error Recovery.
