...
maturity: "canonical"
version: "1.0.0"
tags: ["applications", "client", "frontend", "interaction", "performance", "rendering"]
---
...
Produce a defensible, executable and measurable approach to **rendering performance** within the broader capability of **rendering and interaction**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Balances rendering, loading, enhancement and resilience.

This skill owns the decision and execution contract for **rendering performance**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **rendering performance**.
...
- Rendering Performance decision brief
...
1. Frame the exact decision or outcome governed by rendering performance.
...
```text
Act as the accountable owner for Rendering Performance.
