...
maturity: "canonical"
version: "1.0.0"
tags: ["applications", "asset", "client", "frontend", "interaction", "loading", "rendering"]
---
...
Produce a defensible, executable and measurable approach to **asset loading** within the broader capability of **rendering and interaction**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Balances rendering, loading, enhancement and resilience.

This skill owns the decision and execution contract for **asset loading**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **asset loading**.
...
1. Frame the exact decision or outcome governed by asset loading.
...
```text
Act as the accountable owner for Asset Loading.
