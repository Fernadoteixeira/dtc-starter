...
capability_pack: "rendering-interaction"
capability_pack_title: "Rendering and Interaction"
...
maturity: "canonical"
version: "1.0.0"
tags: ["applications", "client", "enhancement", "frontend", "interaction", "progressive", "rendering"]
---
...
Produce a defensible, executable and measurable approach to **progressive enhancement** within the broader capability of **rendering and interaction**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Balances rendering, loading, enhancement and resilience.

This skill owns the decision and execution contract for **progressive enhancement**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **progressive enhancement**.
...
- Progressive Enhancement decision brief
...
1. Frame the exact decision or outcome governed by progressive enhancement.
...
```text
Act as the accountable owner for Progressive Enhancement.
