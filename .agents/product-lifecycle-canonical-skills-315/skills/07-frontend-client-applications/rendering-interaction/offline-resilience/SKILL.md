...
maturity: "canonical"
version: "1.0.0"
tags: ["applications", "client", "frontend", "interaction", "offline", "rendering", "resilience"]
---
...
Produce a defensible, executable and measurable approach to **offline resilience** within the broader capability of **rendering and interaction**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Balances rendering, loading, enhancement and resilience.

This skill owns the decision and execution contract for **offline resilience**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **offline resilience**.
...
- Offline Resilience decision brief
...
1. Frame the exact decision or outcome governed by offline resilience.
...
```text
Act as the accountable owner for Offline Resilience.
