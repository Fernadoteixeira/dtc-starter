...
capability_pack: "release-management"
capability_pack_title: "Release Management"
...
maturity: "canonical"
version: "1.0.0"
tags: ["change", "coordination", "delivery", "management", "release", "rollout"]
---
...
Produce a defensible, executable and measurable approach to **rollout coordination** within the broader capability of **release management**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Coordinates readiness, rollout, verification and communication.

This skill owns the decision and execution contract for **rollout coordination**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **rollout coordination**.
...
- Rollout Coordination decision brief
...
1. Frame the exact decision or outcome governed by rollout coordination.
...
```text
Act as the accountable owner for Rollout Coordination.
