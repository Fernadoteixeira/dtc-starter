...
maturity: "canonical"
version: "1.0.0"
tags: ["change", "delivery", "management", "readiness", "release"]
---
...
Produce a defensible, executable and measurable approach to **release readiness** within the broader capability of **release management**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Coordinates readiness, rollout, verification and communication.

This skill owns the decision and execution contract for **release readiness**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **release readiness**.
...
- Release Readiness decision brief
...
1. Frame the exact decision or outcome governed by release readiness.
...
```text
Act as the accountable owner for Release Readiness.
