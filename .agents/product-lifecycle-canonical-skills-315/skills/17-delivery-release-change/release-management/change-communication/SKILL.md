...
maturity: "canonical"
version: "1.0.0"
tags: ["change", "communication", "delivery", "management", "release"]
---
...
Produce a defensible, executable and measurable approach to **change communication** within the broader capability of **release management**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Coordinates readiness, rollout, verification and communication.

This skill owns the decision and execution contract for **change communication**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **change communication**.
...
- Change Communication decision brief
...
1. Frame the exact decision or outcome governed by change communication.
...
```text
Act as the accountable owner for Change Communication.
