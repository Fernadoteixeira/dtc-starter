...
maturity: "canonical"
version: "1.0.0"
tags: ["change", "delivery", "management", "release", "verification"]
---
...
Produce a defensible, executable and measurable approach to **release verification** within the broader capability of **release management**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Coordinates readiness, rollout, verification and communication.

This skill owns the decision and execution contract for **release verification**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **release verification**.
...
- Release Verification decision brief
...
1. Frame the exact decision or outcome governed by release verification.
...
```text
Act as the accountable owner for Release Verification.
