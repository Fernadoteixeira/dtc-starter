...
maturity: "canonical"
version: "1.0.0"
tags: ["change", "delivery", "management", "release", "risk"]
---
...
Produce a defensible, executable and measurable approach to **delivery risk management** within the broader capability of **change and risk management**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Controls adoption, impact, dependencies and delivery risk.

This skill owns the decision and execution contract for **delivery risk management**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **delivery risk management**.
...
- Delivery Risk Management decision brief
...
1. Frame the exact decision or outcome governed by delivery risk management.
...
```yaml
skill_id: PLC-268
skill: delivery-risk-management
...
```text
Act as the accountable owner for Delivery Risk Management.
