...
domain: "17-delivery-release-change"
domain_title: "Delivery, Release and Change Management"
capability_pack: "change-risk-management"
capability_pack_title: "Change and Risk Management"
technology_agnostic: true
language_agnostic: true
industry_agnostic: true
lifecycle_modes: ["plan", "sequence", "coordinate", "release", "verify", "communicate", "learn"]
maturity: "canonical"
version: "1.0.0"
tags: ["change", "cross", "delivery", "dependency", "management", "release", "risk", "team"]
---
...
Produce a defensible, executable and measurable approach to **cross team dependency management** within the broader capability of **change and risk management**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Controls adoption, impact, dependencies and delivery risk.

This skill owns the decision and execution contract for **cross team dependency management**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **cross team dependency management**.
...
- Cross Team Dependency Management decision brief
...
Expected artifact families for this domain include: delivery plan, release plan, risk register, change communication.

## Operating workflow

1. Frame the exact decision or outcome governed by cross team dependency management.
...
- Do not hide uncertainty in estimates.
...
```yaml
skill_id: PLC-269
skill: cross-team-dependency-management
...
```text
Act as the accountable owner for Cross Team Dependency Management.
