...
maturity: "canonical"
version: "1.0.0"
tags: ["assessment", "change", "delivery", "impact", "management", "release", "risk"]
---
...
Produce a defensible, executable and measurable approach to **change impact assessment** within the broader capability of **change and risk management**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Controls adoption, impact, dependencies and delivery risk.

This skill owns the decision and execution contract for **change impact assessment**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **change impact assessment**.
...
- Change Impact Assessment decision brief
...
1. Frame the exact decision or outcome governed by change impact assessment.
...
```text
Act as the accountable owner for Change Impact Assessment.
