...
maturity: "canonical"
version: "1.0.0"
tags: ["adoption", "change", "delivery", "management", "release", "risk"]
---
...
Produce a defensible, executable and measurable approach to **adoption management** within the broader capability of **change and risk management**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Controls adoption, impact, dependencies and delivery risk.

This skill owns the decision and execution contract for **adoption management**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **adoption management**.
...
- Adoption Management decision brief
...
1. Frame the exact decision or outcome governed by adoption management.
...
```text
Act as the accountable owner for Adoption Management.
