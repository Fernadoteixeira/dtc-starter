...
maturity: "canonical"
version: "1.0.0"
tags: ["change", "decomposition", "delivery", "planning", "release", "work"]
---
...
Produce a defensible, executable and measurable approach to **work decomposition** within the broader capability of **delivery planning**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Decomposes and sequences work against constraints.

This skill owns the decision and execution contract for **work decomposition**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **work decomposition**.
...
- Work Decomposition decision brief
...
1. Frame the exact decision or outcome governed by work decomposition.
...
```text
Act as the accountable owner for Work Decomposition.
