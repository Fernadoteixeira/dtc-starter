---
id: "PLC-258"
name: "estimation-and-forecasting"
...
capability_pack: "delivery-planning"
capability_pack_title: "Delivery Planning"
...
maturity: "canonical"
version: "1.0.0"
tags: ["change", "delivery", "estimation", "forecasting", "planning", "release"]
---
...
Produce a defensible, executable and measurable approach to **estimation and forecasting** within the broader capability of **delivery planning**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Decomposes and sequences work against constraints.

This skill owns the decision and execution contract for **estimation and forecasting**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **estimation and forecasting**.
...
- Estimation and Forecasting decision brief
...
1. Frame the exact decision or outcome governed by estimation and forecasting.
...
```yaml
skill_id: PLC-258
skill: estimation-and-forecasting
...
```text
Act as the accountable owner for Estimation and Forecasting.
