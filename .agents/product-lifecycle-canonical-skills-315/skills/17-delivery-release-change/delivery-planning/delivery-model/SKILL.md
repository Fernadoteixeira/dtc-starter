...
maturity: "canonical"
version: "1.0.0"
tags: ["change", "delivery", "model", "planning", "release"]
---
...
Produce a defensible, executable and measurable approach to **delivery model** within the broader capability of **delivery planning**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Decomposes and sequences work against constraints.

This skill owns the decision and execution contract for **delivery model**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **delivery model**.
...
1. Frame the exact decision or outcome governed by delivery model.
...
```text
Act as the accountable owner for Delivery Model.
