...
maturity: "canonical"
version: "1.0.0"
tags: ["change", "delivery", "milestone", "planning", "release"]
---
...
Produce a defensible, executable and measurable approach to **milestone planning** within the broader capability of **delivery planning**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Decomposes and sequences work against constraints.

This skill owns the decision and execution contract for **milestone planning**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **milestone planning**.
...
- Milestone Planning decision brief
...
1. Frame the exact decision or outcome governed by milestone planning.
...
```text
Act as the accountable owner for Milestone Planning.
