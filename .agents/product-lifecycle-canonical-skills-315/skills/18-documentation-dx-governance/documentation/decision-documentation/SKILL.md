...
maturity: "canonical"
version: "1.0.0"
tags: ["decision", "documentation", "dx", "governance"]
---
...
Produce a defensible, executable and measurable approach to **decision documentation** within the broader capability of **documentation**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Structures technical and operational knowledge for use and maintenance.

This skill owns the decision and execution contract for **decision documentation**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **decision documentation**.
...
- Decision Documentation decision brief
...
1. Frame the exact decision or outcome governed by decision documentation.
...
```text
Act as the accountable owner for Decision Documentation.
