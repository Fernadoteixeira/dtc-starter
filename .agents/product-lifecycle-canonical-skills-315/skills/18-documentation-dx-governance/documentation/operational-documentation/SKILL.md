...
capability_pack: "documentation"
capability_pack_title: "Documentation"
...
maturity: "canonical"
version: "1.0.0"
tags: ["documentation", "dx", "governance", "operational"]
---
...
Produce a defensible, executable and measurable approach to **operational documentation** within the broader capability of **documentation**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Structures technical and operational knowledge for use and maintenance.

This skill owns the decision and execution contract for **operational documentation**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **operational documentation**.
...
- Operational Documentation decision brief
...
1. Frame the exact decision or outcome governed by operational documentation.
...
```yaml
skill_id: PLC-272
skill: operational-documentation
...
```text
Act as the accountable owner for Operational Documentation.
