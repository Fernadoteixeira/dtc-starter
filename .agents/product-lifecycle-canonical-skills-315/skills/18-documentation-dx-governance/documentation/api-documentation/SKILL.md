...
maturity: "canonical"
version: "1.0.0"
tags: ["api", "documentation", "dx", "governance"]
---
...
Produce a defensible, executable and measurable approach to **api documentation** within the broader capability of **documentation**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Structures technical and operational knowledge for use and maintenance.

This skill owns the decision and execution contract for **api documentation**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **api documentation**.
...
- API Documentation decision brief
...
1. Frame the exact decision or outcome governed by api documentation.
...
```text
Act as the accountable owner for API Documentation.
