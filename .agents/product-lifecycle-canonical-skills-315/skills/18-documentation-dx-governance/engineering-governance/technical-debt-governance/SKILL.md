...
maturity: "canonical"
version: "1.0.0"
tags: ["debt", "documentation", "dx", "engineering", "governance", "technical"]
---
...
Produce a defensible, executable and measurable approach to **technical debt governance** within the broader capability of **engineering governance**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Standardizes code, repositories, debt and review cadence.

This skill owns the decision and execution contract for **technical debt governance**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **technical debt governance**.
...
- Technical Debt Governance decision brief
...
1. Frame the exact decision or outcome governed by technical debt governance.
...
```text
Act as the accountable owner for Technical Debt Governance.
