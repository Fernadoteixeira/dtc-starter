---
id: "PLC-281"
name: "engineering-review-cadence"
title: "Engineering Review Cadence"
kind: "atomic-capability"
domain: "18-documentation-dx-governance"
domain_title: "Documentation, Developer Experience and Governance"
capability_pack: "engineering-governance"
capability_pack_title: "Engineering Governance"
technology_agnostic: true
language_agnostic: true
industry_agnostic: true
lifecycle_modes: ["design", "document", "automate", "measure", "govern", "improve"]
maturity: "canonical"
version: "1.0.0"
tags: ["cadence", "documentation", "dx", "engineering", "governance", "review"]
---
...
Produce a defensible, executable and measurable approach to **engineering review cadence** within the broader capability of **engineering governance**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Standardizes code, repositories, debt and review cadence.

This skill owns the decision and execution contract for **engineering review cadence**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **engineering review cadence**.
...
- Engineering Review Cadence decision brief
...
Expected artifact families for this domain include: documentation system, developer workflow, engineering policy, governance review.

## Operating workflow

1. Frame the exact decision or outcome governed by engineering review cadence.
...
```yaml
skill_id: PLC-281
skill: engineering-review-cadence
...
```text
Act as the accountable owner for Engineering Review Cadence.
