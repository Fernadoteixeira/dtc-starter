...
maturity: "canonical"
version: "1.0.0"
tags: ["documentation", "dx", "engineering", "governance", "repository"]
---
...
Produce a defensible, executable and measurable approach to **repository governance** within the broader capability of **engineering governance**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Standardizes code, repositories, debt and review cadence.

This skill owns the decision and execution contract for **repository governance**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **repository governance**.
...
- Repository Governance decision brief
...
1. Frame the exact decision or outcome governed by repository governance.
...
```text
Act as the accountable owner for Repository Governance.
