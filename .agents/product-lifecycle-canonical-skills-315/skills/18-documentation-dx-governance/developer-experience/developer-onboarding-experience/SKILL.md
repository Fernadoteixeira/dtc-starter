...
capability_pack: "developer-experience"
capability_pack_title: "Developer Experience"
...
maturity: "canonical"
version: "1.0.0"
tags: ["developer", "documentation", "dx", "experience", "governance", "onboarding"]
---
...
Produce a defensible, executable and measurable approach to **developer onboarding experience** within the broader capability of **developer experience**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Reduces friction across setup, feedback and contribution.

This skill owns the decision and execution contract for **developer onboarding experience**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **developer onboarding experience**.
...
- Developer Onboarding Experience decision brief
...
1. Frame the exact decision or outcome governed by developer onboarding experience.
...
```yaml
skill_id: PLC-277
skill: developer-onboarding-experience
...
```text
Act as the accountable owner for Developer Onboarding Experience.
