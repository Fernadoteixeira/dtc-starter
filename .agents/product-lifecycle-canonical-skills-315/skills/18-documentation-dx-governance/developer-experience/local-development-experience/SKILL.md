...
maturity: "canonical"
version: "1.0.0"
tags: ["developer", "development", "documentation", "dx", "experience", "governance", "local"]
---
...
Produce a defensible, executable and measurable approach to **local development experience** within the broader capability of **developer experience**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Reduces friction across setup, feedback and contribution.

This skill owns the decision and execution contract for **local development experience**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **local development experience**.
...
- Local Development Experience decision brief
...
1. Frame the exact decision or outcome governed by local development experience.
...
```yaml
skill_id: PLC-274
skill: local-development-experience
...
```text
Act as the accountable owner for Local Development Experience.
