...
maturity: "canonical"
version: "1.0.0"
tags: ["automation", "developer", "documentation", "dx", "experience", "governance", "tooling"]
---
...
Produce a defensible, executable and measurable approach to **tooling automation** within the broader capability of **developer experience**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Reduces friction across setup, feedback and contribution.

This skill owns the decision and execution contract for **tooling automation**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **tooling automation**.
...
- Tooling Automation decision brief
...
1. Frame the exact decision or outcome governed by tooling automation.
...
```text
Act as the accountable owner for Tooling Automation.
