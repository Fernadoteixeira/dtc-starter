...
maturity: "canonical"
version: "1.0.0"
tags: ["build", "developer", "documentation", "dx", "experience", "feedback", "governance", "loops"]
---
...
Produce a defensible, executable and measurable approach to **build feedback loops** within the broader capability of **developer experience**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Reduces friction across setup, feedback and contribution.

This skill owns the decision and execution contract for **build feedback loops**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **build feedback loops**.
...
- Build Feedback Loops decision brief
...
1. Frame the exact decision or outcome governed by build feedback loops.
...
```text
Act as the accountable owner for Build Feedback Loops.
