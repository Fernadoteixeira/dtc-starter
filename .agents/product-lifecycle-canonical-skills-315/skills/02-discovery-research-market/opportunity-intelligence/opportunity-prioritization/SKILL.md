...
capability_pack: "opportunity-intelligence"
capability_pack_title: "Opportunity Intelligence"
...
maturity: "canonical"
version: "1.0.0"
tags: ["discovery", "intelligence", "market", "opportunity", "prioritization", "research"]
---
...
Produce a defensible, executable and measurable approach to **opportunity prioritization** within the broader capability of **opportunity intelligence**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Identifies and ranks opportunities using market, trend and competitive evidence.

This skill owns the decision and execution contract for **opportunity prioritization**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **opportunity prioritization**.
...
- Opportunity Prioritization decision brief
...
1. Frame the exact decision or outcome governed by opportunity prioritization.
...
```yaml
skill_id: PLC-020
skill: opportunity-prioritization
...
```text
Act as the accountable owner for Opportunity Prioritization.
