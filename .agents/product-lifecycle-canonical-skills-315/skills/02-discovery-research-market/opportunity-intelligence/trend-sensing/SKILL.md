...
maturity: "canonical"
version: "1.0.0"
tags: ["discovery", "intelligence", "market", "opportunity", "research", "sensing", "trend"]
---
...
Produce a defensible, executable and measurable approach to **trend sensing** within the broader capability of **opportunity intelligence**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Identifies and ranks opportunities using market, trend and competitive evidence.

This skill owns the decision and execution contract for **trend sensing**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **trend sensing**.
...
1. Frame the exact decision or outcome governed by trend sensing.
...
```text
Act as the accountable owner for Trend Sensing.
