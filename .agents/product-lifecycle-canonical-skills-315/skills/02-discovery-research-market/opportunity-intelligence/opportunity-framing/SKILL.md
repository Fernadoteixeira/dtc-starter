...
maturity: "canonical"
version: "1.0.0"
tags: ["discovery", "framing", "intelligence", "market", "opportunity", "research"]
---
...
Produce a defensible, executable and measurable approach to **opportunity framing** within the broader capability of **opportunity intelligence**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Identifies and ranks opportunities using market, trend and competitive evidence.

This skill owns the decision and execution contract for **opportunity framing**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **opportunity framing**.
...
- Opportunity Framing decision brief
...
1. Frame the exact decision or outcome governed by opportunity framing.
...
```text
Act as the accountable owner for Opportunity Framing.
