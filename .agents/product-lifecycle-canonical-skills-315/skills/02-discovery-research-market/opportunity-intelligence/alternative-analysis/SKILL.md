...
maturity: "canonical"
version: "1.0.0"
tags: ["alternative", "analysis", "discovery", "intelligence", "market", "opportunity", "research"]
---
...
Produce a defensible, executable and measurable approach to **alternative analysis** within the broader capability of **opportunity intelligence**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Identifies and ranks opportunities using market, trend and competitive evidence.

This skill owns the decision and execution contract for **alternative analysis**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **alternative analysis**.
...
- Alternative Analysis decision brief
...
1. Frame the exact decision or outcome governed by alternative analysis.
...
```text
Act as the accountable owner for Alternative Analysis.
