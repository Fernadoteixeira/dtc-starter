...
maturity: "canonical"
version: "1.0.0"
tags: ["competitive", "discovery", "intelligence", "landscape", "market", "opportunity", "research"]
---
...
Produce a defensible, executable and measurable approach to **competitive landscape** within the broader capability of **opportunity intelligence**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Identifies and ranks opportunities using market, trend and competitive evidence.

This skill owns the decision and execution contract for **competitive landscape**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **competitive landscape**.
...
- Competitive Landscape decision brief
...
1. Frame the exact decision or outcome governed by competitive landscape.
...
```text
Act as the accountable owner for Competitive Landscape.
