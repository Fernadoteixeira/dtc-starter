...
maturity: "canonical"
version: "1.0.0"
tags: ["discovery", "intelligence", "market", "opportunity", "research", "sizing"]
---
...
Produce a defensible, executable and measurable approach to **market sizing** within the broader capability of **opportunity intelligence**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Identifies and ranks opportunities using market, trend and competitive evidence.

This skill owns the decision and execution contract for **market sizing**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **market sizing**.
...
1. Frame the exact decision or outcome governed by market sizing.
...
```text
Act as the accountable owner for Market Sizing.
