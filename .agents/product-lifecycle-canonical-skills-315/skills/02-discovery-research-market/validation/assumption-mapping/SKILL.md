...
maturity: "canonical"
version: "1.0.0"
tags: ["assumption", "discovery", "mapping", "market", "research", "validation"]
---
...
Produce a defensible, executable and measurable approach to **assumption mapping** within the broader capability of **validation**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Reduces uncertainty through explicit assumptions and evidence.

This skill owns the decision and execution contract for **assumption mapping**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **assumption mapping**.
...
- Assumption Mapping decision brief
...
1. Frame the exact decision or outcome governed by assumption mapping.
...
```text
Act as the accountable owner for Assumption Mapping.
