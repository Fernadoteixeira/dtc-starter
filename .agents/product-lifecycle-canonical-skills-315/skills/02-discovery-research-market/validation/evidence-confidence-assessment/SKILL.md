---
id: "PLC-030"
name: "evidence-confidence-assessment"
title: "Evidence Confidence Assessment"
kind: "atomic-capability"
domain: "02-discovery-research-market"
domain_title: "Discovery, Research and Market Intelligence"
capability_pack: "validation"
capability_pack_title: "Validation"
technology_agnostic: true
language_agnostic: true
industry_agnostic: true
lifecycle_modes: ["discover", "research", "validate", "synthesize", "recommend"]
maturity: "canonical"
version: "1.0.0"
tags: ["assessment", "confidence", "discovery", "evidence", "market", "research", "validation"]
---
...
Produce a defensible, executable and measurable approach to **evidence confidence assessment** within the broader capability of **validation**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Reduces uncertainty through explicit assumptions and evidence.

This skill owns the decision and execution contract for **evidence confidence assessment**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **evidence confidence assessment**.
...
- Evidence Confidence Assessment decision brief
...
Expected artifact families for this domain include: research plan, evidence map, market model, validated insight.

## Operating workflow

1. Frame the exact decision or outcome governed by evidence confidence assessment.
...
- Distinguish signal, inference and opinion.
...
```yaml
skill_id: PLC-030
skill: evidence-confidence-assessment
...
```text
Act as the accountable owner for Evidence Confidence Assessment.
