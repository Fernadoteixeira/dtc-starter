---
id: "PLC-028"
name: "solution-concept-validation"
...
maturity: "canonical"
version: "1.0.0"
tags: ["concept", "discovery", "market", "research", "solution", "validation"]
---
...
Produce a defensible, executable and measurable approach to **solution concept validation** within the broader capability of **validation**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Reduces uncertainty through explicit assumptions and evidence.

This skill owns the decision and execution contract for **solution concept validation**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **solution concept validation**.
...
- Solution Concept Validation decision brief
...
1. Frame the exact decision or outcome governed by solution concept validation.
...
```yaml
skill_id: PLC-028
skill: solution-concept-validation
...
```text
Act as the accountable owner for Solution Concept Validation.
