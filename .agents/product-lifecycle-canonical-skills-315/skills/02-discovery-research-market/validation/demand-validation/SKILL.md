...
maturity: "canonical"
version: "1.0.0"
tags: ["demand", "discovery", "market", "research", "validation"]
---
...
Produce a defensible, executable and measurable approach to **demand validation** within the broader capability of **validation**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Reduces uncertainty through explicit assumptions and evidence.

This skill owns the decision and execution contract for **demand validation**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **demand validation**.
...
- Demand Validation decision brief
...
1. Frame the exact decision or outcome governed by demand validation.
...
```text
Act as the accountable owner for Demand Validation.
