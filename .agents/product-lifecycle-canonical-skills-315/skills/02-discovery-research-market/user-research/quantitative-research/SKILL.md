...
maturity: "canonical"
version: "1.0.0"
tags: ["discovery", "market", "quantitative", "research", "user"]
---
...
Produce a defensible, executable and measurable approach to **quantitative research** within the broader capability of **user research**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Builds reliable understanding of users, behaviors, needs and contexts.

This skill owns the decision and execution contract for **quantitative research**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **quantitative research**.
...
- Quantitative Research decision brief
...
1. Frame the exact decision or outcome governed by quantitative research.
...
```text
Act as the accountable owner for Quantitative Research.
