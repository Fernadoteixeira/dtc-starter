...
maturity: "canonical"
version: "1.0.0"
tags: ["discovery", "market", "research", "synthesis", "user"]
---
...
Produce a defensible, executable and measurable approach to **research synthesis** within the broader capability of **user research**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Builds reliable understanding of users, behaviors, needs and contexts.

This skill owns the decision and execution contract for **research synthesis**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **research synthesis**.
...
- Research Synthesis decision brief
...
1. Frame the exact decision or outcome governed by research synthesis.
...
```text
Act as the accountable owner for Research Synthesis.
