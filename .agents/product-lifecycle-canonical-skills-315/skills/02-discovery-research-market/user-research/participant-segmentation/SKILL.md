...
maturity: "canonical"
version: "1.0.0"
tags: ["discovery", "market", "participant", "research", "segmentation", "user"]
---
...
Produce a defensible, executable and measurable approach to **participant segmentation** within the broader capability of **user research**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Builds reliable understanding of users, behaviors, needs and contexts.

This skill owns the decision and execution contract for **participant segmentation**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **participant segmentation**.
...
- Participant Segmentation decision brief
...
1. Frame the exact decision or outcome governed by participant segmentation.
...
```yaml
skill_id: PLC-022
skill: participant-segmentation
...
```text
Act as the accountable owner for Participant Segmentation.
