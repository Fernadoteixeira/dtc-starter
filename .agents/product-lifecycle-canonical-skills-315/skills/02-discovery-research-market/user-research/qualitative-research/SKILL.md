...
maturity: "canonical"
version: "1.0.0"
tags: ["discovery", "market", "qualitative", "research", "user"]
---
...
Produce a defensible, executable and measurable approach to **qualitative research** within the broader capability of **user research**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Builds reliable understanding of users, behaviors, needs and contexts.

This skill owns the decision and execution contract for **qualitative research**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **qualitative research**.
...
- Qualitative Research decision brief
...
1. Frame the exact decision or outcome governed by qualitative research.
...
```text
Act as the accountable owner for Qualitative Research.
