...
maturity: "canonical"
version: "1.0.0"
tags: ["capacity", "horizontal", "patterns", "performance", "scalability"]
---
...
Produce a defensible, executable and measurable approach to **horizontal scalability** within the broader capability of **scalability patterns**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Designs systems to grow safely under changing load.

This skill owns the decision and execution contract for **horizontal scalability**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **horizontal scalability**.
...
- Horizontal Scalability decision brief
...
1. Frame the exact decision or outcome governed by horizontal scalability.
...
```text
Act as the accountable owner for Horizontal Scalability.
