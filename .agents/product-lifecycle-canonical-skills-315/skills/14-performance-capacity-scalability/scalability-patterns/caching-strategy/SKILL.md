...
maturity: "canonical"
version: "1.0.0"
tags: ["caching", "capacity", "patterns", "performance", "scalability", "strategy"]
---
...
Produce a defensible, executable and measurable approach to **caching strategy** within the broader capability of **scalability patterns**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Designs systems to grow safely under changing load.

This skill owns the decision and execution contract for **caching strategy**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **caching strategy**.
...
- Caching Strategy decision brief
...
1. Frame the exact decision or outcome governed by caching strategy.
...
```text
Act as the accountable owner for Caching Strategy.
