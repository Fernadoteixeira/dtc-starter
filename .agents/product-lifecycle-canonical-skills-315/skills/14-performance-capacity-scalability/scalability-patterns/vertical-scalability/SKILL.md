...
maturity: "canonical"
version: "1.0.0"
tags: ["capacity", "patterns", "performance", "scalability", "vertical"]
---
...
Produce a defensible, executable and measurable approach to **vertical scalability** within the broader capability of **scalability patterns**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Designs systems to grow safely under changing load.

This skill owns the decision and execution contract for **vertical scalability**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **vertical scalability**.
...
- Vertical Scalability decision brief
...
1. Frame the exact decision or outcome governed by vertical scalability.
...
```text
Act as the accountable owner for Vertical Scalability.
