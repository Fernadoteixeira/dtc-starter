...
capability_pack: "performance-engineering"
capability_pack_title: "Performance Engineering"
...
maturity: "canonical"
version: "1.0.0"
tags: ["capacity", "engineering", "optimization", "performance", "scalability", "throughput"]
---
...
Produce a defensible, executable and measurable approach to **throughput optimization** within the broader capability of **performance engineering**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Sets and meets latency, throughput and efficiency expectations.

This skill owns the decision and execution contract for **throughput optimization**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **throughput optimization**.
...
- Throughput Optimization decision brief
...
1. Frame the exact decision or outcome governed by throughput optimization.
...
```text
Act as the accountable owner for Throughput Optimization.
