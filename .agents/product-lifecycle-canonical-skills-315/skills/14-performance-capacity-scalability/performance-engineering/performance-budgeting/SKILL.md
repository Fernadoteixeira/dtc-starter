...
maturity: "canonical"
version: "1.0.0"
tags: ["budgeting", "capacity", "engineering", "performance", "scalability"]
---
...
Produce a defensible, executable and measurable approach to **performance budgeting** within the broader capability of **performance engineering**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Sets and meets latency, throughput and efficiency expectations.

This skill owns the decision and execution contract for **performance budgeting**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **performance budgeting**.
...
- Performance Budgeting decision brief
...
1. Frame the exact decision or outcome governed by performance budgeting.
...
```text
Act as the accountable owner for Performance Budgeting.
