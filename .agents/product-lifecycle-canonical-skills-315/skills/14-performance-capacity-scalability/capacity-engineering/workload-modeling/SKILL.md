...
capability_pack: "capacity-engineering"
capability_pack_title: "Capacity Engineering"
...
maturity: "canonical"
version: "1.0.0"
tags: ["capacity", "engineering", "modeling", "performance", "scalability", "workload"]
---
...
Produce a defensible, executable and measurable approach to **workload modeling** within the broader capability of **capacity engineering**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Models demand, tests headroom and predicts saturation.

This skill owns the decision and execution contract for **workload modeling**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **workload modeling**.
...
- Workload Modeling decision brief
...
1. Frame the exact decision or outcome governed by workload modeling.
...
```text
Act as the accountable owner for Workload Modeling.
