...
maturity: "canonical"
version: "1.0.0"
tags: ["analysis", "capacity", "engineering", "performance", "saturation", "scalability"]
---
...
Produce a defensible, executable and measurable approach to **saturation analysis** within the broader capability of **capacity engineering**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Models demand, tests headroom and predicts saturation.

This skill owns the decision and execution contract for **saturation analysis**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **saturation analysis**.
...
- Saturation Analysis decision brief
...
1. Frame the exact decision or outcome governed by saturation analysis.
...
```text
Act as the accountable owner for Saturation Analysis.
