...
maturity: "canonical"
version: "1.0.0"
tags: ["capacity", "engineering", "load", "performance", "scalability", "testing"]
---
...
Produce a defensible, executable and measurable approach to **load testing** within the broader capability of **capacity engineering**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Models demand, tests headroom and predicts saturation.

This skill owns the decision and execution contract for **load testing**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **load testing**.
...
1. Frame the exact decision or outcome governed by load testing.
...
```text
Act as the accountable owner for Load Testing.
