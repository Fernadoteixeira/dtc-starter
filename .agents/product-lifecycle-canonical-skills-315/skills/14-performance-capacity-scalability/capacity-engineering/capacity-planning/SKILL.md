...
maturity: "canonical"
version: "1.0.0"
tags: ["capacity", "engineering", "performance", "planning", "scalability"]
---
...
Produce a defensible, executable and measurable approach to **capacity planning** within the broader capability of **capacity engineering**, independent of industry, technology stack, programming language or delivery method.

## Capability context

Models demand, tests headroom and predicts saturation.

This skill owns the decision and execution contract for **capacity planning**. It may audit an existing state, design a target state, guide implementation, verify results, govern ongoing operation or support controlled evolution.

## Invoke when

- The product lifecycle requires a material decision about **capacity planning**.
...
- Capacity Planning decision brief
...
1. Frame the exact decision or outcome governed by capacity planning.
...
```text
Act as the accountable owner for Capacity Planning.
