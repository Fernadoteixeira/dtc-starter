...
domains: ["05-ux-service-design-information-architecture", "06-ui-design-system-content-accessibility", "07-frontend-client-applications", "11-quality-testing-validation"]
version: "1.0.0"
---
...
- **UX, Service Design and Information Architecture** (`05-ux-service-design-information-architecture`)
- **UI, Design Systems, Content and Accessibility** (`06-ui-design-system-content-accessibility`)
