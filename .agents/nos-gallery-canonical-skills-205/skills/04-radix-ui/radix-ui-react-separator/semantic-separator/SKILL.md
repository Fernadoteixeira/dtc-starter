---
name: "semantic-separator"
title: "Semantic Separator"
capability_id: "SK-088"
domain: "04-radix-ui"
...
Design, implement, review and troubleshoot **Semantic Separator** using `@radix-ui/react-separator` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Semantic Separator**.
- A design or implementation decision depends on `@radix-ui/react-separator`.
...
- The task only asks whether `@radix-ui/react-separator` is installed.
...
1. Clarify the desired outcome for semantic separator and identify the user-visible or operational result.
2. Inspect the relevant `@radix-ui/react-separator` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides semantic separator, not only a wrapper or installed dependency.
