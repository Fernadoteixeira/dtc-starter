...
Design, implement, review and troubleshoot **Single-value Slider** using `@radix-ui/react-slider` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Single-value Slider**.
...
1. Clarify the desired outcome for single-value slider and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides single-value slider, not only a wrapper or installed dependency.
