---
name: "range-slider-keyboard"
title: "Range Slider and Keyboard"
capability_id: "SK-090"
domain: "04-radix-ui"
...
# Range Slider and Keyboard

## Purpose

Design, implement, review and troubleshoot **Range Slider and Keyboard** using `@radix-ui/react-slider` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Range Slider and Keyboard**.
- A design or implementation decision depends on `@radix-ui/react-slider`.
...
- The task only asks whether `@radix-ui/react-slider` is installed.
...
1. Clarify the desired outcome for range slider and keyboard and identify the user-visible or operational result.
2. Inspect the relevant `@radix-ui/react-slider` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides range slider and keyboard, not only a wrapper or installed dependency.
