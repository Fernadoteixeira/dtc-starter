...
Design, implement, review and troubleshoot **Select Control** using `@radix-ui/react-select` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Select Control**.
...
1. Clarify the desired outcome for select control and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides select control, not only a wrapper or installed dependency.
