---
name: "dialog-focus-portal-dismiss"
title: "Dialog Focus, Portal and Dismissal"
capability_id: "SK-072"
domain: "04-radix-ui"
...
# Dialog Focus, Portal and Dismissal

## Purpose

Design, implement, review and troubleshoot **Dialog Focus, Portal and Dismissal** using `@radix-ui/react-dialog` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Dialog Focus, Portal and Dismissal**.
- A design or implementation decision depends on `@radix-ui/react-dialog`.
...
- The task only asks whether `@radix-ui/react-dialog` is installed.
...
1. Clarify the desired outcome for dialog focus, portal and dismissal and identify the user-visible or operational result.
2. Inspect the relevant `@radix-ui/react-dialog` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides dialog focus, portal and dismissal, not only a wrapper or installed dependency.
