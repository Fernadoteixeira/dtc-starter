...
Design, implement, review and troubleshoot **Modal Dialog** using `@radix-ui/react-dialog` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Modal Dialog**.
...
1. Clarify the desired outcome for modal dialog and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides modal dialog, not only a wrapper or installed dependency.
