---
name: "popover-focus-interaction"
title: "Popover Focus and Interaction"
capability_id: "SK-082"
domain: "04-radix-ui"
...
# Popover Focus and Interaction

## Purpose

Design, implement, review and troubleshoot **Popover Focus and Interaction** using `@radix-ui/react-popover` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Popover Focus and Interaction**.
- A design or implementation decision depends on `@radix-ui/react-popover`.
...
- The task only asks whether `@radix-ui/react-popover` is installed.
...
1. Clarify the desired outcome for popover focus and interaction and identify the user-visible or operational result.
2. Inspect the relevant `@radix-ui/react-popover` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides popover focus and interaction, not only a wrapper or installed dependency.
