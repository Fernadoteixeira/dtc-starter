...
Design, implement, review and troubleshoot **Popover Positioning** using `@radix-ui/react-popover` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Popover Positioning**.
...
1. Clarify the desired outcome for popover positioning and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides popover positioning, not only a wrapper or installed dependency.
