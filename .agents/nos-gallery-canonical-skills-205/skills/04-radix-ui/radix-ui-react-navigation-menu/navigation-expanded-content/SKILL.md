---
name: "navigation-expanded-content"
title: "Expanded Navigation Content"
capability_id: "SK-080"
domain: "04-radix-ui"
...
Design, implement, review and troubleshoot **Expanded Navigation Content** using `@radix-ui/react-navigation-menu` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Expanded Navigation Content**.
- A design or implementation decision depends on `@radix-ui/react-navigation-menu`.
...
- The task only asks whether `@radix-ui/react-navigation-menu` is installed.
...
1. Clarify the desired outcome for expanded navigation content and identify the user-visible or operational result.
2. Inspect the relevant `@radix-ui/react-navigation-menu` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides expanded navigation content, not only a wrapper or installed dependency.
