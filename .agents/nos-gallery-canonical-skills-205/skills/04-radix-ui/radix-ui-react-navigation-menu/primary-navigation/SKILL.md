...
Design, implement, review and troubleshoot **Primary Navigation Menu** using `@radix-ui/react-navigation-menu` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Primary Navigation Menu**.
...
1. Clarify the desired outcome for primary navigation menu and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides primary navigation menu, not only a wrapper or installed dependency.
