...
Design, implement, review and troubleshoot **Toast Notifications** using `@radix-ui/react-toast` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Toast Notifications**.
...
1. Clarify the desired outcome for toast notifications and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides toast notifications, not only a wrapper or installed dependency.
