---
name: "toast-queue-lifecycle"
title: "Toast Queue and Lifecycle"
capability_id: "SK-095"
domain: "04-radix-ui"
...
Design, implement, review and troubleshoot **Toast Queue and Lifecycle** using `@radix-ui/react-toast` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Toast Queue and Lifecycle**.
- A design or implementation decision depends on `@radix-ui/react-toast`.
...
- The task only asks whether `@radix-ui/react-toast` is installed.
...
1. Clarify the desired outcome for toast queue and lifecycle and identify the user-visible or operational result.
2. Inspect the relevant `@radix-ui/react-toast` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides toast queue and lifecycle, not only a wrapper or installed dependency.
