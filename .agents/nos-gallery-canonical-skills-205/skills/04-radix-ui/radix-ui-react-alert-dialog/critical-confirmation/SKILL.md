...
title: "Critical Confirmation Dialog"
capability_id: "SK-063"
domain: "04-radix-ui"
...
Design, implement, review and troubleshoot **Critical Confirmation Dialog** using `@radix-ui/react-alert-dialog` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Critical Confirmation Dialog**.
...
1. Clarify the desired outcome for critical confirmation dialog and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides critical confirmation dialog, not only a wrapper or installed dependency.
