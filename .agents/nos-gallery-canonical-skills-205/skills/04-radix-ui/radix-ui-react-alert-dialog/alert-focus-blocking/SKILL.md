---
name: "alert-focus-blocking"
title: "Alert Focus and Interaction Blocking"
capability_id: "SK-064"
domain: "04-radix-ui"
...
# Alert Focus and Interaction Blocking

## Purpose

Design, implement, review and troubleshoot **Alert Focus and Interaction Blocking** using `@radix-ui/react-alert-dialog` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Alert Focus and Interaction Blocking**.
- A design or implementation decision depends on `@radix-ui/react-alert-dialog`.
...
- The task only asks whether `@radix-ui/react-alert-dialog` is installed.
...
1. Clarify the desired outcome for alert focus and interaction blocking and identify the user-visible or operational result.
2. Inspect the relevant `@radix-ui/react-alert-dialog` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides alert focus and interaction blocking, not only a wrapper or installed dependency.
