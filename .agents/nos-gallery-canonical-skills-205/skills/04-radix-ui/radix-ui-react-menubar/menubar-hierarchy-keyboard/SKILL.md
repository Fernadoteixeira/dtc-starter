---
name: "menubar-hierarchy-keyboard"
title: "Menubar Hierarchy and Keyboard"
capability_id: "SK-078"
domain: "04-radix-ui"
...
# Menubar Hierarchy and Keyboard

## Purpose

Design, implement, review and troubleshoot **Menubar Hierarchy and Keyboard** using `@radix-ui/react-menubar` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Menubar Hierarchy and Keyboard**.
- A design or implementation decision depends on `@radix-ui/react-menubar`.
...
- The task only asks whether `@radix-ui/react-menubar` is installed.
...
1. Clarify the desired outcome for menubar hierarchy and keyboard and identify the user-visible or operational result.
2. Inspect the relevant `@radix-ui/react-menubar` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides menubar hierarchy and keyboard, not only a wrapper or installed dependency.
