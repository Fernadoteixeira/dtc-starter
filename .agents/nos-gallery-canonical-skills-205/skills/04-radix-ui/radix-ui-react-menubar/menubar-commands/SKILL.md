---
name: "menubar-commands"
title: "Menubar Commands"
capability_id: "SK-077"
domain: "04-radix-ui"
...
Design, implement, review and troubleshoot **Menubar Commands** using `@radix-ui/react-menubar` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Menubar Commands**.
...
1. Clarify the desired outcome for menubar commands and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides menubar commands, not only a wrapper or installed dependency.
