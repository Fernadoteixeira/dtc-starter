---
name: "hover-preview"
title: "Hover and Focus Preview"
capability_id: "SK-075"
domain: "04-radix-ui"
...
Design, implement, review and troubleshoot **Hover and Focus Preview** using `@radix-ui/react-hover-card` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Hover and Focus Preview**.
- A design or implementation decision depends on `@radix-ui/react-hover-card`.
...
- The task only asks whether `@radix-ui/react-hover-card` is installed.
...
1. Clarify the desired outcome for hover and focus preview and identify the user-visible or operational result.
2. Inspect the relevant `@radix-ui/react-hover-card` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides hover and focus preview, not only a wrapper or installed dependency.
