---
name: "context-menu-keyboard-submenus"
title: "Context Menu Keyboard and Submenus"
capability_id: "SK-070"
domain: "04-radix-ui"
...
# Context Menu Keyboard and Submenus

## Purpose

Design, implement, review and troubleshoot **Context Menu Keyboard and Submenus** using `@radix-ui/react-context-menu` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Context Menu Keyboard and Submenus**.
- A design or implementation decision depends on `@radix-ui/react-context-menu`.
...
- The task only asks whether `@radix-ui/react-context-menu` is installed.
...
1. Clarify the desired outcome for context menu keyboard and submenus and identify the user-visible or operational result.
2. Inspect the relevant `@radix-ui/react-context-menu` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides context menu keyboard and submenus, not only a wrapper or installed dependency.
