...
Design, implement, review and troubleshoot **Context Menu Actions** using `@radix-ui/react-context-menu` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Context Menu Actions**.
...
1. Clarify the desired outcome for context menu actions and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides context menu actions, not only a wrapper or installed dependency.
