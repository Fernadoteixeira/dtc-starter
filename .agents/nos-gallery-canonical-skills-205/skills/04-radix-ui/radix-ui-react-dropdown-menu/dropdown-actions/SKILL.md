...
Design, implement, review and troubleshoot **Dropdown Menu Actions** using `@radix-ui/react-dropdown-menu` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Dropdown Menu Actions**.
...
1. Clarify the desired outcome for dropdown menu actions and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides dropdown menu actions, not only a wrapper or installed dependency.
