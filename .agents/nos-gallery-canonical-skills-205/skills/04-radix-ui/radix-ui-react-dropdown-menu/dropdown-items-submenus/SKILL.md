---
name: "dropdown-items-submenus"
title: "Dropdown Items and Submenus"
capability_id: "SK-074"
domain: "04-radix-ui"
...
# Dropdown Items and Submenus

## Purpose

Design, implement, review and troubleshoot **Dropdown Items and Submenus** using `@radix-ui/react-dropdown-menu` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Dropdown Items and Submenus**.
- A design or implementation decision depends on `@radix-ui/react-dropdown-menu`.
...
- The task only asks whether `@radix-ui/react-dropdown-menu` is installed.
...
1. Clarify the desired outcome for dropdown items and submenus and identify the user-visible or operational result.
2. Inspect the relevant `@radix-ui/react-dropdown-menu` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides dropdown items and submenus, not only a wrapper or installed dependency.
