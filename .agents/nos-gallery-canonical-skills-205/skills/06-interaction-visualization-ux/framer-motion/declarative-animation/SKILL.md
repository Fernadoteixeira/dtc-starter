---
name: "declarative-animation"
title: "Declarative Animation"
capability_id: "SK-123"
...
Design, implement, review and troubleshoot **Declarative Animation** using `framer-motion` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Declarative Animation**.
...
1. Clarify the desired outcome for declarative animation and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides declarative animation, not only a wrapper or installed dependency.
