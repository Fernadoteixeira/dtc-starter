...
Design, implement, review and troubleshoot **Motion Variants** using `framer-motion` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Motion Variants**.
...
1. Clarify the desired outcome for motion variants and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides motion variants, not only a wrapper or installed dependency.
