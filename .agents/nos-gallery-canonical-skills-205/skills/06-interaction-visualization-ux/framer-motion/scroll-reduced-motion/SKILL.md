---
name: "scroll-reduced-motion"
title: "Scroll Animation and Reduced Motion"
capability_id: "SK-129"
domain: "06-interaction-visualization-ux"
package: "framer-motion"
package_version: "12.42.2"
...
# Scroll Animation and Reduced Motion

## Purpose

Design, implement, review and troubleshoot **Scroll Animation and Reduced Motion** using `framer-motion` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Scroll Animation and Reduced Motion**.
- A design or implementation decision depends on `framer-motion`.
...
- The task only asks whether `framer-motion` is installed.
...
1. Clarify the desired outcome for scroll animation and reduced motion and identify the user-visible or operational result.
2. Inspect the relevant `framer-motion` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides scroll animation and reduced motion, not only a wrapper or installed dependency.
