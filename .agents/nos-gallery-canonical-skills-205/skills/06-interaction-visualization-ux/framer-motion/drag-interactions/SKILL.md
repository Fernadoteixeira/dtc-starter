---
name: "drag-interactions"
title: "Drag Interactions"
capability_id: "SK-126"
...
Design, implement, review and troubleshoot **Drag Interactions** using `framer-motion` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Drag Interactions**.
...
1. Clarify the desired outcome for drag interactions and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides drag interactions, not only a wrapper or installed dependency.
