...
Design, implement, review and troubleshoot **Layout Animation** using `framer-motion` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Layout Animation**.
...
1. Clarify the desired outcome for layout animation and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides layout animation, not only a wrapper or installed dependency.
