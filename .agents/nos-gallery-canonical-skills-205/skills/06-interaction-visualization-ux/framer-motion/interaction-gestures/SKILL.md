...
title: "Interaction Gestures"
capability_id: "SK-125"
...
Design, implement, review and troubleshoot **Interaction Gestures** using `framer-motion` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Interaction Gestures**.
...
1. Clarify the desired outcome for interaction gestures and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides interaction gestures, not only a wrapper or installed dependency.
