---
name: "presence-transitions"
title: "Presence Transitions"
capability_id: "SK-128"
...
Design, implement, review and troubleshoot **Presence Transitions** using `framer-motion` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Presence Transitions**.
...
1. Clarify the desired outcome for presence transitions and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides presence transitions, not only a wrapper or installed dependency.
