...
Design, implement, review and troubleshoot **Transient Feedback** using `sonner` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Transient Feedback**.
...
1. Clarify the desired outcome for transient feedback and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides transient feedback, not only a wrapper or installed dependency.
