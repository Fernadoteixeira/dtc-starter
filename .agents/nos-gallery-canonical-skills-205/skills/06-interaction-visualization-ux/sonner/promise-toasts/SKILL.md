---
name: "promise-toasts"
title: "Promise-driven Toasts"
capability_id: "SK-153"
...
Design, implement, review and troubleshoot **Promise-driven Toasts** using `sonner` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Promise-driven Toasts**.
...
1. Clarify the desired outcome for promise-driven toasts and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides promise-driven toasts, not only a wrapper or installed dependency.
