...
Design, implement, review and troubleshoot **Chart Accessibility** using `recharts` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Chart Accessibility**.
...
1. Clarify the desired outcome for chart accessibility and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides chart accessibility, not only a wrapper or installed dependency.
