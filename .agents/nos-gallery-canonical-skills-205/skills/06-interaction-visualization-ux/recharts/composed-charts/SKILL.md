...
Design, implement, review and troubleshoot **Composed Charts** using `recharts` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Composed Charts**.
...
1. Clarify the desired outcome for composed charts and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides composed charts, not only a wrapper or installed dependency.
