...
Design, implement, review and troubleshoot **Responsive Charts** using `recharts` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Responsive Charts**.
...
1. Clarify the desired outcome for responsive charts and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides responsive charts, not only a wrapper or installed dependency.
