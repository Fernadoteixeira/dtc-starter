---
name: "chart-tooltip-legend"
title: "Chart Tooltip and Legend"
capability_id: "SK-149"
...
Design, implement, review and troubleshoot **Chart Tooltip and Legend** using `recharts` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Chart Tooltip and Legend**.
...
1. Clarify the desired outcome for chart tooltip and legend and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides chart tooltip and legend, not only a wrapper or installed dependency.
