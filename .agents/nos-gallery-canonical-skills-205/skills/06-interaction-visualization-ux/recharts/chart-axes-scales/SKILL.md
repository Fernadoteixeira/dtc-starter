---
name: "chart-axes-scales"
title: "Chart Axes and Scales"
capability_id: "SK-147"
...
Design, implement, review and troubleshoot **Chart Axes and Scales** using `recharts` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Chart Axes and Scales**.
...
1. Clarify the desired outcome for chart axes and scales and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides chart axes and scales, not only a wrapper or installed dependency.
