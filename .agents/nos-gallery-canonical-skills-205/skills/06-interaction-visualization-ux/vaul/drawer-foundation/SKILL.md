---
name: "drawer-foundation"
title: "Drawer Foundation"
capability_id: "SK-139"
...
Design, implement, review and troubleshoot **Drawer Foundation** using `vaul` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Drawer Foundation**.
- A design or implementation decision depends on `vaul`.
...
- The task only asks whether `vaul` is installed.
...
1. Clarify the desired outcome for drawer foundation and identify the user-visible or operational result.
2. Inspect the relevant `vaul` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides drawer foundation, not only a wrapper or installed dependency.
