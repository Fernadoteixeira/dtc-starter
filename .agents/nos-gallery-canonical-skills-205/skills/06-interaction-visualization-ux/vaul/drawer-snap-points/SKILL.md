...
Design, implement, review and troubleshoot **Drawer Snap Points** using `vaul` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Drawer Snap Points**.
...
1. Clarify the desired outcome for drawer snap points and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides drawer snap points, not only a wrapper or installed dependency.
