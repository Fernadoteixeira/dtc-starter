---
name: "drawer-gestures"
title: "Drawer Gestures"
capability_id: "SK-140"
...
Design, implement, review and troubleshoot **Drawer Gestures** using `vaul` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Drawer Gestures**.
...
1. Clarify the desired outcome for drawer gestures and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides drawer gestures, not only a wrapper or installed dependency.
