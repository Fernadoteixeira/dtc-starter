...
Design, implement, review and troubleshoot **Nested Drawers** using `vaul` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Nested Drawers**.
...
1. Clarify the desired outcome for nested drawers and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides nested drawers, not only a wrapper or installed dependency.
