...
Design, implement, review and troubleshoot **Panel Layout Persistence** using `react-resizable-panels` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Panel Layout Persistence**.
...
1. Clarify the desired outcome for panel layout persistence and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides panel layout persistence, not only a wrapper or installed dependency.
