---
name: "panel-resize-collapse"
title: "Panel Resize and Collapse"
capability_id: "SK-144"
...
Design, implement, review and troubleshoot **Panel Resize and Collapse** using `react-resizable-panels` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Panel Resize and Collapse**.
- A design or implementation decision depends on `react-resizable-panels`.
...
- The task only asks whether `react-resizable-panels` is installed.
...
1. Clarify the desired outcome for panel resize and collapse and identify the user-visible or operational result.
2. Inspect the relevant `react-resizable-panels` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides panel resize and collapse, not only a wrapper or installed dependency.
