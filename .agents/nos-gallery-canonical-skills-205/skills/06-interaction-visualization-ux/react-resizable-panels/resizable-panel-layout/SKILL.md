...
title: "Resizable Panel Layout"
capability_id: "SK-143"
...
Design, implement, review and troubleshoot **Resizable Panel Layout** using `react-resizable-panels` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Resizable Panel Layout**.
...
1. Clarify the desired outcome for resizable panel layout and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides resizable panel layout, not only a wrapper or installed dependency.
