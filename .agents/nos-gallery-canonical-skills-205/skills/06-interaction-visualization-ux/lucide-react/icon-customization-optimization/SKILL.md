---
name: "icon-customization-optimization"
title: "Icon Customization and Optimization"
capability_id: "SK-156"
domain: "06-interaction-visualization-ux"
package: "lucide-react"
package_version: "^0.454.0"
...
Design, implement, review and troubleshoot **Icon Customization and Optimization** using `lucide-react` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Icon Customization and Optimization**.
- A design or implementation decision depends on `lucide-react`.
...
- The task only asks whether `lucide-react` is installed.
...
1. Clarify the desired outcome for icon customization and optimization and identify the user-visible or operational result.
2. Inspect the relevant `lucide-react` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides icon customization and optimization, not only a wrapper or installed dependency.
