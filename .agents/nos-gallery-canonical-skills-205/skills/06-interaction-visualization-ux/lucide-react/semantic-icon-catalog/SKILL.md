---
name: "semantic-icon-catalog"
title: "Semantic Icon Catalog"
capability_id: "SK-155"
...
Design, implement, review and troubleshoot **Semantic Icon Catalog** using `lucide-react` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Semantic Icon Catalog**.
...
1. Clarify the desired outcome for semantic icon catalog and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides semantic icon catalog, not only a wrapper or installed dependency.
