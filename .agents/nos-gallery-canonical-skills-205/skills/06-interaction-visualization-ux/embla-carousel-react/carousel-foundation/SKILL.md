---
name: "carousel-foundation"
title: "Carousel Foundation"
capability_id: "SK-130"
...
Design, implement, review and troubleshoot **Carousel Foundation** using `embla-carousel-react` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Carousel Foundation**.
...
1. Clarify the desired outcome for carousel foundation and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides carousel foundation, not only a wrapper or installed dependency.
