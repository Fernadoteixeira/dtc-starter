---
name: "carousel-gestures"
title: "Carousel Gestures"
capability_id: "SK-132"
...
Design, implement, review and troubleshoot **Carousel Gestures** using `embla-carousel-react` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Carousel Gestures**.
...
1. Clarify the desired outcome for carousel gestures and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides carousel gestures, not only a wrapper or installed dependency.
