---
name: "carousel-controls-plugins"
title: "Carousel Controls and Plugins"
capability_id: "SK-134"
...
# Carousel Controls and Plugins

## Purpose

Design, implement, review and troubleshoot **Carousel Controls and Plugins** using `embla-carousel-react` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Carousel Controls and Plugins**.
- A design or implementation decision depends on `embla-carousel-react`.
...
- The task only asks whether `embla-carousel-react` is installed.
...
1. Clarify the desired outcome for carousel controls and plugins and identify the user-visible or operational result.
2. Inspect the relevant `embla-carousel-react` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides carousel controls and plugins, not only a wrapper or installed dependency.
