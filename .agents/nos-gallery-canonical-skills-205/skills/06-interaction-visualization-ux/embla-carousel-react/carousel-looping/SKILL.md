...
title: "Carousel Looping"
capability_id: "SK-133"
...
Design, implement, review and troubleshoot **Carousel Looping** using `embla-carousel-react` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Carousel Looping**.
...
1. Clarify the desired outcome for carousel looping and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides carousel looping, not only a wrapper or installed dependency.
