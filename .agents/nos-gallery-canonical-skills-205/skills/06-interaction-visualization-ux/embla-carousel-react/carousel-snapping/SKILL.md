---
name: "carousel-snapping"
title: "Carousel Snapping"
capability_id: "SK-131"
...
Design, implement, review and troubleshoot **Carousel Snapping** using `embla-carousel-react` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Carousel Snapping**.
...
1. Clarify the desired outcome for carousel snapping and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides carousel snapping, not only a wrapper or installed dependency.
