---
name: "command-groups-actions"
title: "Command Groups and Actions"
capability_id: "SK-138"
...
Design, implement, review and troubleshoot **Command Groups and Actions** using `cmdk` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Command Groups and Actions**.
...
1. Clarify the desired outcome for command groups and actions and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides command groups and actions, not only a wrapper or installed dependency.
