...
Design, implement, review and troubleshoot **Command Search** using `cmdk` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Command Search**.
...
1. Clarify the desired outcome for command search and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides command search, not only a wrapper or installed dependency.
