...
Design, implement, review and troubleshoot **Command Palette** using `cmdk` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Command Palette**.
...
1. Clarify the desired outcome for command palette and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides command palette, not only a wrapper or installed dependency.
