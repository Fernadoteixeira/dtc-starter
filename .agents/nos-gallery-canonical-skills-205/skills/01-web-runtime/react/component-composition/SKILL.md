...
Design, implement, review and troubleshoot **Component Composition** using `react` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Component Composition**.
...
1. Clarify the desired outcome for component composition and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides component composition, not only a wrapper or installed dependency.
