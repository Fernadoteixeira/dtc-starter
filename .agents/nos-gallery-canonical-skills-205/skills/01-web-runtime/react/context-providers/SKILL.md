...
Design, implement, review and troubleshoot **Context and Providers** using `react` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Context and Providers**.
...
1. Clarify the desired outcome for context and providers and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides context and providers, not only a wrapper or installed dependency.
