...
Design, implement, review and troubleshoot **Error Boundaries and Recovery** using `react` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Error Boundaries and Recovery**.
...
1. Clarify the desired outcome for error boundaries and recovery and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides error boundaries and recovery, not only a wrapper or installed dependency.
