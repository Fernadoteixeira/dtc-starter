...
Design, implement, review and troubleshoot **Suspense and Transitions** using `react` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Suspense and Transitions**.
...
1. Clarify the desired outcome for suspense and transitions and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides suspense and transitions, not only a wrapper or installed dependency.
