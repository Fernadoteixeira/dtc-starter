...
Design, implement, review and troubleshoot **State and Hooks** using `react` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **State and Hooks**.
...
1. Clarify the desired outcome for state and hooks and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides state and hooks, not only a wrapper or installed dependency.
