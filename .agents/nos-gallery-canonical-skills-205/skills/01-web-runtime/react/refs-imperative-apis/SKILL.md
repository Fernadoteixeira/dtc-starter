---
name: "refs-imperative-apis"
title: "Refs and Imperative APIs"
capability_id: "SK-016"
...
Design, implement, review and troubleshoot **Refs and Imperative APIs** using `react` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Refs and Imperative APIs**.
...
1. Clarify the desired outcome for refs and imperative apis and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides refs and imperative apis, not only a wrapper or installed dependency.
