...
Design, implement, review and troubleshoot **Metadata and SEO** using `next` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Metadata and SEO**.
...
1. Clarify the desired outcome for metadata and seo and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides metadata and seo, not only a wrapper or installed dependency.
