...
Design, implement, review and troubleshoot **Route Handlers** using `next` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Route Handlers**.
...
1. Clarify the desired outcome for route handlers and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides route handlers, not only a wrapper or installed dependency.
