...
Design, implement, review and troubleshoot **Rendering Strategy** using `next` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Rendering Strategy**.
...
1. Clarify the desired outcome for rendering strategy and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides rendering strategy, not only a wrapper or installed dependency.
