...
Design, implement, review and troubleshoot **Asset Optimization** using `next` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Asset Optimization**.
...
1. Clarify the desired outcome for asset optimization and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides asset optimization, not only a wrapper or installed dependency.
