...
Design, implement, review and troubleshoot **Server Actions** using `next` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Server Actions**.
...
1. Clarify the desired outcome for server actions and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides server actions, not only a wrapper or installed dependency.
