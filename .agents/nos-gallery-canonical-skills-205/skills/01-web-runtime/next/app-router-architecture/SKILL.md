...
Design, implement, review and troubleshoot **App Router Architecture** using `next` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **App Router Architecture**.
...
1. Clarify the desired outcome for app router architecture and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides app router architecture, not only a wrapper or installed dependency.
