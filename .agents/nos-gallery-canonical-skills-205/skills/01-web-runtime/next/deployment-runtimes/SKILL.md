---
name: "deployment-runtimes"
title: "Deployment and Runtime Selection"
capability_id: "SK-010"
...
Design, implement, review and troubleshoot **Deployment and Runtime Selection** using `next` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Deployment and Runtime Selection**.
...
1. Clarify the desired outcome for deployment and runtime selection and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides deployment and runtime selection, not only a wrapper or installed dependency.
