...
Design, implement, review and troubleshoot **Server and Client Boundaries** using `next` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Server and Client Boundaries**.
...
1. Clarify the desired outcome for server and client boundaries and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides server and client boundaries, not only a wrapper or installed dependency.
