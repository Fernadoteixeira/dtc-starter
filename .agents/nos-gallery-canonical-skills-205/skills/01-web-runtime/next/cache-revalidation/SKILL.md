...
Design, implement, review and troubleshoot **Cache and Revalidation** using `next` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Cache and Revalidation**.
...
1. Clarify the desired outcome for cache and revalidation and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides cache and revalidation, not only a wrapper or installed dependency.
