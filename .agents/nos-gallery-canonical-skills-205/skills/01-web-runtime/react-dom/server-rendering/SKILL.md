...
title: "React DOM Server Rendering"
capability_id: "SK-020"
...
Design, implement, review and troubleshoot **React DOM Server Rendering** using `react-dom` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **React DOM Server Rendering**.
...
1. Clarify the desired outcome for react dom server rendering and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides react dom server rendering, not only a wrapper or installed dependency.
