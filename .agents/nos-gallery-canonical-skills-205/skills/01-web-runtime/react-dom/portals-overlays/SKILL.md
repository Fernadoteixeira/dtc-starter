---
name: "portals-overlays"
title: "Portals and Overlay Mounting"
capability_id: "SK-019"
...
# Portals and Overlay Mounting

## Purpose

Design, implement, review and troubleshoot **Portals and Overlay Mounting** using `react-dom` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Portals and Overlay Mounting**.
- A design or implementation decision depends on `react-dom`.
...
- The task only asks whether `react-dom` is installed.
...
1. Clarify the desired outcome for portals and overlay mounting and identify the user-visible or operational result.
2. Inspect the relevant `react-dom` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides portals and overlay mounting, not only a wrapper or installed dependency.
