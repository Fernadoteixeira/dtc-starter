---
name: "root-hydration"
title: "Root Creation and Hydration"
capability_id: "SK-018"
...
# Root Creation and Hydration

## Purpose

Design, implement, review and troubleshoot **Root Creation and Hydration** using `react-dom` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Root Creation and Hydration**.
...
1. Clarify the desired outcome for root creation and hydration and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides root creation and hydration, not only a wrapper or installed dependency.
