---
name: "otp-paste-completion"
title: "OTP Paste and Completion"
capability_id: "SK-031"
...
# OTP Paste and Completion

## Purpose

Design, implement, review and troubleshoot **OTP Paste and Completion** using `input-otp` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **OTP Paste and Completion**.
- A design or implementation decision depends on `input-otp`.
...
- The task only asks whether `input-otp` is installed.
...
1. Clarify the desired outcome for otp paste and completion and identify the user-visible or operational result.
2. Inspect the relevant `input-otp` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides otp paste and completion, not only a wrapper or installed dependency.
