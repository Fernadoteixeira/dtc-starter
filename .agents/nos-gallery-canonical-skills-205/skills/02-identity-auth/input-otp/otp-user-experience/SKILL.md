---
name: "otp-user-experience"
title: "OTP User Experience"
capability_id: "SK-030"
...
Design, implement, review and troubleshoot **OTP User Experience** using `input-otp` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **OTP User Experience**.
...
1. Clarify the desired outcome for otp user experience and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides otp user experience, not only a wrapper or installed dependency.
