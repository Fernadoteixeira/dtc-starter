---
name: "otp-form-integration"
title: "OTP Form Integration"
capability_id: "SK-032"
...
Design, implement, review and troubleshoot **OTP Form Integration** using `input-otp` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **OTP Form Integration**.
...
1. Clarify the desired outcome for otp form integration and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides otp form integration, not only a wrapper or installed dependency.
