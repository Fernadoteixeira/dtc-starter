...
Design, implement, review and troubleshoot **Organization Management** using `@clerk/nextjs` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Organization Management**.
...
1. Clarify the desired outcome for organization management and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides organization management, not only a wrapper or installed dependency.
