---
name: "mfa-security"
title: "MFA and Authentication Security"
capability_id: "SK-029"
...
Design, implement, review and troubleshoot **MFA and Authentication Security** using `@clerk/nextjs` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **MFA and Authentication Security**.
...
1. Clarify the desired outcome for mfa and authentication security and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides mfa and authentication security, not only a wrapper or installed dependency.
