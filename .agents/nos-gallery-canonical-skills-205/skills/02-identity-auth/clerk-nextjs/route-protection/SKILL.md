...
title: "Route and Operation Protection"
capability_id: "SK-025"
...
Design, implement, review and troubleshoot **Route and Operation Protection** using `@clerk/nextjs` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Route and Operation Protection**.
...
1. Clarify the desired outcome for route and operation protection and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides route and operation protection, not only a wrapper or installed dependency.
