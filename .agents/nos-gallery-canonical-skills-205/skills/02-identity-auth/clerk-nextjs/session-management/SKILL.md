...
Design, implement, review and troubleshoot **Session Management** using `@clerk/nextjs` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Session Management**.
...
1. Clarify the desired outcome for session management and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides session management, not only a wrapper or installed dependency.
