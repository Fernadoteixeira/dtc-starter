...
Design, implement, review and troubleshoot **User Profile Management** using `@clerk/nextjs` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **User Profile Management**.
...
1. Clarify the desired outcome for user profile management and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides user profile management, not only a wrapper or installed dependency.
