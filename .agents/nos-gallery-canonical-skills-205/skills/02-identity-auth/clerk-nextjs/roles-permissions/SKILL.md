...
Design, implement, review and troubleshoot **Roles and Permissions** using `@clerk/nextjs` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Roles and Permissions**.
...
1. Clarify the desired outcome for roles and permissions and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides roles and permissions, not only a wrapper or installed dependency.
