...
Design, implement, review and troubleshoot **Sign-up and Sign-in** using `@clerk/nextjs` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Sign-up and Sign-in**.
...
1. Clarify the desired outcome for sign-up and sign-in and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides sign-up and sign-in, not only a wrapper or installed dependency.
