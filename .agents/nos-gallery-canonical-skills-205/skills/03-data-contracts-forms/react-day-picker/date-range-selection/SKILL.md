...
Design, implement, review and troubleshoot **Date-range Selection** using `react-day-picker` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Date-range Selection**.
...
1. Clarify the desired outcome for date-range selection and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides date-range selection, not only a wrapper or installed dependency.
