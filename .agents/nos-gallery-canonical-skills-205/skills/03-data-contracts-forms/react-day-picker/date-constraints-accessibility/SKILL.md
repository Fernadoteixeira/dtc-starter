---
name: "date-constraints-accessibility"
title: "Date Constraints and Accessibility"
capability_id: "SK-061"
...
# Date Constraints and Accessibility

## Purpose

Design, implement, review and troubleshoot **Date Constraints and Accessibility** using `react-day-picker` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Date Constraints and Accessibility**.
- A design or implementation decision depends on `react-day-picker`.
...
- The task only asks whether `react-day-picker` is installed.
...
1. Clarify the desired outcome for date constraints and accessibility and identify the user-visible or operational result.
2. Inspect the relevant `react-day-picker` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides date constraints and accessibility, not only a wrapper or installed dependency.
