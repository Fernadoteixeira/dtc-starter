...
Design, implement, review and troubleshoot **Single-date Selection** using `react-day-picker` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Single-date Selection**.
...
1. Clarify the desired outcome for single-date selection and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides single-date selection, not only a wrapper or installed dependency.
