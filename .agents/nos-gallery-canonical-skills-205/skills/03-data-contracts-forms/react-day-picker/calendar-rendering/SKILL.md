...
Design, implement, review and troubleshoot **Calendar Rendering** using `react-day-picker` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Calendar Rendering**.
...
1. Clarify the desired outcome for calendar rendering and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides calendar rendering, not only a wrapper or installed dependency.
