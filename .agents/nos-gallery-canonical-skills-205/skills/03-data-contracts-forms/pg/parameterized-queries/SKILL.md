...
Design, implement, review and troubleshoot **Parameterized Queries** using `pg` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Parameterized Queries**.
...
1. Clarify the desired outcome for parameterized queries and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides parameterized queries, not only a wrapper or installed dependency.
