---
name: "type-mapping-results"
title: "Type Mapping and Query Results"
capability_id: "SK-036"
...
# Type Mapping and Query Results

## Purpose

Design, implement, review and troubleshoot **Type Mapping and Query Results** using `pg` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Type Mapping and Query Results**.
...
1. Clarify the desired outcome for type mapping and query results and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides type mapping and query results, not only a wrapper or installed dependency.
