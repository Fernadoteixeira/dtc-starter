...
Design, implement, review and troubleshoot **PostgreSQL Connection Pooling** using `pg` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **PostgreSQL Connection Pooling**.
...
1. Clarify the desired outcome for postgresql connection pooling and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides postgresql connection pooling, not only a wrapper or installed dependency.
