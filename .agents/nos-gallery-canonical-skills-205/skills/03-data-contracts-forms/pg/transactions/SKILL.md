...
Design, implement, review and troubleshoot **Database Transactions** using `pg` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Database Transactions**.
...
1. Clarify the desired outcome for database transactions and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides database transactions, not only a wrapper or installed dependency.
