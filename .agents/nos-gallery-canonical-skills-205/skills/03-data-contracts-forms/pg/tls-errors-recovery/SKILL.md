---
name: "tls-errors-recovery"
title: "Database TLS, Errors and Recovery"
capability_id: "SK-037"
domain: "03-data-contracts-forms"
package: "pg"
package_version: "^8.22.0"
...
# Database TLS, Errors and Recovery

## Purpose

Design, implement, review and troubleshoot **Database TLS, Errors and Recovery** using `pg` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Database TLS, Errors and Recovery**.
- A design or implementation decision depends on `pg`.
...
- The task only asks whether `pg` is installed.
...
1. Clarify the desired outcome for database tls, errors and recovery and identify the user-visible or operational result.
2. Inspect the relevant `pg` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides database tls, errors and recovery, not only a wrapper or installed dependency.
