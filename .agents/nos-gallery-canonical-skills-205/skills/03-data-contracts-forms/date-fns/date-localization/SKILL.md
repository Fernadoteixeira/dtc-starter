...
Design, implement, review and troubleshoot **Date Localization** using `date-fns` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Date Localization**.
...
1. Clarify the desired outcome for date localization and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides date localization, not only a wrapper or installed dependency.
