...
Design, implement, review and troubleshoot **Date Arithmetic** using `date-fns` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Date Arithmetic**.
...
1. Clarify the desired outcome for date arithmetic and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides date arithmetic, not only a wrapper or installed dependency.
