...
Design, implement, review and troubleshoot **Date Comparison** using `date-fns` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Date Comparison**.
...
1. Clarify the desired outcome for date comparison and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides date comparison, not only a wrapper or installed dependency.
