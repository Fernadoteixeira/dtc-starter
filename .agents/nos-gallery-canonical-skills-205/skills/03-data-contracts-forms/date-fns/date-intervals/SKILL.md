...
Design, implement, review and troubleshoot **Date Intervals** using `date-fns` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Date Intervals**.
...
1. Clarify the desired outcome for date intervals and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides date intervals, not only a wrapper or installed dependency.
