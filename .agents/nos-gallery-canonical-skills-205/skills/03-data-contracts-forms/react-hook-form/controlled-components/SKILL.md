...
title: "Controlled Component Integration"
capability_id: "SK-046"
...
Design, implement, review and troubleshoot **Controlled Component Integration** using `react-hook-form` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Controlled Component Integration**.
...
1. Clarify the desired outcome for controlled component integration and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides controlled component integration, not only a wrapper or installed dependency.
