---
name: "dynamic-field-arrays"
title: "Dynamic Field Arrays"
capability_id: "SK-047"
...
Design, implement, review and troubleshoot **Dynamic Field Arrays** using `react-hook-form` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Dynamic Field Arrays**.
...
1. Clarify the desired outcome for dynamic field arrays and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides dynamic field arrays, not only a wrapper or installed dependency.
