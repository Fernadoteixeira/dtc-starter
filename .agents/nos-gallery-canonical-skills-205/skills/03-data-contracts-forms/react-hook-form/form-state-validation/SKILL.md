...
Design, implement, review and troubleshoot **Form State and Validation** using `react-hook-form` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Form State and Validation**.
...
1. Clarify the desired outcome for form state and validation and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides form state and validation, not only a wrapper or installed dependency.
