...
title: "Form Render Performance"
capability_id: "SK-049"
...
Design, implement, review and troubleshoot **Form Render Performance** using `react-hook-form` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Form Render Performance**.
...
1. Clarify the desired outcome for form render performance and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides form render performance, not only a wrapper or installed dependency.
