...
Design, implement, review and troubleshoot **Field Registration** using `react-hook-form` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Field Registration**.
...
1. Clarify the desired outcome for field registration and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides field registration, not only a wrapper or installed dependency.
