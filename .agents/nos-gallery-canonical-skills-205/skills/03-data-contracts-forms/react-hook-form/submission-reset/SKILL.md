---
name: "submission-reset"
title: "Submission and Reset Flows"
capability_id: "SK-048"
domain: "03-data-contracts-forms"
package: "react-hook-form"
package_version: "^7.60.0"
...
# Submission and Reset Flows

## Purpose

Design, implement, review and troubleshoot **Submission and Reset Flows** using `react-hook-form` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Submission and Reset Flows**.
- A design or implementation decision depends on `react-hook-form`.
...
- The task only asks whether `react-hook-form` is installed.
...
1. Clarify the desired outcome for submission and reset flows and identify the user-visible or operational result.
2. Inspect the relevant `react-hook-form` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides submission and reset flows, not only a wrapper or installed dependency.
