...
title: "Shared Runtime and Type Contracts"
capability_id: "SK-043"
...
# Shared Runtime and Type Contracts

## Purpose

Design, implement, review and troubleshoot **Shared Runtime and Type Contracts** using `zod` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Shared Runtime and Type Contracts**.
...
1. Clarify the desired outcome for shared runtime and type contracts and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides shared runtime and type contracts, not only a wrapper or installed dependency.
