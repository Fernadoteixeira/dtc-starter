...
Design, implement, review and troubleshoot **Schema Modeling** using `zod` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Schema Modeling**.
...
1. Clarify the desired outcome for schema modeling and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides schema modeling, not only a wrapper or installed dependency.
