---
name: "refinements"
title: "Refinements and Cross-field Rules"
capability_id: "SK-040"
...
Design, implement, review and troubleshoot **Refinements and Cross-field Rules** using `zod` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Refinements and Cross-field Rules**.
...
1. Clarify the desired outcome for refinements and cross-field rules and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides refinements and cross-field rules, not only a wrapper or installed dependency.
