---
name: "error-modeling"
title: "Validation Error Modeling"
capability_id: "SK-042"
...
Design, implement, review and troubleshoot **Validation Error Modeling** using `zod` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Validation Error Modeling**.
...
1. Clarify the desired outcome for validation error modeling and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides validation error modeling, not only a wrapper or installed dependency.
