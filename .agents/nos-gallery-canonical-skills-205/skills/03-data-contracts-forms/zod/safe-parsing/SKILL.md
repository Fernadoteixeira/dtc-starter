...
Design, implement, review and troubleshoot **Safe Parsing** using `zod` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Safe Parsing**.
...
1. Clarify the desired outcome for safe parsing and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides safe parsing, not only a wrapper or installed dependency.
