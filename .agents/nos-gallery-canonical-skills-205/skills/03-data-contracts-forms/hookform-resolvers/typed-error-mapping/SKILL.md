---
name: "typed-error-mapping"
title: "Typed Error Mapping"
capability_id: "SK-051"
...
Design, implement, review and troubleshoot **Typed Error Mapping** using `@hookform/resolvers` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Typed Error Mapping**.
...
1. Clarify the desired outcome for typed error mapping and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides typed error mapping, not only a wrapper or installed dependency.
