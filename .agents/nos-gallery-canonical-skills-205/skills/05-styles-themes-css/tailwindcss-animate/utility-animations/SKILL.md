---
name: "utility-animations"
title: "Utility Animations"
capability_id: "SK-119"
...
Design, implement, review and troubleshoot **Utility Animations** using `tailwindcss-animate` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Utility Animations**.
...
1. Clarify the desired outcome for utility animations and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides utility animations, not only a wrapper or installed dependency.
