...
Design, implement, review and troubleshoot **Theme Architecture** using `tailwindcss` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Theme Architecture**.
...
1. Clarify the desired outcome for theme architecture and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides theme architecture, not only a wrapper or installed dependency.
