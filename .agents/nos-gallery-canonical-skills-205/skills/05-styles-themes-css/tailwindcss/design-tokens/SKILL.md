...
Design, implement, review and troubleshoot **Design Tokens** using `tailwindcss` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Design Tokens**.
...
1. Clarify the desired outcome for design tokens and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides design tokens, not only a wrapper or installed dependency.
