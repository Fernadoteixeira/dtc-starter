---
name: "utility-styling"
title: "Utility-first Styling"
capability_id: "SK-100"
...
Design, implement, review and troubleshoot **Utility-first Styling** using `tailwindcss` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Utility-first Styling**.
...
1. Clarify the desired outcome for utility-first styling and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides utility-first styling, not only a wrapper or installed dependency.
