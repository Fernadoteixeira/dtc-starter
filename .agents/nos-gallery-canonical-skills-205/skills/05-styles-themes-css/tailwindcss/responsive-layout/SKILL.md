...
Design, implement, review and troubleshoot **Responsive Layout** using `tailwindcss` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Responsive Layout**.
...
1. Clarify the desired outcome for responsive layout and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides responsive layout, not only a wrapper or installed dependency.
