...
Design, implement, review and troubleshoot **Interaction States** using `tailwindcss` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Interaction States**.
...
1. Clarify the desired outcome for interaction states and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides interaction states, not only a wrapper or installed dependency.
