---
name: "css-generation-optimization"
title: "CSS Generation and Optimization"
capability_id: "SK-104"
...
Design, implement, review and troubleshoot **CSS Generation and Optimization** using `tailwindcss` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **CSS Generation and Optimization**.
- A design or implementation decision depends on `tailwindcss`.
...
- The task only asks whether `tailwindcss` is installed.
...
1. Clarify the desired outcome for css generation and optimization and identify the user-visible or operational result.
2. Inspect the relevant `tailwindcss` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides css generation and optimization, not only a wrapper or installed dependency.
