---
name: "tailwind-conflict-resolution"
title: "Tailwind Conflict Resolution"
capability_id: "SK-109"
...
Design, implement, review and troubleshoot **Tailwind Conflict Resolution** using `tailwind-merge` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Tailwind Conflict Resolution**.
- A design or implementation decision depends on `tailwind-merge`.
...
- The task only asks whether `tailwind-merge` is installed.
...
1. Clarify the desired outcome for tailwind conflict resolution and identify the user-visible or operational result.
2. Inspect the relevant `tailwind-merge` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides tailwind conflict resolution, not only a wrapper or installed dependency.
