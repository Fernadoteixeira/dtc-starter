---
name: "predictable-style-overrides"
title: "Predictable Style Overrides"
capability_id: "SK-110"
...
Design, implement, review and troubleshoot **Predictable Style Overrides** using `tailwind-merge` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Predictable Style Overrides**.
...
1. Clarify the desired outcome for predictable style overrides and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides predictable style overrides, not only a wrapper or installed dependency.
