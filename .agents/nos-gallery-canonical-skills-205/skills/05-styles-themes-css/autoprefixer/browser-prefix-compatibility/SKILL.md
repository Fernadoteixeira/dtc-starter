---
name: "browser-prefix-compatibility"
title: "Browser Prefix Compatibility"
capability_id: "SK-118"
domain: "05-styles-themes-css"
package: "autoprefixer"
package_version: "^10.4.20"
...
# Browser Prefix Compatibility

## Purpose

Design, implement, review and troubleshoot **Browser Prefix Compatibility** using `autoprefixer` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Browser Prefix Compatibility**.
- A design or implementation decision depends on `autoprefixer`.
...
- The task only asks whether `autoprefixer` is installed.
...
1. Clarify the desired outcome for browser prefix compatibility and identify the user-visible or operational result.
2. Inspect the relevant `autoprefixer` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides browser prefix compatibility, not only a wrapper or installed dependency.
