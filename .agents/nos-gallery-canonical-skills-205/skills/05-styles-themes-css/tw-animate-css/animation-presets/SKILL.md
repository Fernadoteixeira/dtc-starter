...
Design, implement, review and troubleshoot **Animation Presets** using `tw-animate-css` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Animation Presets**.
...
1. Clarify the desired outcome for animation presets and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides animation presets, not only a wrapper or installed dependency.
