...
title: "CSS Processing Pipeline"
capability_id: "SK-115"
...
Design, implement, review and troubleshoot **CSS Processing Pipeline** using `postcss` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **CSS Processing Pipeline**.
...
1. Clarify the desired outcome for css processing pipeline and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides css processing pipeline, not only a wrapper or installed dependency.
