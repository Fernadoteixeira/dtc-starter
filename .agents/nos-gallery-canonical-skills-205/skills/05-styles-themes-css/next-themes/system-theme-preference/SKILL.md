...
Design, implement, review and troubleshoot **System Theme Preference** using `next-themes` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **System Theme Preference**.
...
1. Clarify the desired outcome for system theme preference and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides system theme preference, not only a wrapper or installed dependency.
