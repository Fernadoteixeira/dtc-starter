...
Design, implement, review and troubleshoot **Theme Switching** using `next-themes` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Theme Switching**.
...
1. Clarify the desired outcome for theme switching and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides theme switching, not only a wrapper or installed dependency.
