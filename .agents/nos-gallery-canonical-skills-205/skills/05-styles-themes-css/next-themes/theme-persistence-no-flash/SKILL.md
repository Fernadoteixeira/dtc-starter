---
name: "theme-persistence-no-flash"
title: "Theme Persistence and Flash Prevention"
capability_id: "SK-113"
...
# Theme Persistence and Flash Prevention

## Purpose

Design, implement, review and troubleshoot **Theme Persistence and Flash Prevention** using `next-themes` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Theme Persistence and Flash Prevention**.
- A design or implementation decision depends on `next-themes`.
...
- The task only asks whether `next-themes` is installed.
...
1. Clarify the desired outcome for theme persistence and flash prevention and identify the user-visible or operational result.
2. Inspect the relevant `next-themes` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides theme persistence and flash prevention, not only a wrapper or installed dependency.
