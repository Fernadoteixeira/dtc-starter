---
name: "typed-variant-props"
title: "Typed Variant Props"
capability_id: "SK-107"
...
Design, implement, review and troubleshoot **Typed Variant Props** using `class-variance-authority` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Typed Variant Props**.
...
1. Clarify the desired outcome for typed variant props and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides typed variant props, not only a wrapper or installed dependency.
