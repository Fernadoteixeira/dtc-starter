...
Design, implement, review and troubleshoot **Component Variants** using `class-variance-authority` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Component Variants**.
...
1. Clarify the desired outcome for component variants and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides component variants, not only a wrapper or installed dependency.
