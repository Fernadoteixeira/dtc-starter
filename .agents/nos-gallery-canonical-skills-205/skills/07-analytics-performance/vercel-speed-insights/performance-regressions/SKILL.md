...
Design, implement, review and troubleshoot **Performance Regression Detection** using `@vercel/speed-insights` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Performance Regression Detection**.
...
1. Clarify the desired outcome for performance regression detection and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides performance regression detection, not only a wrapper or installed dependency.
