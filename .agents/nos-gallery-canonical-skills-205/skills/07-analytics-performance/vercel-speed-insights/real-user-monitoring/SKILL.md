...
Design, implement, review and troubleshoot **Real User Monitoring** using `@vercel/speed-insights` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Real User Monitoring**.
...
1. Clarify the desired outcome for real user monitoring and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides real user monitoring, not only a wrapper or installed dependency.
