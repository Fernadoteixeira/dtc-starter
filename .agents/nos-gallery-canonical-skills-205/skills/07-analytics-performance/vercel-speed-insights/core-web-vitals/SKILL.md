...
Design, implement, review and troubleshoot **Core Web Vitals** using `@vercel/speed-insights` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Core Web Vitals**.
...
1. Clarify the desired outcome for core web vitals and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides core web vitals, not only a wrapper or installed dependency.
