---
name: "custom-events"
title: "Custom Product Events"
capability_id: "SK-158"
...
Design, implement, review and troubleshoot **Custom Product Events** using `@vercel/analytics` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Custom Product Events**.
...
1. Clarify the desired outcome for custom product events and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides custom product events, not only a wrapper or installed dependency.
