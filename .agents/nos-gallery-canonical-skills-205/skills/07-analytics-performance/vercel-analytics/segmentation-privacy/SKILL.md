---
name: "segmentation-privacy"
title: "Segmentation and Privacy"
capability_id: "SK-160"
...
Design, implement, review and troubleshoot **Segmentation and Privacy** using `@vercel/analytics` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Segmentation and Privacy**.
- A design or implementation decision depends on `@vercel/analytics`.
...
- The task only asks whether `@vercel/analytics` is installed.
...
1. Clarify the desired outcome for segmentation and privacy and identify the user-visible or operational result.
2. Inspect the relevant `@vercel/analytics` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides segmentation and privacy, not only a wrapper or installed dependency.
