...
Design, implement, review and troubleshoot **Product Funnels** using `@vercel/analytics` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Product Funnels**.
...
1. Clarify the desired outcome for product funnels and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides product funnels, not only a wrapper or installed dependency.
