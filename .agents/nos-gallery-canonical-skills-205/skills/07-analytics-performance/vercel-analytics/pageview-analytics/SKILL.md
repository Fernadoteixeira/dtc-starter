---
name: "pageview-analytics"
title: "Page-view Analytics"
capability_id: "SK-157"
...
Design, implement, review and troubleshoot **Page-view Analytics** using `@vercel/analytics` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Page-view Analytics**.
...
1. Clarify the desired outcome for page-view analytics and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides page-view analytics, not only a wrapper or installed dependency.
