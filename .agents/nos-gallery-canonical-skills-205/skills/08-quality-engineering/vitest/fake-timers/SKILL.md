...
Design, implement, review and troubleshoot **Fake Timers** using `vitest` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Fake Timers**.
...
1. Clarify the desired outcome for fake timers and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides fake timers, not only a wrapper or installed dependency.
