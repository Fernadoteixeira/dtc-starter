...
Design, implement, review and troubleshoot **Vitest Browser Mode** using `vitest` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Vitest Browser Mode**.
...
1. Clarify the desired outcome for vitest browser mode and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides vitest browser mode, not only a wrapper or installed dependency.
