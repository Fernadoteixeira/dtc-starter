...
Design, implement, review and troubleshoot **Mocks and Spies** using `vitest` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Mocks and Spies**.
...
1. Clarify the desired outcome for mocks and spies and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides mocks and spies, not only a wrapper or installed dependency.
