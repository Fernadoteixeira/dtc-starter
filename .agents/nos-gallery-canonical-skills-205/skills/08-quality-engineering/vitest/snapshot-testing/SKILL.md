...
Design, implement, review and troubleshoot **Snapshot Testing** using `vitest` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Snapshot Testing**.
...
1. Clarify the desired outcome for snapshot testing and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides snapshot testing, not only a wrapper or installed dependency.
