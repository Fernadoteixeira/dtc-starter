...
Design, implement, review and troubleshoot **Vitest Projects** using `vitest` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Vitest Projects**.
...
1. Clarify the desired outcome for vitest projects and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides vitest projects, not only a wrapper or installed dependency.
