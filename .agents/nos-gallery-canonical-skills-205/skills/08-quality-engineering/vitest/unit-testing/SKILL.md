...
Design, implement, review and troubleshoot **Unit Testing** using `vitest` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Unit Testing**.
...
1. Clarify the desired outcome for unit testing and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides unit testing, not only a wrapper or installed dependency.
