...
Design, implement, review and troubleshoot **Coverage Thresholds** using `@vitest/coverage-v8` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Coverage Thresholds**.
...
1. Clarify the desired outcome for coverage thresholds and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides coverage thresholds, not only a wrapper or installed dependency.
