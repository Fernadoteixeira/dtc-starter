...
Design, implement, review and troubleshoot **Coverage Reporting** using `@vitest/coverage-v8` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Coverage Reporting**.
...
1. Clarify the desired outcome for coverage reporting and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides coverage reporting, not only a wrapper or installed dependency.
