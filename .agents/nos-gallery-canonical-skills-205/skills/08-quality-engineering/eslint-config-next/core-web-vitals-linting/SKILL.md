---
name: "core-web-vitals-linting"
title: "Core Web Vitals Linting"
capability_id: "SK-199"
...
Design, implement, review and troubleshoot **Core Web Vitals Linting** using `eslint-config-next` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Core Web Vitals Linting**.
...
1. Clarify the desired outcome for core web vitals linting and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides core web vitals linting, not only a wrapper or installed dependency.
