---
name: "typescript-cli-automation"
title: "TypeScript CLI Automation"
capability_id: "SK-201"
...
# TypeScript CLI Automation

## Purpose

Design, implement, review and troubleshoot **TypeScript CLI Automation** using `tsx` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **TypeScript CLI Automation**.
- A design or implementation decision depends on `tsx`.
...
- The task only asks whether `tsx` is installed.
...
1. Clarify the desired outcome for typescript cli automation and identify the user-visible or operational result.
2. Inspect the relevant `tsx` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides typescript cli automation, not only a wrapper or installed dependency.
