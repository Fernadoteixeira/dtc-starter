---
name: "typescript-script-execution"
title: "TypeScript Script Execution"
capability_id: "SK-200"
...
Design, implement, review and troubleshoot **TypeScript Script Execution** using `tsx` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **TypeScript Script Execution**.
...
1. Clarify the desired outcome for typescript script execution and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides typescript script execution, not only a wrapper or installed dependency.
