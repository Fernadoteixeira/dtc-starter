---
name: "typecheck-gates"
title: "Type-checking Gates"
capability_id: "SK-193"
...
Design, implement, review and troubleshoot **Type-checking Gates** using `typescript` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Type-checking Gates**.
...
1. Clarify the desired outcome for type-checking gates and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides type-checking gates, not only a wrapper or installed dependency.
