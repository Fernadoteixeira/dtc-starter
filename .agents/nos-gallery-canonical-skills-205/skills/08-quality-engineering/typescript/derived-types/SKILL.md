...
Design, implement, review and troubleshoot **Derived Types** using `typescript` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Derived Types**.
...
1. Clarify the desired outcome for derived types and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides derived types, not only a wrapper or installed dependency.
