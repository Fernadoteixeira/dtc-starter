---
name: "narrowing-unions"
title: "Narrowing and Unions"
capability_id: "SK-189"
...
Design, implement, review and troubleshoot **Narrowing and Unions** using `typescript` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Narrowing and Unions**.
- A design or implementation decision depends on `typescript`.
...
- The task only asks whether `typescript` is installed.
...
1. Clarify the desired outcome for narrowing and unions and identify the user-visible or operational result.
2. Inspect the relevant `typescript` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides narrowing and unions, not only a wrapper or installed dependency.
