...
Design, implement, review and troubleshoot **Generics** using `typescript` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Generics**.
...
1. Clarify the desired outcome for generics and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides generics, not only a wrapper or installed dependency.
