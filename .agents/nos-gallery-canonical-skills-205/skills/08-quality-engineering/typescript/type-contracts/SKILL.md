...
Design, implement, review and troubleshoot **Type Contracts** using `typescript` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Type Contracts**.
...
1. Clarify the desired outcome for type contracts and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides type contracts, not only a wrapper or installed dependency.
