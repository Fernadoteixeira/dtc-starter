...
Design, implement, review and troubleshoot **Module Boundaries** using `typescript` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Module Boundaries**.
...
1. Clarify the desired outcome for module boundaries and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides module boundaries, not only a wrapper or installed dependency.
