...
Design, implement, review and troubleshoot **TypeScript Configuration** using `typescript` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **TypeScript Configuration**.
...
1. Clarify the desired outcome for typescript configuration and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides typescript configuration, not only a wrapper or installed dependency.
