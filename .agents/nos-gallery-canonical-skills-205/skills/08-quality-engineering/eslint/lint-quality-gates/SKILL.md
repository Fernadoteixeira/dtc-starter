...
title: "Lint Quality Gates"
capability_id: "SK-197"
...
Design, implement, review and troubleshoot **Lint Quality Gates** using `eslint` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Lint Quality Gates**.
...
1. Clarify the desired outcome for lint quality gates and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides lint quality gates, not only a wrapper or installed dependency.
