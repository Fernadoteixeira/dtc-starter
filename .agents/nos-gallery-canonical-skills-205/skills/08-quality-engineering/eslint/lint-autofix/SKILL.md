...
Design, implement, review and troubleshoot **Lint Auto-fix** using `eslint` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Lint Auto-fix**.
...
1. Clarify the desired outcome for lint auto-fix and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides lint auto-fix, not only a wrapper or installed dependency.
