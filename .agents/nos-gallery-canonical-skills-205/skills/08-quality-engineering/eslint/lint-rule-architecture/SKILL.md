---
name: "lint-rule-architecture"
title: "Lint Rule Architecture"
capability_id: "SK-194"
domain: "08-quality-engineering"
package: "eslint"
package_version: "^9.39.5"
...
Design, implement, review and troubleshoot **Lint Rule Architecture** using `eslint` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Lint Rule Architecture**.
- A design or implementation decision depends on `eslint`.
...
- The task only asks whether `eslint` is installed.
...
1. Clarify the desired outcome for lint rule architecture and identify the user-visible or operational result.
2. Inspect the relevant `eslint` contracts, runtime boundaries and surrounding architecture.
...
- [ ] The solution demonstrably provides lint rule architecture, not only a wrapper or installed dependency.
