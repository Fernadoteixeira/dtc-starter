...
Design, implement, review and troubleshoot **ESLint Flat Configuration** using `eslint` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **ESLint Flat Configuration**.
...
1. Clarify the desired outcome for eslint flat configuration and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides eslint flat configuration, not only a wrapper or installed dependency.
