...
Design, implement, review and troubleshoot **Automated Accessibility Audit** using `@axe-core/playwright` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Automated Accessibility Audit**.
...
1. Clarify the desired outcome for automated accessibility audit and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides automated accessibility audit, not only a wrapper or installed dependency.
