...
title: "Accessibility CI Gates"
capability_id: "SK-176"
...
Design, implement, review and troubleshoot **Accessibility CI Gates** using `@axe-core/playwright` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Accessibility CI Gates**.
...
1. Clarify the desired outcome for accessibility ci gates and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides accessibility ci gates, not only a wrapper or installed dependency.
