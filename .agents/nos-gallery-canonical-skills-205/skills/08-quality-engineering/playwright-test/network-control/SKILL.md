...
Design, implement, review and troubleshoot **Network Control** using `@playwright/test` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Network Control**.
...
1. Clarify the desired outcome for network control and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides network control, not only a wrapper or installed dependency.
