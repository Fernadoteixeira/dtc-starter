...
Design, implement, review and troubleshoot **Visual Testing** using `@playwright/test` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Visual Testing**.
...
1. Clarify the desired outcome for visual testing and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides visual testing, not only a wrapper or installed dependency.
