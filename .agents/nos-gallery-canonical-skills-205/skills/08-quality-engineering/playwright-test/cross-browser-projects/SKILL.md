---
name: "cross-browser-projects"
title: "Cross-browser Projects"
capability_id: "SK-166"
...
Design, implement, review and troubleshoot **Cross-browser Projects** using `@playwright/test` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Cross-browser Projects**.
...
1. Clarify the desired outcome for cross-browser projects and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides cross-browser projects, not only a wrapper or installed dependency.
