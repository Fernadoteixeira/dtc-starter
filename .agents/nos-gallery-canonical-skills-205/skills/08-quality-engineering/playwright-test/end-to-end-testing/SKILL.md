...
Design, implement, review and troubleshoot **End-to-end Testing** using `@playwright/test` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **End-to-end Testing**.
...
1. Clarify the desired outcome for end-to-end testing and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides end-to-end testing, not only a wrapper or installed dependency.
