...
title: "Parallel CI Execution"
capability_id: "SK-172"
...
Design, implement, review and troubleshoot **Parallel CI Execution** using `@playwright/test` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Parallel CI Execution**.
...
1. Clarify the desired outcome for parallel ci execution and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides parallel ci execution, not only a wrapper or installed dependency.
