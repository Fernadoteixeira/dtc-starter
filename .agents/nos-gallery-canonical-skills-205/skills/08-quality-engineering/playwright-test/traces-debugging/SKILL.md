---
name: "traces-debugging"
title: "Traces and Debugging"
capability_id: "SK-171"
...
Design, implement, review and troubleshoot **Traces and Debugging** using `@playwright/test` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Traces and Debugging**.
...
1. Clarify the desired outcome for traces and debugging and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides traces and debugging, not only a wrapper or installed dependency.
