...
Design, implement, review and troubleshoot **Authenticated Testing** using `@playwright/test` as a canonical capability, without assuming prior incorporation into the target repository.

## Use this skill when

- A requirement explicitly involves **Authenticated Testing**.
...
1. Clarify the desired outcome for authenticated testing and identify the user-visible or operational result.
...
- [ ] The solution demonstrably provides authenticated testing, not only a wrapper or installed dependency.
