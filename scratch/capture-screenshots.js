...
const routes = [
  { name: "storefront_home.png", url: "http://localhost:8000/" },
  { name: "storefront_catalog.png", url: "http://localhost:8000/us/store" },
  { name: "storefront_account.png", url: "http://localhost:8000/us/account" },
...
async function capture() {
  console.log("Installing chromium browser if needed...")
