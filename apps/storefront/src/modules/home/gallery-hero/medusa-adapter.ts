...
export interface GalleryProductMetadata {
...
export function mapStoreProductToGalleryItem(
  ...
  let price: GalleryPrice | undefined;
  ...
  let availability: GalleryAvailability = "available";
...
export function mapStoreProductsToGalleryItems(
